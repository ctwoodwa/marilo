...
| API spec | /workspaces/Marilo/docs/component-specs/map/ | Full directory | What is documented |
...
| Gap workspace closure reports | /workspaces/Marilo/workspaces/map-gap-analysis/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/map-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/map-spec-gap-list.md | spec-coverage-format.md |
