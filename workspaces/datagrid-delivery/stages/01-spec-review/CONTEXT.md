...
| API spec | /workspaces/Marilo/docs/component-specs/grid/ | Full directory | What is documented |
...
| Gap workspace closure reports | /workspaces/Marilo/workspaces/datagrid-gap-analysis/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/datagrid-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/datagrid-spec-gap-list.md | spec-coverage-format.md |
