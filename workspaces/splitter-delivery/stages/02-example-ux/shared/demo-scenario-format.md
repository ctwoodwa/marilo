...
4. At least one user-controllable input that changes the component's behaviour in real time.
5. A code snippet panel showing the minimal Razor markup for this scenario.
