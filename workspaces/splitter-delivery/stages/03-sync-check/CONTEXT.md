...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/splitter-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/splitter-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/splitter-delivery-report.md | delivery-checklist.md |
