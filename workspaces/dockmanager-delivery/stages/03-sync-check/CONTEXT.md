...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/dockmanager-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/dockmanager-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/dockmanager-delivery-report.md | delivery-checklist.md |
