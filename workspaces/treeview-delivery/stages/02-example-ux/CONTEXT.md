...
| Stage 01 output | stages/01-spec-review/output/treeview-spec-gap-list.md | Full file | Which parameters need demo coverage |
| API spec | /home/user/marilo/docs/component-specs/treeview/ | Full directory | Parameter definitions and use cases |
| Demo scenario format | shared/demo-scenario-format.md | Full file | What a complete scenario looks like |
| Existing demo page(s) | /home/user/marilo/samples/Marilo.Demo/Pages/Components/TreeView/ | Full file | Current state |
| Component source | /home/user/marilo/src/Marilo.Components/Navigation/ | Parameter and event declarations | Accurate API surface |
...
8. Write output/treeview-demo-gap-list.md (the gap audit).
9. Write the updated demo page file(s) to /home/user/marilo/samples/Marilo.Demo/Pages/Components/TreeView/.
...
|----------|----------|--------|
| Demo gap list | output/treeview-demo-gap-list.md | demo-scenario-format.md |
| Updated demo page | /home/user/marilo/samples/Marilo.Demo/Pages/Components/TreeView/ | Blazor .razor file(s) |
