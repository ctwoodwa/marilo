...
| Stage 01 output | stages/01-spec-review/output/resizable-container-spec-gap-list.md | Full file | Which parameters need demo coverage |
| API spec | /workspaces/Marilo/docs/component-specs/resizable-container/ | Full directory | Parameter definitions and use cases |
| Demo scenario format | shared/demo-scenario-format.md | Full file | What a complete scenario looks like |
| Existing demo page(s) | /workspaces/Marilo/samples/Marilo.Demo/Pages/Components/ResizableContainer/ | Full file | Current state |
| Component source | /workspaces/Marilo/src/Marilo.Components/Layout/ResizableContainer/ | Parameter and event declarations | Accurate API surface |
...
8. Write output/resizable-container-demo-gap-list.md.
...
|----------|----------|--------|
| Demo gap list | output/resizable-container-demo-gap-list.md | demo-scenario-format.md |
| Updated demo page | /workspaces/Marilo/samples/Marilo.Demo/Pages/Components/ResizableContainer/ | Blazor .razor file(s) |
