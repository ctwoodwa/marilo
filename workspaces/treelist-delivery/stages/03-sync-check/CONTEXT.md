...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/treelist-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/treelist-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/treelist-delivery-report.md | delivery-checklist.md |
