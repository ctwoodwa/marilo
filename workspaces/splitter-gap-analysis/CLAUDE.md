# Gap Analysis -- MariloSplitter

**Status:** STUB -- no gap phases started

Run intake (Stage 01) via ../splitter-delivery/ to begin gap analysis. Feature areas tracked in ../splitter-delivery/_config/delivery-context.md.

## Folder Map

```
splitter-gap-analysis/
