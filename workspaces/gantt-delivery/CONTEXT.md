...
Coordinates spec, Example UX, and source+tests for MariloGantt.
...
| Gap workspace | /workspaces/Marilo/workspaces/gantt-gap-analysis/CLAUDE.md | Routing table only |
