...
| API spec | /workspaces/Marilo/docs/component-specs/diagram/ | Full directory | What is documented |
...
| Gap workspace closure reports | /workspaces/Marilo/workspaces/diagram-gap-analysis/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/diagram-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/diagram-spec-gap-list.md | spec-coverage-format.md |
