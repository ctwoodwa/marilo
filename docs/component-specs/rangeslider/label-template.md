...
tags: marilo,blazor,range,slider,label,template
published: true
position: 10
...
<MariloRangeSlider @bind-StartValue="@TheStartValue"
...
<MariloRangeSlider @bind-StartValue="@TheStartIndex"
...
* [Live Demo: RangeSlider Label Template](https://demos.marilo.com/blazor-ui/rangeslider/label-template)