...
tags: marilo,blazor,range,slider,events
published: true
position: 20
...
This article showcases the available events in the Marilo RangeSlider component:
...
<MariloRangeSlider StartValue="@StartValue" StartValueChanged="@( async (decimal v) => await StartValueChangedHandler(v) )"
...
<MariloRangeSlider StartValue="@StartValue"
                    EndValue="@EndValue"
