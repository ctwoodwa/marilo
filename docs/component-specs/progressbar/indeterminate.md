...
tags: marilo,blazor,progress,bar,progressbar,indeterminate,state
published: True
position: 10
...
>caption Marilo ProgressBar in Indeterminate state
...
````RAZOR
<div>
    <MariloButton ThemeColor="primary" OnClick="(_ => isIndeterminate = true)">Put the ProgressBar in Indeterminate State</MariloButton>
</div>

<br />

<MariloProgressBar Indeterminate="@isIndeterminate" Value="10" Max="100" />
...
## See Also
  ...
  * [Live Demo: ProgressBar Overview](https://demos.marilo.com/blazor-ui/loader/overview)
