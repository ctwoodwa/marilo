...
tags: marilo,blazor,multicolumncombobox,combo,columns,overview
published: True
position: 0
...
The <a href="https://www.marilo.com/blazor-ui/multicolumncombobox" target="_blank">Blazor MultiColumnComboBox</a> enables users to select an option from a [predefined set of choices](slug:multicolumncombobox-data-binding) in a dropdown grid layout. Users can also [filter](slug:multicolumncombobox-filter) or [group](slug:multicolumncombobox-grouping) the available items, or enter [custom values](slug:multicolumncombobox-custom-value).


## Creating MultiColumnComboBox

1. Use the `<MariloMultiColumnComboBox>` tag.
...
````RAZOR
<MariloMultiColumnComboBox Data="@MultiComboData"
...
Add a reference to the component instance to use the [MultiColumnComboBox's methods](slug:Marilo.Blazor.Components.MariloMultiColumnComboBox-2). Note that the [MultiColumnComboBox is a generic component](slug:common-features-data-binding-overview#component-type).
...
````RAZOR
<MariloButton OnClick="@Open">Open MultiColumnComboBox</MariloButton>

<MariloMultiColumnComboBox @ref="@MultiColumnComboRef"
                            Data="@Products"
                            @bind-Value="@SelectedProduct"
                            ValueField="@nameof(Product.Id)"
                            TextField="@nameof(Product.Name)"
...
@code {
    private MariloMultiColumnComboBox<Product, int> MultiColumnComboRef { get; set; }
...
* [Live Demo: MultiColumnComboBox](https://demos.marilo.com/blazor-ui/multicolumncombobox/overview)
* [Live Demo: MultiColumnComboBox Validation](https://demos.marilo.com/blazor-ui/multicolumncombobox/validation)
