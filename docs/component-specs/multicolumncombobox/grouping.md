...
tags: marilo,blazor,multicolumncombobox,combobox,group,grouping
published: True
position: 15
...
<MariloGrid Data="@MultiComboData" Pageable="true" Groupable="true">
    <GridColumns>
...
* A grouped MultiColumnComboBox will provide a `Groups` property with a single [`GroupDescriptor`](slug:Marilo.DataSource.GroupDescriptor) in the [`DataSourceRequest`](slug:Marilo.DataSource.DataSourceRequest) argument of its [OnRead event](slug:multicolumncombobox-events#onread). This will allow the developer to apply grouping with [manual data operations](slug:common-features-data-binding-onread).

## See Also

* [Live Demo: ComboBox Grouping](https://demos.marilo.com/blazor-ui/multicolumncombobox/grouping)
