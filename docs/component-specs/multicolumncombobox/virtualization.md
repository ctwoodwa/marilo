...
tags: marilo,blazor,combo,combobox,virtualization
published: True
position: 30
...
* `ScrollMode` - `Marilo.Blazor.DropDownScrollMode` - set it to `DropDownScrollMode.Virtual`. It defaults to the "regular" scrolling.
...
@SelectedValue
<br />
<MariloMultiColumnComboBox Data="@Data"
                            TItem="Person"
                            TValue="int"
...
<MariloMultiColumnComboBox TItem="Person"
                            TValue="int"
                            TextField="@TextField"
...
## See Also
  ...
  * [Live Demo: MultiColumnComboBox Virtualization](https://demos.marilo.com/blazor-ui/multicolumncombobox/virtualization)
