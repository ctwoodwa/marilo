...
tags: marilo,blazor,multicolumncombobox,combobox,combo,events
published: true
position: 50
...
This article describes the events of the Marilo MultiColumnComboBox for Blazor.
...
<MariloMultiColumnComboBox TItem="@SuggestionsModel" TValue="int"
                            OnRead="@ReadItems"
...
<MariloMultiColumnComboBox TItem="Car" TValue="int"
                            TextField="Model"
                            ValueField="Id"
                            GroupField="Make"
                            Filterable="true"
...
````RAZOR
<MariloMultiColumnComboBox Data="@Items"
