...
page_title: Marilo UI for Blazor Upload Documentation | Upload Accessibility
description: "Get started with the Marilo UI for Blazor Upload and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Marilo UI for Blazor Upload provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Upload keyboard navigation works, refer to the [Blazor Upload Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/upload/keyboard-navigation).
