...
tags: marilo,blazor,upload,async,validate,validation
published: true
position: 5
components: ["upload"]
---
...
* client validation - by the Marilo Upload component
* server validation - in the application endpoints

The Marilo Upload component offers parameters to validate selected files on the client:
...
>caption Client validation by the Marilo Upload
...
<MariloUpload AllowedExtensions="@ValidFiles"
...
* [Live Demo: Upload Validation](https://demos.marilo.com/blazor-ui/upload/validation)
