...
slug: chiplist-bound
tags: marilo,blazor,chiplist,data,bind,binding,databind
published: True
position: 5
components: ["chiplist"]
---
...
````RAZOR
<MariloChipList Data="@ChipListData" />
...
* [Live Demo: ChipList](https://demos.marilo.com/blazor-ui/chiplist/overview)
