...
slug: switch-events
tags: marilo,blazor,switch,events
published: true
position: 20
components: ["switch"]
---
...
This article showcases the available events in the Marilo Switch component:
...
<MariloSwitch Value="@toggleSwitch" 
...
<MariloSwitch @bind-Value="@toggleSwitch"
...
<MariloSwitch @bind-Value="@TheValue"
