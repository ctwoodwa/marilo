...
slug: switch-labels
tags: marilo,blazor,labels,on,off
published: True
position: 10
components: ["switch"]
---
...
<MariloSwitch @bind-Value="@hasAgreed"
               OnLabel="@myOnLabel"
               OffLabel="@myOffLabel"
               Width="100px">
</MariloSwitch>
...
<MariloSwitch @bind-Value="@isSelected" OnLabel=" " OffLabel=" " />
...
## See Also
* [Live Demo: Switch Labels](https://demos.marilo.com/blazor-ui/switch/labels)
