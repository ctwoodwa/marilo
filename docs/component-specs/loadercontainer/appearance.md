...
tags: marilo,blazor,loader,container,loadercontainer,appearance
published: True
position: 5
...
You can see the appearance settings in action in the [LoaderContainer Appearance live demo](https://demos.marilo.com/blazor-ui/loadercontainer/appearance).
...
<div class="row">
    <div class="col-4" style="position: relative; height: 200px">
        <MariloLoaderContainer OverlayThemeColor="dark"></MariloLoaderContainer>
    ...
    <div class="col-4" style="position: relative; height: 200px">
        <MariloLoaderContainer OverlayThemeColor="light"></MariloLoaderContainer>
...
<div class="row">
    <div class="col-4" style="position: relative; height: 200px">
        <MariloLoaderContainer LoaderPosition="@LoaderPosition.Top"></MariloLoaderContainer>
    </div>
    <div class="col-4" style="position: relative; height: 200px">
        <MariloLoaderContainer LoaderPosition="@LoaderPosition.Start"></MariloLoaderContainer>
    </div>
    <div class="col-4" style="position: relative; height: 200px"> 
        <MariloLoaderContainer LoaderPosition="@LoaderPosition.End"></MariloLoaderContainer>
    </div>
</div>
````
...
>caption Setting MariloLoaderContainer LoaderType

````RAZOR
<MariloLoaderContainer LoaderType="@LoaderType.InfiniteSpinner" />
````
...
>caption Setting MariloLoaderContainer Size

````RAZOR
<MariloLoaderContainer Size="@ThemeConstants.Loader.Size.Large" />
````
...
>caption Setting MariloLoaderContainer ThemeColor

````RAZOR
<MariloLoaderContainer ThemeColor="@ThemeConstants.Loader.ThemeColor.Info" />
````
...
````RAZOR
<MariloLoaderContainer Class="custom-loading-colors" />
...
* [Live Demo: LoaderContainer Appearance](https://demos.marilo.com/blazor-ui/loadercontainer/appearance)
