...
tags: marilo,blazor,numeric textbox,overview
published: True
position: 0
...
The <a href="https://www.marilo.com/blazor-ui/numeric-textbox" target="_blank">Blazor Numeric Textbox component</a> allows the user to enter decimal values and no text. The developer can control minimum, maximum values, steps and other elements of the UX.

## Creating Blazor Numeric TextBox

1. Add the `MariloNumericTextBox` tag to your razor page.
...
>tip To learn more about the appearance, anatomy, and accessibility of the Numeric TextBox, visit the [Progress Design System Kit documentation](https://www.marilo.com/design-system/docs/components/numerictextbox/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.

## Numeric TextBox Reference and Methods


````RAZOR.skip-repl
<MariloNumericTextBox @ref="@NumericTextBoxRef" .../>
...
* If you want to use a currency format, you must specify the culture for your app thread, so .NET knows what symbol to render. If you don't do that, you may see an unexpected/incorrect symbol or format. The Marilo Numeric Textbox uses the thread culture for currency signs and decimal separators (more on [globalization in the Marilo components](slug:globalization-overview)).
...
````RAZOR.skip-repl
        ...
        <MariloNumericTextBox @bind-Value=@DecimalStepValue 
                               Step="0.01m" 
                               Decimals="2" 
                               Format="N2">
        </MariloNumericTextBox>
...
* [Live Demo: Numeric Textbox](https://demos.marilo.com/blazor-ui/numerictextbox/overview)
* [Live Demo: Numeric Textbox Validation](https://demos.marilo.com/blazor-ui/numerictextbox/validation)
* [Live Demo: Numeric Textbox Formats](https://demos.marilo.com/blazor-ui/numerictextbox/formats)
* [Input Validation](slug:common-features/input-validation)
* [NumericTextBox API Reference](slug:Marilo.Blazor.Components.MariloNumericTextBox-1)
