...
tags: marilo,blazor,form,button,buttons
published: True
position: 3
components: ["form"]
---
...
The [Blazor Form](https://demos.marilo.com/blazor-ui/form/overview) component adds a Submit Button at the end of the Form by default. You can add your own buttons through the `FormButtons` tag.
...
You can provide a standard [Marilo UI for Blazor Button](slug:components/button/overview) to allow the user to clear the contents of the editors in the Marilo Form. Refer to below Blazor Form Submit example for more details.

````RAZOR
@* Add a Clear Button to the Marilo Form. We also add a Submit button *@

@inject IServiceProvider ServiceProvider
@using System.ComponentModel.DataAnnotations

<MariloForm EditContext="@FormEditContext" OnValidSubmit="@OnValidSubmitHandler" Width="200px">

    <FormButtons>
        <MariloButton ButtonType="@ButtonType.Submit" ThemeColor="primary">Submit</MariloButton>
        <MariloButton ButtonType="ButtonType.Button" OnClick="@ClearButton">Clear</MariloButton>
    </FormButtons>
