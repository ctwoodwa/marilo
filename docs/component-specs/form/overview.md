...
slug: form-overview
tags: marilo,blazor,form,edit,form
published: True
position: 0
components: ["form"]
---
...
|-----------|----------|
| `string`  | [Marilo TextBox](slug:components/textbox/overview) |
| `int`, `double`, `float`, `decimal`  | [Marilo NumericTextBox](slug:components/numerictextbox/overview) |
| `Enum`  | [Marilo DropDownList](slug:components/dropdownlist/overview) |
| `DateTime`  | [Marilo DatePicker](slug:components/datepicker/overview) |
| `bool`  | [Marilo CheckBox](slug:checkbox-overview) |
...
The [Blazor Form](https://demos.marilo.com/blazor-ui/form/overview) exposes multiple parameters that allow you to customize its layout. Besides the parameters below, the Form component also allows you to [define a completely custom layout with HTML markup and Razor components](slug:form-formitems-formitemstemplate).
...
The following parameters enable you to customize the appearance of the [Blazor Form](https://demos.marilo.com/blazor-ui/form/overview):
...
<MariloForm Model="@TeamMate" @ref="@FormRef" Width="300px">
    <FormValidation>
...
@code {
    private MariloForm FormRef { get; set; }
...
* [Live Demo: Form](https://demos.marilo.com/blazor-ui/form/overview)
* [Form API Reference](slug:Marilo.Blazor.Components.MariloForm)
