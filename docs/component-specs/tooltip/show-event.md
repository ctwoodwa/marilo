...
tags: marilo,blazor,tooltip,show,event
published: true
position: 3
components: ["tooltip"]
---
...
It takes a member of the `Marilo.Blazor.TooltipShowEvent` enum:
...
<MariloTooltip TargetSelector="#hoverTarget" ShowOn="@TooltipShowEvent.Hover">
</MariloTooltip>
...
<MariloTooltip TargetSelector="#clickTarget" ShowOn="@TooltipShowEvent.Click">
</MariloTooltip>
...
* [Live Demo: Tooltip Show Event](https://demos.marilo.com/blazor-ui/tooltip/show-event)
