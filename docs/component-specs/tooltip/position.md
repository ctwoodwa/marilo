...
You can control it through the `Position` parameter, which takes a member of the `Marilo.Blazor.TooltipPosition` enum:
...
<MariloTooltip TargetSelector="#target" Position="@position">
</MariloTooltip>
...
* [Live Demo: Tooltip Position](https://demos.marilo.com/blazor-ui/tooltip/position)
