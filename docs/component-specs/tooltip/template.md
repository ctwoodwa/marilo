...
tags: marilo,blazor,tooltip,template
published: true
position: 4
components: ["tooltip"]
---
...
<MariloTooltip TargetSelector="p strong[title]">
    <Template>
        @{
...
<MariloTooltip TargetSelector="p strong.target" Height="300px" Width="400px">
    <Template>
...
* [Live Demo: Tooltip Template](https://demos.marilo.com/blazor-ui/tooltip/template)
