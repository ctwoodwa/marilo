...
page_title: Marilo UI for Blazor Spreadsheet Documentation | Spreadsheet Accessibility
description: "Get started with the Marilo UI for Blazor Spreadsheet and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Marilo UI for Blazor Spreadsheet provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Spreadsheet keyboard navigation works, refer to the [Blazor Spreadsheet Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/spreadsheet/keyboard-navigation).

## See Also

* [Blazor Spreadsheet Demos](https://demos.marilo.com/blazor-ui/spreadsheet/overview)
