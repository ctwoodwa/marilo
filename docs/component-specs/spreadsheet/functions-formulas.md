...
description: Learn about all built-in functions supported by the Marilo UI for Blazor Spreadsheet.
...
The Marilo Spreadsheet supports a large variety of functions. They work in the same way as in other Excel editors, so the following documentations are also applicable:
