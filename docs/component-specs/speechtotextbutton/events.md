...
To review all available properties of the event arguments for `OnResult`, see the [`SpeechToTextButtonResultEventArgs` API Reference](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.SpeechToTextButtonResultEventArgs.html).
