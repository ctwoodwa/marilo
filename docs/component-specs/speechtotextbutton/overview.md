...
To review all available parameters for the SpeechToTextButton component, see the [SpeechToTextButton API Reference](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.MariloSpeechToTextButton#parameters).

## SpeechToTextButton Reference and Methods

The SpeechToTextButton component exposes several public methods that you can call from your code. For a full list and details, see the [SpeechToTextButton API Reference](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.MariloSpeechToTextButton#methods).

>caption Example of Calling a Method by Reference


````RAZOR.skip-repl
<MariloSpeechToTextButton @ref="speechToTextButtonRef" />
...
````RAZOR.skip-repl
<MariloSpeechToTextButton Lang="en-US" />
````
...
* [SpeechToTextButton Live Demo](https://demos.marilo.com/blazor-ui/speechtotextbutton/overview)
* [SpeechToTextButton API Reference](/blazor-ui/api/Marilo.Blazor.Components.MariloSpeechToTextButton)
