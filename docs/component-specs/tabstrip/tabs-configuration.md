...
````RAZOR
<MariloButton OnClick="@ToggleVisible">Toggle Second Tab Visibility</MariloButton>
...
````RAZOR
<MariloButton OnClick="@ToggleDisabled">Enable/Disable Second Tab</MariloButton>
...
````RAZOR
<MariloTabStrip EnableTabReorder="true">
...
## See Also
  ...
  * [Live Demo: TabStrip - Tab Visibility](https://demos.marilo.com/blazor-ui/tabstrip/tab-visibility)
