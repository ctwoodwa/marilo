...
tags: marilo,blazor,tab,strip,tabstrip,alignment
published: True
position: 11
components: ["tabstrip"]
---
...
You can customize their alignment through the `TabAlignment` parameter. It takes a member of the `Marilo.Blazor.TabStripTabAlignment` enumeration:
...
````RAZOR
<MariloTabStrip TabAlignment="@TabStripTabAlignment.End">
