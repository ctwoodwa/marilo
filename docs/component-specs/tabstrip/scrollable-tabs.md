...
tags: marilo,blazor,tab,strip,tabstrip,scroll,overflow,tabs
published: True
position: 15
tag: updated
components: ["tabstrip"]
...
````RAZOR
<MariloTabStrip OverflowMode="@TabStripOverflowMode.Scroll"
                 Width="300px">
    @{
        for (int i = 1; i <= 10; i++)
        {
...
````RAZOR
<MariloTabStrip OverflowMode="@TabStripOverflowMode.Menu"
                 Width="300px">
    @{
        for (int i = 1; i <= 10; i++)
        {
...
<MariloTabStrip OverflowMode="@TabStripOverflowMode.Menu"
    ...
    <TabStripSuffixTemplate>
        ...
        <MariloButton Icon="@SvgIcon.Gear" FillMode="@ThemeConstants.Button.FillMode.Flat" />
    </TabStripSuffixTemplate>
</MariloTabStrip>
````
...
* [Live Demo: TabStrip - Scrollable Tabs](https://demos.marilo.com/blazor-ui/tabstrip/scrollable-tabs)
