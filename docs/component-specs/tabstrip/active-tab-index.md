...
tags: marilo,blazor,tab,strip,tabstrip,active,tab,index
published: True
position: 5
components: ["tabstrip"]
---
...
<MariloTabStrip @bind-ActiveTabIndex="@ActiveTabIndex">
	...
	<TabStripTab Title="Second">
        ...
        <br />
        <MariloButton OnClick="@SelectThirdTab">Select Third Tab</MariloButton>
	</TabStripTab>
