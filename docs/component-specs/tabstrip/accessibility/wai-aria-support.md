...
page_title: Marilo UI for Blazor TabStrip Documentation | TabStrip Accessibility
description: "Get started with the Marilo UI for Blazor TabStrip and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Marilo UI for Blazor TabStrip provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the TabStrip keyboard navigation works, refer to the [Blazor TabStrip Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/tabstrip/keyboard-navigation).
