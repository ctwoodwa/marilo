...
tags: marilo,blazor, tabstrip, header, template
published: True
position: 15
components: ["tabstrip"]
---
...
>caption The following example showcases the use of a `<HeaderTemplate>`, including `MariloIcons`
...
* [Live Demo: TabStrip Header Template](https://demos.marilo.com/blazor-ui/tabstrip/header-template)
