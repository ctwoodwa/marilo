...
description: Learn how to enable drag-and-drop tab reordering in the Marilo TabStrip for Blazor.
slug: tabstrip-tab-reorder
tags: marilo,blazor,tabstrip,reorder,drag,drop
published: True
position: 10
tag: new
components: ["tabstrip"]
...
The Marilo TabStrip for Blazor allows users to reorder tabs by dragging and dropping them to new positions.
