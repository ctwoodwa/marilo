...
description: Discover the Marilo UI for Blazor Chat component. Learn how to add the component to your app and explore its features like messaging, AI integration, customization, and accessibility.
slug: chat-overview
tags: marilo,blazor,chat,messaging,ai,accessibility
published: True
position: 0
components: ["chat"]
---
...
>caption Basic configuration of the Marilo Chat

````razor
<MariloChat Data="@ChatData"
...
<MariloButton OnClick="@OnRefreshChatClick">Refresh Chat</MariloButton>

@code {
    private MariloChat<ChatMessage>? ChatRef { get; set; }
...
* [Live Demo: Chat Overview](https://demos.marilo.com/blazor-ui/chat/overview)
* [Live Demo: AI Integration](https://demos.marilo.com/blazor-ui/chat/ai-integration)
