...
description: Learn how to configure message actions, styling, and behavior in the Marilo UI for Blazor Chat component.
slug: chat-messages
tags: marilo,blazor,chat,messages,actions,styling
published: True
position: 5
components: ["chat"]
---
...
The Marilo UI for Blazor Chat component provides comprehensive control over message display, interactions, and styling to create rich conversational experiences.
...
````RAZOR
<MariloButton OnClick="@AddTypingMessage">Show Typing Indicator</MariloButton>
...
````RAZOR
<MariloChat Data="@ChatConversation"
             @ref="@Chat1"
             Width="600px"
             Height="700px"
             TextField="Content"
...
@code {
    ...
    private MariloChat<ChatMessage>? Chat1;
