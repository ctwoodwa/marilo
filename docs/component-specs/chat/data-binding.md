...
description: Learn how to bind data to the Marilo UI for Blazor Chat component, including message models and dynamic updates.
slug: chat-data-binding
tags: marilo,blazor,chat,data-binding,messages
published: True
position: 2
components: ["chat"]
---
...
The Marilo UI for Blazor Chat component supports data binding to collections of messages and provides flexible field mapping to accommodate different data models.
...
````RAZOR.skip-repl
<MariloChat AuthorIdField="@nameof(Message.UserId)"
...
<MariloButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
               OnClick="@OnAddSystemMessageClick">Add System Message</MariloButton>
<MariloButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
               OnClick="@OnClearMessagesClick">Clear All Messages</MariloButton>
