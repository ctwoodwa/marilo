...
description: Learn how to configure file uploads, media sharing, and speech-to-text features in the Marilo UI for Blazor Chat component.
slug: chat-file-uploads-and-media
tags: marilo,blazor,chat,file-upload,media,speech-to-text
published: True
position: 4
components: ["chat"]
---
...
The Marilo UI for Blazor Chat component supports file uploads, media sharing, and speech-to-text functionality to enhance the messaging experience.
...
````RAZOR.skip-repl
<MariloChat EnableFileUpload="true" />
````
...
````RAZOR.skip-repl
<MariloChat EnableSpeechToText="true">
    <ChatSettings>
