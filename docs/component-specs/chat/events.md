...
description: Learn about the events exposed by the Marilo UI for Blazor Chat component for message handling, quick actions, uploads, and more.
slug: chat-events
tags: marilo,blazor,chat,events
published: True
position: 9
components: ["chat"]
---
...
The Marilo UI for Blazor Chat component exposes various events that allow you to implement custom functionality and handle user interactions. This article lists the available events and provides examples for the most common use cases.
