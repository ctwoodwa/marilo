...
position: 10
description: Learn about WAI-ARIA accessibility support in the Marilo UI for Blazor Chat component, including ARIA roles, attributes, and screen reader compatibility.
tags: marilo,blazor,chat,accessibility,wai-aria
published: True
---
...
* [Blazor Chat Demos](https://demos.marilo.com/blazor-ui/chat/overview)
