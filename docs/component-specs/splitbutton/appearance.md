...
tags: marilo,blazor,splitbutton,appearance,styling
published: True
position: 10
...
````RAZOR
<MariloSplitButton FillMode="@ThemeConstants.SplitButton.FillMode.Solid"
...
<MariloSplitButton FillMode="solid"
                    Rounded="lg"
                    Size="lg"
                    ThemeColor="primary">
    <SplitButtonContent> Foo </SplitButtonContent>
...
@foreach (var item in FillModes)
{
    ...
    <MariloSplitButton FillMode="@fillMode">
...
@foreach (var item in RoundedOptions)
{
    ...
    <MariloSplitButton Rounded="@rounded">
...
@foreach (var item in ThemeColors)
{
    ...
    <MariloSplitButton ThemeColor="@themeColor">
...
* [Live Demo: SplitButton Appearance](https://demos.marilo.com/blazor-ui/splitbutton/appearance)
