...
tags: marilo,blazor,splitbutton,icons
published: True
position: 5
...
The `<MariloSplitButton>` and `<SplitButtonItem>` provide an `Icon` parameter that allows you to add an icon to the main button and all secondary action items.
...
>caption How to use icons in Marilo Blazor SplitButton

````RAZOR
<MariloSplitButton Icon="@SvgIcon.Table">
    ...
    <SplitButtonItems>
        ...
        <SplitButtonItem> <MariloLoader /> Custom Markup </SplitButtonItem>
    </SplitButtonItems>
</MariloSplitButton>
...
* [Live Demo: SplitButton Icons](https://demos.marilo.com/blazor-ui/splitbutton/overview)
