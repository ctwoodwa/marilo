...
tags: marilo,blazor,splitbutton
published: True
position: 0
...
The <a href = "https://www.marilo.com/blazor-ui/split-button" target="_blank">SplitButton for Blazor</a> is a combination of a button and a dropdown. It provides a collection of related user actions in a compact interface. The SplitButton has one primary clickable action, which is always visible, and a list of secondary actions that are displayed in a dropdown when the user clicks on the arrow.
...
1. Set the `OnClick` parameter of the `<MariloSplitButton>` tag. This will be the event handler for the primary action.
...
````RAZOR
<MariloSplitButton OnClick="@OnReply">
...
>tip To learn more about the appearance, anatomy, and accessibility of the SplitButton, visit the [Progress Design System Kit documentation](https://www.marilo.com/design-system/docs/components/splitbutton/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.
...
````RAZOR
<MariloSplitButton @ref="@SplitButtonRef" OnClick="@OnReply">
    <SplitButtonContent>Reply</SplitButtonContent>
    <SplitButtonItems>
        <SplitButtonItem OnClick="@OnReplyAll">Reply All</SplitButtonItem>
    </SplitButtonItems>
...
<MariloButton OnClick="@FocusSplitButton">Focus SplitButton</MariloButton>

Last action clicked: <strong> @LastActionClicked </strong>

@code {
    MariloSplitButton SplitButtonRef { get; set; }
...
* [SplitButton API](slug:Marilo.Blazor.Components.MariloSplitButton)
* [Live Demo: SplitButton](https://demos.marilo.com/blazor-ui/splitbutton/overview)
