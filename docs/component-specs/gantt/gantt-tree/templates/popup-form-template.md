...
tags: marilo,blazor,gantt,ganttchart,templates,popup,edit,create
published: True
position: 50
components: ["gantt"]
---
                        ...
                        <FormItems>
                            ...
                            <FormItem Field="@(nameof(FlatModel.PercentComplete))" LabelText="Complete">
                                <Template>
                                    ...
                                    <MariloNumericTextBox Id="complete" @bind-Value="@EditItem.PercentComplete" Format="P2" />
                                </Template>
                            </FormItem>
                        </FormItems>
                        <FormButtons>
...
@code {
    private MariloGantt<FlatModel> GanttRef;
