...
tags: marilo,blazor,gantt,filtering,filter,row
published: True
position: 5
components: ["gantt"]
---
...
>caption Filter Row in Marilo Gantt
...
## See Also
  ...
  * [Live Demo: Gantt Filter Row](https://demos.marilo.com/blazor-ui/gantt/filter-row)