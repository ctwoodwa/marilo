...
tags: marilo,blazor,gantt,tree,editing,overview
published: True
position: 5
components: ["gantt"]
---
...
You can control whether a newly added item appears at the top or bottom of the Gantt Tree. Use the [`NewRowPosition`](https://www.marilo.com/blazor-ui/documentation/api/marilo.blazor.gantttreelistnewrowposition) parameter to specify the position. This parameter does not affect Popup edit mode, which always displays a dialog for new items.
...
## See Also
  ...
  * [Live Demo: Gantt Inline Editing](https://demos.marilo.com/blazor-ui/treelist/editing-inline)
  * [Live Demo: Gantt Popup Editing](https://demos.marilo.com/blazor-ui/treelist/editing-popup)
  * [Live Demo: Gantt InCell Editing](https://demos.marilo.com/blazor-ui/treelist/editing-incell)