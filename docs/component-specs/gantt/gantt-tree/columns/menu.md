...
tags: marilo,blazor,gantt,column,columns,menu
published: True
position: 20
components: ["gantt"]
---
...
To enable the Column Menu, set the `ShowColumnMenu` parameter of the `<MariloGantt>` tag to `true`. This will enable the menu for each column of the Gantt.
...
## See Also
  * [Live Demo: Gantt Column Menu](https://demos.marilo.com/blazor-ui/gantt/column-menu)
