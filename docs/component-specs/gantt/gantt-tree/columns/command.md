...
tags: marilo,blazor,gantt,column,command
published: True
position: 1
components: ["gantt"]
---
...
See also Appearance properties like `Icon`, `Class`, `Enabled` that are coming from the underlying [Marilo UI for Blazor Button Component features](slug:components/button/overview).
...
## See Also
  ...
  * [Live Demo: Gantt Tree Command Column](https://demos.marilo.com/blazor-ui/gantt/editing-inline)
