...
tags: marilo,blazor,Gantt,observable,data,new,collection
published: True
position: 20
components: ["gantt"]
---
...
<MariloButton OnClick="@AddRootTask">Add root task</MariloButton>

<MariloButton OnClick="@RemoveTask">Remove Task 1</MariloButton>
