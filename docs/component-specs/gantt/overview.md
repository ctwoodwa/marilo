...
slug: gantt-overview
tags: marilo,blazor,gantt,overview
published: True
position: 0
components: ["gantt"]
---
...
The <a href = "https://www.marilo.com/blazor-ui/gantt" target="_blank">Blazor Gantt Chart component</a> allows you to easily illustrate a collection of tasks. The component consists of two areas: 
...
1. Add the `MariloGantt` tag to a Razor file.
...
>tip The Marilo Blazor Gantt Chart is data source agnostic - you can use any database and service according to your project, you only need to get the collection of data models to the Gantt Chart in the view-model of the component hosting it.
...
@code{
    private MariloGantt<MyModel> GanttRef;
}
````
