...
tags: marilo,blazor,context menu,events
published: true
position: 30
...
This article describes the events that are fired by the Marilo Context Menu for Blazor:
...
<MariloContextMenu Data="@MenuItems" Selector="#context-menu-target"
...
<MariloContextMenu Data="@MenuItems"
