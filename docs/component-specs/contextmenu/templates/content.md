...
tags: marilo,blazor,menu,templates
published: True
position: 5
...
<MariloContextMenu Data="@MenuItems" @ref="@TheContextMenu">
    <Template>
        ...
        @if (UseSpecialMenu)
        {
            <MariloButton OnClick="@( () => Console.WriteLine($"do more with {dataSource[1].Text}") )">Do More</MariloButton>
        }
    </Template>
</MariloContextMenu>
...
## See Also
  ...
  * [Live Demo: Context Menu Templates](https://demos.marilo.com/blazor-ui/contextmenu/templates)
