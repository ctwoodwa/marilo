...
tags: marilo,blazor,context menu,data,bind,databind,databinding,basics
published: True
position: 0
...
* `Icon` - The [Marilo Font or SVG icon](slug:common-features-icons) that will be rendered in the item. Read more in the [Icons article](slug:contextmenu-icons).
...
<MariloContextMenu Data="@ContextMenuItems" Selector=".menuTarget"
...
## See Also
  ...
  * [Live Demo: Context Menu](https://demos.marilo.com/blazor-ui/contextmenu/overview)
