...
tags: marilo,blazor,dropdownlist,dropdown,list,templates
published: True
position: 25
...
<MariloDropDownList Data="@DropDownData" @bind-Value="@Role">
    <ValueTemplate>
...
* [Live Demo: DropDownList Templates](https://demos.marilo.com/blazor-ui/dropdownlist/templates)
