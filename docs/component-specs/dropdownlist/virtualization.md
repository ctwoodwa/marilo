...
tags: marilo,blazor,dropdown,DropDownList,virtualization
published: True
position: 20
...
<br />
<MariloDropDownList TItem="@Person" TValue="@int"
                     ScrollMode="@DropDownScrollMode.Virtual"
...
* [Live Demo: DropDownList Virtualization](https://demos.marilo.com/blazor-ui/dropdownlist/virtualization)
