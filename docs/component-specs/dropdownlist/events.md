...
tags: marilo,blazor,dropdown,list,dropdownlist,events
published: true
position: 35
...
This article explains the events available in the Marilo DropDownList for Blazor:
...
<br />
<MariloDropDownList Data="@MyList" OnChange="@MyOnChangeHandler" @bind-Value="@MySelectedItem">
</MariloDropDownList>
...
<MariloDropDownList TItem="@Car" TValue="@(int?)"
                     OnRead="@ReadItems"
                     @bind-Value="@SelectedValue"
...
<MariloDropDownList Data="@DropDownListData"
...
<MariloDropDownList @bind-Value="@TheValue" Data="@Suggestions"
