...
tags: marilo,blazor,drawer,navigation
published: True
position: 3
components: ["drawer"]
---
...
<MariloRootComponent>
    ...
    <MariloDrawer Data="@NavigablePages" Expanded="true" MiniMode="true" Mode="@DrawerMode.Push">
        <DrawerContent>
            @Body
        </DrawerContent>
    </MariloDrawer>
...
* A GitHub sample project that showcases [Drawer as side navigation](https://github.com/marilo/blazor-ui/tree/master/drawer/sidenav).
