...
tags: marilo,blazor,drawer,templates
published: True
position: 12
components: ["drawer"]
---
...
<MariloButton OnClick="@(() => DrawerRef.ToggleAsync())" Icon="@SvgIcon.Menu" />

<MariloDrawer @bind-Expanded="@Expanded"
               Data="@Data"
               MiniMode="true"
    ...
    <ItemTemplate Context="item">
        <MariloSvgIcon Icon="@item.Icon" Class="styled-icon"></MariloSvgIcon>
        @if (Expanded)
        {
...
>tip You can find a runnable sample that showcases this in the [Drawer as Side Navigation using the Template](https://github.com/marilo/blazor-ui/tree/master/drawer/template) sample project.
...
<MariloDrawer @bind-Expanded="@DrawerExpanded"
               Data="@Data"
               MiniMode="true"
               Mode="@DrawerMode.Push"
               @bind-SelectedItem="@SelectedItem"
    ...
    <Template>
        ...
        @if (DrawerExpanded)
        {
            <div style="text-align: center; margin-top: 3em; padding-top: 2em; border-top: 2px solid black; white-space:nowrap">
                ...
                <br /><br />
                <MariloButton Icon="@SvgIcon.Logout" ThemeColor="primary">Log Out</MariloButton>
            </div>
        }
    </Template>
    <DrawerContent>
...
* [Drawer Templates Demo](https://demos.marilo.com/blazor-ui/drawer/overview)
* [Drawer Data Binding](slug:drawer-data-binding)
* [Drawer Navigation](slug:drawer-navigation)
* [Hierarchical Drawer Demo](https://demos.marilo.com/blazor-ui/drawer/hierarchical-drawer)
