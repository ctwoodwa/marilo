...
tags: marilo,blazor,drawer,data,binding
published: True
position: 2
components: ["drawer"]
---
...
The properties of a drawer item match directly to a field of the model the drawer is bound to. You provide that relationship by providing the name of the field from which the corresponding information is present. To do this, use the properties in the main `MariloDrawer` tag:
...
https://docs.marilo.com/blazor-ui/components/drawer/navigation
*@

<MariloDrawer Data="@Data" UrlField="ItemUrl" TextField="ItemText" IconField="ItemIcon"
