...
page_title: Marilo UI for Blazor Drawer Documentation | Drawer Accessibility
description: "Get started with the Marilo UI for Blazor Drawer and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Marilo UI for Blazor Drawer provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Drawer keyboard navigation works, refer to the [Blazor Drawer Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/drawer/keyboard-navigation).
