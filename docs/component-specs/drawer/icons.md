...
slug: drawer-icons
tags: marilo,blazor,drawer,icon,iconclass,image
published: True
position: 22
components: ["drawer"]
---
...
You can add [Marilo Font or SVG icons](slug:common-features-icons) to the Drawer items. The component also supports custom icons.
...
<style>
    ...
    .my-image {
        ...
        background-image: url('https://demos.marilo.com/kendo-ui/content/shared/icons/16/star.png'); 
        flex-shrink: 0;
    }
</style>

<!-- Load this stylesheet only if using Marilo font icons -->
<link href="https://blazor.cdn.marilo.com/blazor/6.0.2/kendo-font-icons/font-icons.css" rel="stylesheet" type="text/css" />
...
@code {
    private MariloDrawer<DrawerItem> DrawerRef { get; set; }
