...
slug: drawer-events
tags: marilo,blazor,drawer,event,events
published: True
position: 25
components: ["drawer"]
---
...
This article explains the events available in the Marilo Drawer for Blazor:
...
<MariloDrawer Data="@Data" Expanded="true" MiniMode="true" Mode="DrawerMode.Push"
...
@if (!Expanded)
{
    <MariloButton OnClick="@(() => DrawerRef.ExpandAsync())" Icon="@SvgIcon.Menu">Expand Drawer</MariloButton>
}

<MariloDrawer Expanded="@Expanded"
...
<MariloButton OnClick="@(() => DrawerRef.ToggleAsync())"
               Icon="@SvgIcon.Menu">Toggle drawer</MariloButton>
