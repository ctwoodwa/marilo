...
tags: marilo,blazor,checkbox,events
published: true
position: 20
components: ["checkbox"]
---
...
This article showcases the available events in the Marilo CheckBox component:
...
<div class="mt-2">
    ...
    <MariloCheckBox @bind-Value="@CheckBoxValue" Id="theCb"
                     Indeterminate="@Indeterminate"
                     IndeterminateChanged="((bool val) => ChangeHandler(val))">
    </MariloCheckBox>
</div>
<MariloButton ThemeColor="primary" OnClick="@(() => Indeterminate = !Indeterminate)"> Toggle Indeterminate </MariloButton>
...
<MariloCheckBox @bind-Value="@TheValue"
