...
tags: marilo,blazor,checkbox,state,indeterminate
published: true
position: 2
components: ["checkbox"]
---
...
In addition to `checked` and `unchecked` basic states, the Marilo CheckBox has a third state - `Indeterminate`. This means that its state is something in between - neither checked, nor unchecked.
...
<MariloButton ThemeColor="primary" OnClick="@( _ => TheValue = null )">Make indeterminate</MariloButton>
<br />

<MariloCheckBox Id="DemoCheckbox" @bind-Value="@TheValue" Indeterminate="@( !TheValue.HasValue )" />
...
<div>
    <MariloCheckBox Id="selectAllCheckbox"
                     Value="SelectAll"
                     ValueChanged="((bool newVal) => ChangeAllHander(newVal))"
                     Indeterminate="SelectAllIndeterminate"></MariloCheckBox>
...
@foreach (var delivery in Deliveries)
{
    <div class="ml-2">
        <label class="text-muted">
            <MariloCheckBox Value="delivery.IsDelivered"
