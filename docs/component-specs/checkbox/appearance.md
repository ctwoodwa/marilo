...
tags: marilo,blazor,button,checkbox,appearance
published: True
position: 35
components: ["checkbox"]
---
...
The `Rounded` attribute applies the `border-radius` CSS rule to the checkbox to achieve curving of the edges. You can set it to a member of the `Marilo.Blazor.ThemeConstants.CheckBox.Rounded` class:
