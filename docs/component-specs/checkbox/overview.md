...
tags: marilo,blazor,checkbox,overview
published: True
position: 0
components: ["checkbox"]
---
...
>caption Basic setup of the Marilo CheckBox using two-way data binding.
...
>tip To learn more about the appearance, anatomy, and accessibility of the CheckBox, visit the [Progress Design System Kit documentation](https://www.marilo.com/design-system/docs/components/checkbox/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.
...
<MariloCheckBox Id="myCheckBox" @bind-Value="@hasAgreed" />
...
* [Live CheckBox Demos](https://demos.marilo.com/blazor-ui/checkbox/overview)
* [CheckBox API Reference](slug:Marilo.Blazor.Components.MariloCheckBox-1)
