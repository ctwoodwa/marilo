...
tags: marilo,blazor,wizard,stepper
published: True
position: 0
components: ["wizard"]
---
...
One of the main elements of the Wizard component is the Stepper. The Wizard component utilizes the [Marilo UI for Blazor Stepper](slug:stepper-overview) internally.
...
<div style="text-align:center">
    <MariloWizard Width="600px" Height="250px">
        <WizardSettings>
...
* `Icon` - `object` - Specifies the [Marilo Font or SVG icon](slug:common-features-icons) which will be put inside the step indicator.
...
<MariloButton OnClick="@ToggleDisabled">Toggle Disabled of the Preview Step</MariloButton>
