...
slug: chart-events
tags: marilo,blazor,chart,events,event
published: true
position: 33
components: ["charts"]
---
...
This article describes the available events for the Marilo Chart for Blazor:
...
<MariloRadioGroup Data="@ClickModes" @bind-Value="@SelectedMode" />

<MariloChart OnLegendItemClick="@OnLegendClickHandler"
              Transitions="false">
    <ChartSeriesItems>
...
* [Live Demo: Chart Events](https://demos.marilo.com/blazor-ui/chart/events)
