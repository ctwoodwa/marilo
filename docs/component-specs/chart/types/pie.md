...
The <a href="https://www.marilo.com/blazor-ui/pie-chart" target="_blank">Blazor Pie chart</a> displays the data as sectors from a two-dimensional circle and is therefore useful for displaying data as parts of a whole. There can only be one series in a pie chart.
...
````RAZOR
Chart Width
<MariloDropDownList Data="@ChartDimensions"
                     Value="@ChartWidth"
...
* [Live Demo: Pie Chart](https://demos.marilo.com/blazor-ui/chart/pie-chart)
