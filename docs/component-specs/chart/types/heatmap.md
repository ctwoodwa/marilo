...
tags: marilo,blazor,chart,heatmap
published: True
position: 13
components: ["charts"]
---
...
The <a href="https://www.marilo.com/blazor-ui/heatmap" target="_blank">Blazor Heatmap chart</a> shows the data in a grid-like structure that shows the magnitude of a value over two dimensions.
...
## See Also
  ...
  * [Live Demo: Heatmap Chart](https://demos.marilo.com/blazor-ui/chart/heatmap-chart)
