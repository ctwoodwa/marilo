...
description: The Marilo UI for Blazor Waterfall Chart illustrates the cumulative effects of positive or negative values from a starting point. Its purpose is to enhance comprehension of how an initial amount is impacted by subsequently added positive or negative values.
slug: components/chart/types/waterfall
tags: marilo,blazor,chart,waterfall
published: True
position: 0
components: ["charts"]
---
...
## See Also
  ...
  * [Live Demo: Waterfall Chart](https://demos.marilo.com/blazor-ui/chart/waterfall-chart)
