...
tags: marilo,blazor,chart,column
published: True
position: 0
components: ["charts"]
---
...
The <a href="https://www.marilo.com/blazor-ui/column-chart" target="_blank">Blazor Column chart</a> displays data as vertical bars whose heights vary according to their value. You can use a Column chart to show a comparison between several sets of data (for example, summaries of sales data for different time periods). Each series is automatically colored differently for easier reading.
...
## See Also
  ...
  * [Live Demo: Column Chart](https://demos.marilo.com/blazor-ui/chart/column-chart)
