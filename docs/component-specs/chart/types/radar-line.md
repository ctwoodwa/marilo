...
tags: marilo,blazor,chart,radar,Line
published: True
position: 0
components: ["charts"]
---
...
You can render the lines between the points with different styles. The supported styles can be set via the `Style` property that takes a member of `Marilo.Blazor.ChartSeriesStyle` enum:
...
## See Also
  ...
  * [Live Demo: Radar Line Chart](https://demos.marilo.com/blazor-ui/chart/radar-line-chart)
