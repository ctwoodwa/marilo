...
tags: marilo,blazor,chart,date,axis
published: true
position: 30
components: ["charts"]
---
...
You can control the aggregation level through the `BaseUnit` property of the axis. It takes a member of the `Marilo.Blazor.ChartCategoryAxisBaseUnit` class.

You can set the aggregation function through the `Aggregate` property of the series. It takes a member of the `Marilo.Blazor.ChartSeriesAggregate` class.
