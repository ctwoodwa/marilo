...
description: Learn more about the Zoom feature of the Marilo UI for Blazor Chart component and explore the available examples.
slug: components/chart/zoom
tags: marilo, blazor, chart, event, pan, zoom
published: true
position: 1
components: ["charts"]
---
...
The `Zoom` feature allows you to zoom in or out the Marilo UI for Blazor Chart component. This functionality works with both `category` and `numeric` series.
...
## See Also
  ...
  * [Live Demos: Chart - Pan and Zoom](https://demos.marilo.com/blazor-ui/chart/pan-zoom)
