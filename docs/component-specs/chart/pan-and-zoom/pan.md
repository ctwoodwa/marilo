...
description: Learn more about the Pan feature of the Marilo UI for Blazor Chart component and explore the available examples.
...
The `Pan` feature allows you to navigate through the Marilo Blazor Chart component. This functionality works with both `category` and `numeric` series.
