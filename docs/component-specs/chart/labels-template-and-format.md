...
tags: marilo,blazor,chart,label,template,format
published: true
position: 22
components: ["charts"]
---
...
* [Complex logic in Chart label format](https://github.com/marilo/blazor-ui/tree/master/chart/label-template)
