...
tags: marilo,blazor,chart,stack,group
published: True
position: 20
components: ["charts"]
---
...
To use a 100% stacks, set the `Type` property of the first stacked series to `Marilo.Blazor.ChartSeriesStackType.Stack100`.
