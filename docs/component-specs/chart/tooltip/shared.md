...
tags: marilo,blazor,chart,tooltip,shared,tooltips
published: True
position: 2
components: ["charts"]
---
# Shared Tooltip for Marilo Blazor Chart

The Marilo Chart allows you to show a unified tooltip for all categories in [Categorical](slug:components/chart/databind#series-types) Charts.
...
1. Inside the `<MariloChart>` tag, add the `<ChartTooltip>` tag.
