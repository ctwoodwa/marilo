...
description: The DrillDown feature of the Marilo Chart for Blazor allows users to explore hierarchical data by initially displaying summarized information and to drill down into specific categories or data points for more detailed insights.
slug: chart-drilldown
tags: marilo,blazor,chart,drill,down,drilldown
published: true
position: 55
components: ["charts"]
---
...
The Marilo UI for Blazor Chart supports drilldown functionality for exploring data.
...
1. Declare a `MariloChartBreadcrumb` component.
...
````RAZOR
<MariloChartBreadcrumb ChartId="@ChartId"></MariloChartBreadcrumb>
...
````RAZOR
<MariloButton OnClick="@ResetDrilldownLevel">Reset Drilldown level the Chart</MariloButton>
...
@code {
    private MariloChart ChartRef { get; set; } = null!;
...
* [Live Demo: DrillDown Charts](https://demos.marilo.com/blazor-ui/chart/drilldown-chart)
