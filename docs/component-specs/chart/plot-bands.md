...
tags: marilo,blazor,chart,plot,bands,plotbands
published: true
position: 45
components: ["charts"]
---
...
Plot Bands are colored ranges in the Marilo UI for Blazor Chart. Their purpose is to highlight areas of the chart by changing the background in a predefined axis range.
...
* [Live Demo: Chart Plot Bands](https://demos.marilo.com/blazor-ui/chart/plot-bands)
