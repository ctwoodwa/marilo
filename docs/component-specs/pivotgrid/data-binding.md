...
description: What are the different ways to provide data to the Marilo UI for Blazor PivotGrid. Information about XMLA datasource, local data.
...
* When using load on demand, XMLA binding supports custom aggregate functions that are defined and performed in the OLAP cube. Local data supports only the [predefined aggregate types in the `PivotGridAggregateType` enum](slug:marilo.blazor.pivotgridaggregatetype).
...
<MariloPivotGridContainer>
    ...
    <MariloPivotGrid DataProviderType="@PivotGridDataProviderType.Xmla"
                      TItem="object">
        <PivotGridSettings>
            <PivotGridXmlaDataProviderSettings ServerUrl="https://demos.marilo.com/olap/msmdpump.dll"
...
* [Live PivotGrid Demos - Local Data Binding](https://demos.marilo.com/blazor-ui/pivotgrid/local-data-binding)
* [Live PivotGrid Demos - OLAP (XMLA) Data Binding](https://demos.marilo.com/blazor-ui/pivotgrid/xmla-data-binding)
