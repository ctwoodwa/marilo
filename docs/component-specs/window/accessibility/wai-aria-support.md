...
page_title: Marilo UI for Blazor Window Documentation | Window Accessibility
...
Out of the box, the Marilo UI for Blazor Window provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Window keyboard navigation works, refer to the [Blazor Window Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/window/keyboard-navigation).
