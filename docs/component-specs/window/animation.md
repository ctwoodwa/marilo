...
description: Learn about the animation options for the Marilo Window component in Blazor.
slug: window-animations
tags: marilo,blazor,window,animations
published: True
position: 4
components: ["window"]
---
...
The Marilo Window component for Blazor provides an option to control the opening animations to enhance the user experience. You can configure the animation type and duration using the following parameters:
...
<div class="k-d-flex k-align-items-stretch k-gap-5">
    ...
    <div class="k-d-flex k-flex-col">
        ...
        <MariloNumericTextBox @bind-Value="@Duration"
                               Width="130px"
                               Id="duration" />
    </div>

    <div class="k-align-self-flex-end">
        <MariloButton OnClick="@(() => Visible = !Visible)">@(Visible ? "Hide Window" : "Show Window")</MariloButton>
    </div>
</div>

<MariloWindow @bind-Visible="@Visible"
               Height="300px"
               Width="300px"
               @bind-Top="@Top"
               @bind-Left="@Left"
