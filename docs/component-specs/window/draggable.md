...
tags: marilo,blazor,window,draggable,movable
published: True
position: 5
components: ["window"]
---
...
<MariloWindow Visible="true" @bind-Left="@TheLeft" @bind-Top="@TheTop">
...
<MariloWindow Visible="true" Draggable="false" Left="400px" Top="200px">
...
## See Also
  ...
  * [Live Demo: Draggable Window](https://demos.marilo.com/blazor-ui/window/draggable)
