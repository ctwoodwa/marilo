...
tags: marilo,blazor,window,modal
published: True
position: 5
components: ["window"]
---
...
<MariloButton OnClick="@( _ => isModalVisible = true )">Open the window</MariloButton>
...
* [Live Demo: Modal Window](https://demos.marilo.com/blazor-ui/window/modal)
