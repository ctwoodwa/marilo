...
tags: marilo,blazor,window,size
published: True
position: 1
components: ["window"]
---
...
You can invoke those actions by setting the `State` parameter. It takes a member of the `Marilo.Blazor.WindowState` enum:
...
<MariloWindow @bind-State="@State" Width="500px" Height="300px" Visible="true"
...
<MariloButton OnClick="@(() => WindowResizable = !WindowResizable)">Toggle Resizable</MariloButton>

<MariloWindow @bind-Visible="@WindowVisible"
...
* [Live Demo: Window Size](https://demos.marilo.com/blazor-ui/window/dimensions)
