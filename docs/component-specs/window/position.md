...
tags: marilo,blazor,window,position
published: True
position: 2
components: ["window"]
---
...
The Marilo Window component provides multiple options to control its position, allowing you to customize its placement and behavior to suit your application's layout and requirements. This article contains the following sections:
...
In this case, the Window will render inside the specified container and not as a child of the [`MariloRootComponent`](slug:rootcomponent-overview).
...
<div id="window-container"
    ...
    <MariloButton OnClick="@( () => WindowVisible = !WindowVisible )">Toggle Window</MariloButton>

    <MariloWindow ContainmentSelector="#window-container"
...
### Center
 ...
 The Marilo Window is automatically centered when the `Top` and `Left` parameters are not set or are explicitly set to `string.Empty`. To see this behavior in action, refer to the [example](#example) below.
...
<MariloWindow @ref="@WindowRef"
    ...
    <WindowFooter>
        <MariloButton OnClick="@CenterWindow">Center Window</MariloButton>
    </WindowFooter>
</MariloWindow>
...
* [Live Demo: Window Position](https://demos.marilo.com/blazor-ui/window/position)
* [Live Demo: Constrain Window Movement](https://demos.marilo.com/blazor-ui/window/constrain-movement)
