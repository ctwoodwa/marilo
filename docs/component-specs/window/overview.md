...
tags: marilo,blazor,window,overview
published: True
position: 0
components: ["window"]
---
...
This article provides basic information about the <a href="https://www.marilo.com/blazor-ui/window" target="_blank">Blazor Window component</a> and its core features.
...
| `ThemeColor` | `string` | A predefined color scheme for the Window, especially the titlebar. Use the available members of the static class [`ThemeConstants.Window.ThemeColor`](slug:Marilo.Blazor.ThemeConstants.Window.ThemeColor). |
...
````RAZOR
<MariloButton OnClick="@OpenWindow">Open Window</MariloButton>

<MariloWindow @ref="WindowRef" @bind-Visible="@WindowVisible">
    <WindowTitle>
        Window Title
    </WindowTitle>
    <WindowActions>
    ...
    <WindowContent>
        ...
        <MariloButton OnClick="IncrementCount">Increment Count</MariloButton>
    </WindowContent>
</MariloWindow>

@code {
    private MariloWindow? WindowRef { get; set; }
...
When [`ContainmentSelector`](slug:components/window/position#containmentselector) is not set, the Marilo Window component renders as a child of the [`MariloRootComponent`](slug:rootcomponent-overview) at the root of the Blazor app. This placement ensures that the Window can show over all the other page content in all scenarios and have a correct position.
...
* [Live Demo: Window](https://demos.marilo.com/blazor-ui/window/overview)
* [Window API Reference](slug:Marilo.Blazor.Components.MariloWindow)
