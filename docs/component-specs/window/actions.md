...
tags: marilo,blazor,window,actions
published: True
position: 3
components: ["window"]
---
...
| `Icon` | `string` | The CSS class of the icon to be rendered. Use with the [Marilo font icons](slug:common-features-icons), or set your own font icon class. |
...
<MariloWindow Visible="@WindowVisible">
	<WindowActions>
...
@if (!WindowVisible)
{
	<MariloButton OnClick="@( () => WindowVisible=true )">Show the Window</MariloButton>
}
...
* [(Demo) Window Actions](https://demos.marilo.com/blazor-ui/window/actions)
