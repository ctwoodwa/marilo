...
slug: window-events
tags: marilo,blazor,window,events
published: True
position: 20
components: ["window"]
---
...
This article explains the events available in the Marilo Window for Blazor:
...
<MariloButton OnClick="@ToggleWindow">Toggle the Window</MariloButton>

<MariloWindow Visible="@isVisible" VisibleChanged="@VisibleChangedHandler">
    <WindowTitle>
...
<MariloButton OnClick="@( _ => isVisible = !isVisible )">Toggle the Window</MariloButton>
...
<MariloWindow State="@State" StateChanged="@StateChangedHandler" Width="500px" Height="300px" Visible="true"
...
<MariloWindow Left="@TheLeft" Top="@TheTop" Draggable="true"
