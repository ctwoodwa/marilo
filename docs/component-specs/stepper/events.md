...
slug: stepper-events
tags: marilo,blazor,stepper,events
published: True
position: 25
components: ["stepper"]
---
...
This article explains the events available in the Marilo Stepper for Blazor:
...
The Marilo Stepper for Blazor supports ValueChanged event. It fires upon every change of the CurrentStepIndex.
...
<MariloStepper ValueChanged="@ValueChangeHandler">
    <StepperSteps>
...
## See Also
  ...
  * [Live Demo: Stepper Events](https://demos.marilo.com/blazor-ui/stepper/events)
