...
tags: marilo,blazor,stepper,steps,validation
published: True
position: 7
components: ["stepper"]
---
...
<div style="width:700px">
    <MariloStepper Linear="true" Value="@StepperValue" ValueChanged="@HandleValueChanged">
        <StepperSteps>
...
<div style="width:700px">
    <MariloStepper StepType="@StepperStepType.Labels" Linear="true" 
...
## See Also
  ...
  * [Live Demo: Stepper Validation](https://demos.marilo.com/blazor-ui/stepper/validation)