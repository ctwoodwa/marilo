...
tags: marilo,blazor,treelist,templates,column,menu
published: True
position: 40
components: ["treelist"]
---
...
The Column Chooser Template lets you control the rendering of the [ColumnChooser](slug:treelist-column-menu#column-chooser). It exposes a [`context`](slug:Marilo.Blazor.Components.ColumnMenuChooserTemplateContext) object that contains a list of all columns in the TreeList. 
 ...
 * [Live Demo: TreeList Templates](https://demos.marilo.com/blazor-ui/treelist/templates)
 * [Live Demo: TreeList Column Menu](https://demos.marilo.com/blazor-ui/treelist/column-menu)
 * [Live Demo: TreeList Custom Column Menu](https://demos.marilo.com/blazor-ui/treelist/custom-column-menu)
