...
tags: marilo,blazor,treelist,templates,filter
published: True
position: 35
components: ["treelist"]
---
...
<MariloTreeList Data="@TreeListData" FilterMode="@TreeListFilterMode.FilterRow"
...
<MariloTreeList Data="@Data" FilterMode="@TreeListFilterMode.FilterMenu"
                 Pageable="true" IdField="Id" ParentIdField="ParentId" Width="850px">
    <TreeListColumns>
        <TreeListColumn Field="Name" Expandable="true" Width="320px" Filterable="false" />
        <TreeListColumn Field="Id" Filterable="false" Width="100px" />
        <TreeListColumn Field="Role" Width="350px">
            <FilterMenuTemplate>
                ...
                {
                    <div>
                        <MariloCheckBox Value="@(IsCheckboxInCurrentFilter(context.FilterDescriptor, role))"
                                         TValue="bool"
