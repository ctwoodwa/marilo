...
tags: marilo,blazor,treelist,templates,pager
published: True
position: 40
components: ["treelist"]
---
...
>caption Using the Marilo UI for Blazor Slider to paginate the TreeList data

````RAZOR
@* Marilo Blazor TreeList with Pager Template *@
...
<MariloTreeList Data="@TreeListData"
    ...
    <TreeListPagerTemplate>
        <div style="padding:10px">
            <MariloSlider @bind-Value="@CurrentPage"
                           Width="100%"
                           Min="1"
                           Max="@Total">
            </MariloSlider>
