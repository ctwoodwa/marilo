...
tags: marilo,blazor,treelist,templates,popup,edit,create
published: True
position: 50
components: ["treelist"]
---
                ...
                <TreeListPopupEditFormSettings>
                    <FormTemplate>
                        @{
                            ...
                            <MariloForm Model="@EditItem" OnValidSubmit="@OnValidSubmit">
                                <FormItems>
                                ...
                                <FormButtons>
                                    ...
                                    <MariloButton Icon="@nameof(SvgIcon.Cancel)" ButtonType="@ButtonType.Button" OnClick="@OnCancel">Cancel</MariloButton>
                                </FormButtons>
                            </MariloForm>
                        }
                    </FormTemplate>
...
@code {
    ...
    public MariloTreeList<HierarchicalModel> TreeListRef { get; set; }
 ...
 * [Live Demo: TreeList Popup Edit Form Template](https://demos.marilo.com/blazor-ui/treelist/popup-edit-form-template)