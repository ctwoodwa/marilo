...
page_title: Marilo UI for Blazor TreeList Documentation | TreeList Accessibility Overview
description: "Get started with the Marilo UI for Blazor TreeList and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
tags: marilo,blazor,accessibility,wai-aria,wcag,treelist
...
<MariloDialog @bind-Visible="@Visible"
    ...
    <DialogContent>
        ...
        <MariloRadioGroup Data="@RadioOptions"
            ...
            <ItemTemplate>
                ...
                {
                    <span>@item.Text</span>
                    <MariloDropDownList Width="190px"
                                     Data="@RowsList"
                ...
                {
                    <span>@item.Text</span>
                    <MariloDropDownList Width="170px"
                                     Data="@RowsList"
                ...
                {
                    <span>@item.Text</span>
                    <MariloNumericTextBox @bind-Value="@DestinationIndex"
                                       Width="40%"
    ...
    <DialogButtons>
        <MariloButton AriaLabel="Confirm Reorder" OnClick="@OnApplyClick" ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"><MariloSvgIcon Icon="@SvgIcon.Check" /><span style="margin-left: 5px;">Reorder</span></MariloButton>
        <MariloButton AriaLabel="Cancel Reorder" OnClick="@(() => { Visible = false; })"><MariloSvgIcon Icon="@SvgIcon.CancelOutline" /><span style="margin-left: 5px;">Cancel</span></MariloButton>
    </DialogButtons>
</MariloDialog>
...
## See also
 * [Live demo: TreeList Accessibility](https://demos.marilo.com/blazor-ui/treelist/keyboard-navigation)