...
tags: marilo, blazor, treelist, validation, editing
published: True
position: 40
components: ["treelist"]
---
...
>caption Use Marilo TreeList for Blazor with FluentValidation
...
<MariloTreeList Data="@TreeListData"
    ...
    <TreeListToolBarTemplate>
        ...
        <label class="k-checkbox-label">
            <MariloCheckBox @bind-Value="@TreeListValidationEnabled" />
            Enable Validation
        </label>
    </TreeListToolBarTemplate>
    <TreeListColumns>
