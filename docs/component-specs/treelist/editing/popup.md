...
tags: marilo, blazor, treelist, editing, popup
published: True
position: 2
components: ["treelist"]
---
...
The popup edit mode can display a [Marilo Validation Summary component](slug:validation-tools-summary) if the TreeList model is configured for validation.
...
* [Live Demo: TreeList Popup Editing](https://demos.marilo.com/blazor-ui/treelist/editing-popup)
