...
tags: marilo,blazor,treelist,sorting
published: True
position: 21
components: ["treelist"]
---
...
>caption Enable Sorting in Marilo TreeList

````RAZOR
Click a column header to sort by its data

<MariloTreeList Data="@Data" Sortable="true"
...
## See Also
  ...
  * [Live Demo: TreeList Sorting](https://demos.marilo.com/blazor-ui/treelist/sorting)
