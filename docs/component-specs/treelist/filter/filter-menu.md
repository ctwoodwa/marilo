...
tags: marilo,blazor,TreeList,filtering,filter,menu
published: True
position: 10
components: ["treelist"]
---
...
To enable the filter menu, set the `FilterMode` property of the grid to `Marilo.Blazor.TreeListFilterMode.FilterMenu`.
...
>caption Filter Menu in Marilo TreeList
