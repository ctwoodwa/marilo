...
tags: marilo,blazor,TreeList,filtering,filter,CheckBoxList
published: True
position: 15
components: ["treelist"]
---
...
1. Set the `FilterMode` parameter of the grid to `Marilo.Blazor.TreeListFilterMode.FilterMenu`
...
<MariloTreeList Data="@Data" FilterMode="@TreeListFilterMode.FilterMenu" FilterMenuType="@FilterMenuType.CheckBoxList"
...
## See Also
  ...
  * [Live Demo: Treelist CheckBox List Filter](https://demos.marilo.com/blazor-ui/treelist/filter-checkboxlist)
