...
tags: marilo,blazor,TreeList,filtering,filter
published: True
...
* [`Marilo.Blazor.TreeListFilterMode.FilterRow`](slug:treelist-filter-row) - a row of filter options is rendered below the column headers

* [`Marilo.Blazor.TreeListFilterMode.FilterMenu`](slug:treelist-filter-menu) - the column headers render a button that shows a popup with filtering options
...
## See Also
  ...
  * [Live Demo: TreeList Filter Row](https://demos.marilo.com/blazor-ui/treelist/filter-row)
  * [Live Demo: TreeList Filter Menu](https://demos.marilo.com/blazor-ui/treelist/filter-menu)
