...
slug: treelist-state
tags: marilo,blazor,treelist,state,save,load,layout,set,change,management
published: true
position: 50
components: ["treelist"]
---
...
<div id="demo-container">
    ...
    <div id="console">
        ...
        @OnStateChangedCount
        <MariloButton OnClick="@( () => OnStateChangedCount = 0 )">Reset</MariloButton>
        <br /><br />
...
* [Live Demo: TreeList State](https://demos.marilo.com/blazor-ui/treelist/persist-state)
* [TreeListState API reference](slug:Marilo.Blazor.Components.TreeListState-1)
