...
tags: marilo,blazor,treelist,observable,data,new,collection
published: True
position: 60
components: ["treelist"]
---
...
<MariloButton OnClick="@AddRootItem">Add root item at the end of the collection</MariloButton>
...
@code {
    private MariloTreeList<Employee> TreeListRef;
...
<MariloButton OnClick="@ClearData">Clear Data</MariloButton>
