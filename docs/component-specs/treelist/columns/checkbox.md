...
description: Configuration options for the Marilo Blazor TreeList Checkbox Column
slug: treelist-columns-checkbox
tags: marilo,blazor,TreeList,column,selection
published: True
position: 2
components: ["treelist"]
---
...
* [Live Demo: TreeList Selection](https://demos.marilo.com/blazor-ui/treelist/row-selection)
