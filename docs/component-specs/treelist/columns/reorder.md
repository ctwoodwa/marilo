...
tags: marilo,blazor,treelist,column,reorder,drag
published: True
position: 2
components: ["treelist"]
---
...
>caption Reordering columns in the Marilo TreeList

![Reorder columns in the marilo treelist](images/column-reorder.gif)



## See Also

  * [Live Demo: Column Reordering](https://demos.marilo.com/blazor-ui/treelist/column-reordering)
