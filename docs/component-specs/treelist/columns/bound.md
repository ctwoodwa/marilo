...
tags: marilo,blazor,treelist,bound,column
published: True
position: 0
components: ["treelist"]
---
...
<MariloTreeList Data="@Data" Pageable="true" IdField="Id" ParentIdField="ParentId" Width="650px">
    <TreeListColumns>
...
>tip You can find more examples in the rest of the treelist documentation and in our [live demos](https://demos.marilo.com/blazor-ui/treelist/overview).
...
## See Also
  ...
  * [Live Demo: TreeList Columns](https://demos.marilo.com/blazor-ui/treelist/columns)
