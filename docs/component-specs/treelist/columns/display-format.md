...
tags: marilo,blazor,treelist,column,display,format
published: True
position: 2
components: ["treelist"]
---
...
<MariloTreeList Data="@Data" ItemsField="Items" Pageable="true">
    <TreeListColumns>
...
## See Also
  ...
  * [Live Demo: Cell Formatting](https://demos.marilo.com/blazor-ui/treelist/cell-formatting)
