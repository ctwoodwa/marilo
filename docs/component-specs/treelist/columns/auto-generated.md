...
tags: marilo,blazor,treelist,column,automatic,automatically,generated,columns
published: true
position: 5
components: ["treelist"]
---
...
>tip To use the attributes listed above the `System.ComponentModel.DataAnnotations` using statement has to be present in the file with your model. With [Popup editing](https://demos.marilo.com/blazor-ui/treelist/editing-popup), you can use validation attributes in addition to the customization attributes.
...
* [Live Demo: Auto Generated Columns](https://demos.marilo.com/blazor-ui/treelist/column-auto-generation)
