...
tags: marilo,blazor,treelist,column,columns,menu
published: True
position: 20
components: ["treelist"]
---
...
To enable the Column Menu, set the `ShowColumnMenu` parameter of the `<MariloTreeList>` tag to `true`. This will enable the menu for each column of the TreeList.
