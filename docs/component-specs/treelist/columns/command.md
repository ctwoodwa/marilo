...
tags: marilo,blazor,treelist,column,command
published: True
position: 1
components: ["treelist"]
---
...
* Appearance properties like `Icon`, `Class`, `Enabled` that are come from the underlying [Marilo UI for Blazor Button Component features](slug:components/button/overview).
...
## See Also
  ...
  * [Live Demo: TreeList Command Column](https://demos.marilo.com/blazor-ui/treelist/editing-inline)
