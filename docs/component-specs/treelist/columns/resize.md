...
tags: marilo,blazor,treelist,column,resize,drag
published: True
position: 3
components: ["treelist"]
---
...
>caption How column resizing works in the Marilo TreeList
...
````RAZOR
<MariloButton OnClick="@AutoFitSingleColumn">AutoFit Name Column</MariloButton>
<MariloButton OnClick="@AutoFitMultipleColumns">AutoFit Id and ParentId Columns</MariloButton>
<MariloButton OnClick="@AutoFitAllColumns">AutoFit All Columns</MariloButton>

<MariloTreeList @ref="@TreeList" Data="@TreeListData" Resizable="true"
...
@code {
    private MariloTreeList<Employee>? TreeList { get; set; }
...
* [Live Demo: Column Resizing](https://demos.marilo.com/blazor-ui/treelist/column-resizing)
