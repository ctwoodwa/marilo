...
tags: marilo,blazor,treelist,selection,overview 
published: True
position: 0
components: ["treelist"]
---
...
You can configure the selection behavior by setting the TreeList `SelectionMode` parameter to a member of the `Marilo.Blazor.TreeListSelectionMode` enum. The TreeList supports the following selection modes:
...
* [Live Demo: TreeList Row Selection](https://demos.marilo.com/blazor-ui/treelist/row-selection)
