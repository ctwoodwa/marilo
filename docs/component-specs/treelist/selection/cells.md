...
tags: marilo,blazor,treelist,selection,cells
position: 5
components: ["treelist"]
---
# Cell Selection
...
| --- | --- | --- |
| `ColumnField` | `string` | The value of the TreeList column [`Field` parameter](slug:marilo.blazor.components.common.boundcolumnbase#Marilo_Blazor_Components_Common_BoundColumnBase_Field), if set. |
| `ColumnId` | `string` | The value of the TreeList column [`Id` parameter](slug:Marilo.Blazor.Components.Common.ColumnBase#Marilo_Blazor_Components_Common_ColumnBase_Id), if set. |
...
* [Live Demo: TreeList Cell Selection](https://demos.marilo.com/blazor-ui/treelist/cell-selection)
