...
tags: marilo,blazor,treelist,data,bind,databind,databinding,basics
published: True
position: 0
components: ["treelist"]
---
...
The properties of a treelist item match directly to a field of the model the treelist is bound to. You provide that relationship by providing the name of the field from which the corresponding information is to be taken. To do this, in the main `MariloTreeList` tag, use the parameters described below:
...
## See Also
  ...
  * [Live Demo: TreeList Flat Data](https://demos.marilo.com/blazor-ui/treelist/binding-flat-data)
  * [Live Demo: TreeList Hierarchical Data](https://demos.marilo.com/blazor-ui/treelist/binding-hierarchical-data)
  * [Live Demo: TreeList Load on Demand](https://demos.marilo.com/blazor-ui/treelist/load-on-demand)
