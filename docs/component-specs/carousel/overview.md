...
tags: marilo,blazor,carousel,overview
published: True
position: 0
components: ["carousel"]
---
...
The <a href = "https://www.marilo.com/blazor-ui/carousel" target="_blank">Carousel for Blazor</a> is an interactive component that allows users to browse a collection of content items (pages) one at a time. The Carousel template supports random web content, although it is most often used to display images.

## Creating Blazor Carousel

1. Use the `MariloCarousel` tag to add the component to your razor page.
...
The table below lists the Carousel methods. Also consult the [Carousel API](slug:Marilo.Blazor.Components.MariloCarousel-1).
...
@code{
    private MariloCarousel<MyModel> CarouselRef;
}
````
...
* [Carousel Live Demo](https://demos.marilo.com/blazor-ui/carousel/overview)
* [Carousel API Reference](slug:Marilo.Blazor.Components.MariloCarousel-1)
