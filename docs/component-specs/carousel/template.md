...
tags: marilo,blazor,carousel,template
published: True
position: 10
components: ["carousel"]
---
...
The nested `<Template>` tag of the `<MariloCarousel>` represents a standard [`RenderFragment`](https://docs.microsoft.com/en-us/aspnet/core/blazor/components/templated-components).
