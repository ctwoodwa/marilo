...
tags: marilo,blazor,popover,popover,align,position,collision
published: True
position: 10
components: ["popover"]
---
...
<div>
    <label>
        Popover Position
        <MariloDropDownList @bind-Value="@PopoverPositionType" Data="@PopoverPositions" Width="200px" />
    </label>
</div>
<div>
    <label>
        Offset
        <MariloNumericTextBox @bind-Value="@PopoverOffset" Width="200px" />
    </label>
</div>
<div>
    <label>
        Popover Collision Type
        <MariloDropDownList @bind-Value="@PopoverCollisionType" Data="@PopoverCollisionTypes" Width="200px" />
    </label>
</div>
...
<MariloPopover @ref="@PopoverRef"
    ...
    <PopoverContent>
        I am a Marilo Popover
    </PopoverContent>
    <PopoverActions>
        <MariloButton OnClick="@(() => PopoverRef?.Hide())" Icon="@SvgIcon.X">Close</MariloButton>
    </PopoverActions>
</MariloPopover>
