...
tags: marilo,blazor,gridlayout,items
published: True
position: 5
...
<MariloNumericTextBox @bind-Value="@ColumnSpan" Max="3" Min="1" Width="200px"/>
...
<MariloNumericTextBox @bind-Value="@RowSpan" Max="3" Min="1" Width="200px"/>
...
````RAZOR
@* Create a page layout with the Marilo Components *@
...
<MariloGridLayout>
    ...
    <GridLayoutItems>
        <GridLayoutItem Column="1" Row="1" ColumnSpan="3">
            <span>
                <MariloButton OnClick="@(() => DrawerRef.ToggleAsync())" Icon="@("menu")">Toggle drawer</MariloButton>
            </span>
        </GridLayoutItem>
        <GridLayoutItem Column="1" Row="2">

            <div style="width: 200px">
                <MariloDrawer Data="@DrawerData"
                               MiniMode="true"
        ...
        <GridLayoutItem Column="2" Row="2">
            ...
            <MariloGrid Data="@GridData"
                         ...
                         Sortable="true"
                         Groupable="true"
                         FilterMode="Marilo.Blazor.GridFilterMode.FilterRow"
                         Resizable="true"
                         Reorderable="true">
            </MariloGrid>
        ...
        <GridLayoutItem Column="1" ColumnSpan="3">
            <MariloSwitch @bind-Value="@likedLayout" Width="70px" Id="layout-liked" OnLabel="Liked" OffLabel="Not"></MariloSwitch>
