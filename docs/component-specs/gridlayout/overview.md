...
tags: marilo,blazor,gridlayout,overview
published: True
position: 0
...
The <a href="https://www.marilo.com/blazor-ui/gridlayout" target="_blank">Blazor GridLayout component</a> allows you to arrange the contents of the component in rows and columns in a grid structure. 

## Creating GridLayout

1. Add the `<MariloGridLayout>` tag to your razor page. 
...
>caption A basic configuration of the Marilo GridLayout
...
The GridLayout Item defines the content of the MariloGridLayout. [See the Items article for more information...](slug:gridlayout-items)
...
## See Also
  ...
  * [Live Demo: GridLayout](https://demos.marilo.com/blazor-ui/gridlayout/overview)
  * [GridLayout API Reference](slug:Marilo.Blazor.Components.MariloGridLayout)
