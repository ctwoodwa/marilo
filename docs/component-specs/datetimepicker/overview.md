...
tags: marilo,blazor,datetime,picker,datetimepicker,overview
published: True
position: 0
...
1. Add the `MariloDateTimePicker` tag to your razor page.
...
<MariloDateTimePicker Min="@Min" Max="@Max" @bind-Value="@selectedTime"
                       Format="dd MMM yyyy HH:mm:ss" Width="250px"></MariloDateTimePicker>
...
Add a reference to the component instance to use the [Date Time Picker's methods](slug:Marilo.Blazor.Components.MariloDateTimePicker-1).
...
````RAZOR
<MariloDateTimePicker @ref="@DateTimePickerRef"
...
@code {  
    ...
    private MariloDateTimePicker<DateTime> DateTimePickerRef { get; set; }
...
* [Live Demo: DateTime Picker](https://demos.marilo.com/blazor-ui/datetimepicker/overview)
* [Input Validation](slug:common-features/input-validation)
* [Supported Input Date Formats](slug:components/dateinput/supported-formats)
* [DateTimePicker API Reference](slug:Marilo.Blazor.Components.MariloDateTimePicker-1)
