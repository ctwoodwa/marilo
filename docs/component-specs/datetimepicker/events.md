...
tags: marilo,blazor,DateTimePicker,events
published: true
position: 20
...
This article explains the events available in the Marilo DateTimePicker for Blazor:
...
<MariloDateTimePicker @bind-Value="@DateTimePickerValue"
...
As an argument, the event handler receives a [`DateTimePickerCalendarCellRenderEventArgs` object](slug:marilo.blazor.components.datetimepickercalendarcellrendereventargs), which contains the following properties:
...
As an argument, the event handler receives a [`DateTimePickerCloseEventArgs` object](slug:marilo.blazor.components.datetimepickercloseeventargs), which contains the following properties:
...
<MariloDateTimePicker Value="@DateTimePickerValue" 
