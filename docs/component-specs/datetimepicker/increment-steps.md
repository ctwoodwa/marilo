...
tags: marilo,blazor,DateTimePicker,step
published: true
position: 5
...
<MariloDateTimePicker Format="yyyy MMM dd, HH:mm:ss tt" @bind-Value="@selectedDateTime" Width="250px">
...
* [Live Demo: DateTime Picker Incremental Steps](https://demos.marilo.com/blazor-ui/datetimepicker/incremental-steps)
