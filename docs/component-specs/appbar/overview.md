...
tags: marilo,blazor,appbar,navbar
published: True
position: 0
components: ["appbar"]
---
...
The <a href = "https://www.marilo.com/blazor-ui/appbar" target="_blank">Blazor AppBar component</a> helps you build navigation bars for your application seamlessly. This article explains how to start using the component and describes its features.

## Creating Blazor AppBar

1. Add the `<MariloAppBar>` tag to a Razor file.
...
>caption Basic configuration of the Marilo AppBar
...
| `ThemeColor` | `Marilo.Blazor.ThemeConstants.AppBar.ThemeColor` | Adjust the color of the AppBar |
...
````RAZOR
<MariloButton OnClick="@RefreshAppBar">Refresh AppBar</MariloButton>

<MariloAppBar @ref="AppBarRef" />

@code {
	private MariloAppBar AppBarRef { get; set; }
...
* [Live AppBar Demos](https://demos.marilo.com/blazor-ui/appbar/overview)
* [AppBar API Reference](slug:Marilo.Blazor.Components.MariloAppBar)
