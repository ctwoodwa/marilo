...
tags: marilo,blazor,appbar,sections,section,content
published: True
position: 1
components: ["appbar"]
---
...
>caption The Marilo AppBar sections with its parameter
...
<MariloButton OnClick="@(() => isSectionVisible = !isSectionVisible)">Toggle the visibility of the Our Mission section</MariloButton>
