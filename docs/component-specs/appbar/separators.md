...
description: Separate items in the Marilo AppBar for Blazor
slug: appbar-separators
tags: marilo,blazor,appbar,navbar,separator,spacer
published: True
position: 5
components: ["appbar"]
---
...
You can visually separate the items in the Marilo AppBar for Blazor. Depending on the needs of your application you can use of the following, or a combination of them.
...
## See Also
  ...
  * [Live Demo: AppBar Overview](https://demos.marilo.com/blazor-ui/appbar/overview)
