...
slug: fab-appearance
tags: marilo,blazor,floating action button, appearance
published: True
position: 1
...
<div class="k-flex-basis-auto">
    <label>
        Theme Color
        <MariloDropDownList Data="@ThemeColors" @bind-Value="@ThemeColor">
    ...
    <label>
        Rounded
        <MariloDropDownList Data="@RoundedValues" @bind-Value="@Rounded">
            <DropDownListSettings>
                <DropDownButtonPopupSettings MaxHeight="auto" />
            </DropDownListSettings>
        </MariloDropDownList>
    ...
    <label>
        Size
        <MariloDropDownList Data="@Sizes" @bind-Value="@Size">
            <DropDownListSettings>
                <DropDownButtonPopupSettings MaxHeight="auto" />
            </DropDownListSettings>
        </MariloDropDownList>
...
<MariloFloatingActionButton ThemeColor="@ThemeColor"
                             Rounded="@Rounded"
                             Size="@Size"
...
* [Appearance - Design System Docs](https://www.marilo.com/design-system/docs/components/floatingactionbutton/#appearance)