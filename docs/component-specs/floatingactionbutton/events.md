...
slug: fab-events
tags: marilo,blazor,floating action button,events
published: True
position: 3
...
This article explains the events available in the Marilo Floating Action Button for Blazor:
...
````RAZOR
<MariloFloatingActionButton Id="floating-action-button"
...
<MariloPopup @ref="@PopupRef"
    ...
    <div class="k-d-flex k-flex-col k-gap-1.5 k-p-1.5 k-flex-wrap k-align-content-around">
        <MariloButton Icon="@SvgIcon.Download"
        ...
        <MariloButton Icon="@SvgIcon.Trash"
                       ...
                       Size="@ThemeConstants.Button.Size.Large"
                       Title="Delete" />
        <MariloButton Icon="@SvgIcon.Upload"
                       Rounded="@ThemeConstants.Button.Rounded.Full"
                       FillMode="@ThemeConstants.Button.FillMode.Flat"
