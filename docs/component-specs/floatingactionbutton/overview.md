...
slug: fab-overview
tags: marilo,blazor,floating action button
published: True
position: 0
...
The <a href="https://www.marilo.com/blazor-ui/floating-action-button" target="_blank">Blazor Floating Action Button</a> is a UI component that shows over the other page content and may not move during scrolling. The component can perform the most logical action expected from a user looking at a particular screen. You can configure the FloatingActionButton to display:
...
1. Use the `<MariloFloatingActionButton>` tag to add the component to your razor page.
2. (optional) Customize the [appearance](slug:fab-appearance) of the Marilo Blazor Floating Action Button.

>caption Basic Blazor Floating Action Button

````RAZOR
Current time: @Result
<MariloFloatingActionButton Size="@ThemeConstants.Button.Size.Large"
...
| `Icon` | `object` | The icon rendered in the Floating Action Button. Can be set to a predefined Marilo icon or a custom one. | 
...
| `Rounded` | `string` <br /> `"full"` | Defines how rounded the borders of the Floating Action Button are. Use predefined value constants from the static class `Marilo.Blazor.ThemeConstants.Button.Rounded`. |
| `Size` | `string` <br /> (`"md"`) | Sets the size of the Floating Action Button. Set it to a predefined value constant from the static class `Marilo.Blazor.ThemeConstants.Button.Size`. |
| `ThemeColor` | `string` <br /> (`"primary"`) | Adjusts the background color of the Floating Action Button. Use predefined values from the static class `Marilo.Blazor.ThemeConstants.Button.ThemeColor`. |
...
* [Live Demo: Floating Action Button](https://demos.marilo.com/blazor-ui/floatingactionbutton/overview)
* [Floating Action Button Events](slug:fab-events)
* [Floating Action Button API Reference](/blazor-ui/api/Marilo.Blazor.Components.MariloFloatingActionButton)