...
tags: marilo,blazor,notification,template,templates
published: True
position: 10
...
<MariloButton OnClick="@AddNotifications">Add notifications</MariloButton>

<MariloNotification @ref="@NotificationReference1">
    <Template>
        The current text is: @context.Text
    </Template>
</MariloNotification>

<MariloNotification @ref="@NotificationReference2">
    <Template>
...
@code {
    public MariloNotification NotificationReference1 { get; set; }
    public MariloNotification NotificationReference2 { get; set; }
...
## See Also
  ...
  * [Live Demo: Notification Template](https://demos.marilo.com/blazor-ui/notification/template)
