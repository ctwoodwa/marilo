...
tags: marilo,blazor,notification,open,close,hide
published: True
position: 20
...
<MariloButton OnClick="@AddAutoClosingNotification">Add Auto closing notification</MariloButton>
...
<MariloButton OnClick="@AddManuallyClosingNotification">Add manually closing notification</MariloButton>
...
<MariloButton OnClick="@AddTwoNotifications">Add two notifications</MariloButton>
<MariloButton OnClick="@HideAllNotification">Hide All Notifications</MariloButton>
