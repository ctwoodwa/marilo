...
tags: marilo, blazor, smartpastebutton, ai, forms, validation
published: True
position: 10
...
<div style="max-width: 500px; display: flex; flex-direction: column; gap: 12px;">
    <MariloTextArea @bind-Value="SourceText"
                     Placeholder="Paste or edit text here" />
    <MariloButton OnClick="@CopyToClipboard">
        Copy Text
    </MariloButton>
        ...
        <FormItems>
            <FormItem Field="@nameof(FormData.Name)" LabelText="Name">
                <Template>
                    ...
                    <div class="k-form-field-wrap">
                        <MariloTextBox Id="name" @bind-Value="FormModel.Name" />
                    </div>
                </Template>
            </FormItem>
            ...
            <FormItem Field="@nameof(FormData.Email)" LabelText="Email">
                <Template>
                    ...
                    <div class="k-form-field-wrap">
                        <MariloTextBox Id="email" @bind-Value="FormModel.Email" />
                        <MariloValidationMessage For="@(() => FormModel.Email)" />
                    </div>
                </Template>
            </FormItem>
        </FormItems>
...
* [SmartPasteButton Live Validation Demo](https://demos.marilo.com/blazor-ui/smartpastebutton/validation)
