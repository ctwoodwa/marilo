...
tags: marilo, blazor, smartpastebutton, events, ai
published: True
position: 20
...
This article describes the events available in the Marilo SmartPasteButton for Blazor:
...
The event handler receives an argument of type [`SmartPasteButtonRequestStartEventArgs`](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.SmartPasteButtonRequestStartEventArgs).
...
<div style="display: flex; max-width: 600px; margin-bottom: 16px;">
    <div style="flex: 1; margin-right: 16px;">
        ...
        <MariloButton OnClick="@CopySampleText" Icon="SvgIcon.Copy">Copy</MariloButton>
    </div>
...
````RAZOR Home.razor
<MariloSmartPasteButton ChatClientKey="gpt-4o-mini"
...
* [SmartPasteButton Live Events Demo](https://demos.marilo.com/blazor-ui/smartpastebutton/events)
