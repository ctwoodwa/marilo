...
The [Blazor PDF Viewer](https://demos.marilo.com/blazor-ui/pdfviewer/overview) toolbar can render built-in and custom tools. This article describes the built-in tools and shows how to add custom tools or customize the toolbar.


## Built-in Tools

By default, the [Blazor PDF Viewer](https://demos.marilo.com/blazor-ui/pdfviewer/overview) displays all its built-in tools in the order below. Use the *tool tag* if you need to define a tool explicitly in a [custom toolbar configuration](#toolbar-configuration).
...
Add a `<PdfViewerToolBar>` tag inside `<MariloPdfViewer>` to configure a custom toolbar, for example:
...
<MariloPdfViewer Data="@PdfSource">
    <PdfViewerToolBar>
        <PdfViewerToolBarCustomTool>
            <MariloButton OnClick="@OnPdfCustomClick">Custom PDF Tool</MariloButton>
        </PdfViewerToolBarCustomTool>
...
* [PdfViewer Live Demo](https://demos.marilo.com/blazor-ui/pdfviewer/overview)
