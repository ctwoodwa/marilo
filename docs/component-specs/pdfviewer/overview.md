...
````RAZOR
<MariloPdfViewer @ref="@PdfViewerRef"
                  Data="@PdfSource">
    <PdfViewerToolBar>
        <PdfViewerToolBarCustomTool>
            <MariloButton OnClick="@OnButtonClick" Icon="@SvgIcon.ArrowRotateCw">Rebind PDF Viewer</MariloButton>
        </PdfViewerToolBarCustomTool>
    </PdfViewerToolBar>
</MariloPdfViewer>

@code {
    private MariloPdfViewer PdfViewerRef { get; set; }
