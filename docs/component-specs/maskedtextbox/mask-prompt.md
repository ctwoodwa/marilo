...
tags: marilo,blazor,masked,textbox,mask,prompt,value
published: true
position: 10
...
This article explains the relationship and the configuration options that tie the Mask, the prompts and the Value of the Marilo MaskedTextbox for Blazor. The settings and behaviors described below let you customize the behavior of the component and what data you will get out of it.
...
The Marilo MaskedTextbox provides a set of built-in rules that it recognizes as special characters when encountered in the `Mask` and they are the main feature of the component that determines how the user writes their input. The reference list below shows the rules and what they do.
...
>tip You can find some examples of different masks in the [Masks Live Demo](https://demos.marilo.com/blazor-ui/maskedtextbox/masks) and in the [Some Sample Masks](slug:maskedtextbox-overview#mask-examples) section of the documentation.
...
<MariloMaskedTextBox Mask="\AB\C---00\0\9" @bind-Value="@invoiceNumber"></MariloMaskedTextBox>
...
<MariloMaskedTextBox Mask="(+999) 000-0000"
                      @bind-Value="@TheValue"
...
<MariloFloatingLabel Text="Credit Card Number:">
    <MariloMaskedTextBox MaskOnFocus="true"
...
<MariloMaskedTextBox PromptPlaceholder="@( CustomPromptPlaceholder ? "a"[0] : ' ' )"
...
>tip You can see the behavior of the prompt features in the [Customization Live Demo](https://demos.marilo.com/blazor-ui/maskedtextbox/customization).
...
* [Live Demo: Masks](https://demos.marilo.com/blazor-ui/maskedtextbox/masks)
* [Live Demo: Customization](https://demos.marilo.com/blazor-ui/maskedtextbox/customization)
