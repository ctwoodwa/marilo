...
tags: marilo,blazor,masked,maskedtextbox,overview
published: True
position: 0
...
1. Add the `<MariloMaskedTextBox>` tag to your razor page.
...
````RAZOR
<MariloMaskedTextBox @bind-Value="@MaskedValue"
...
You can validate the content of the `MariloMaskedTextBox` using the Data Annotation attributes. [See the Input Validation article for an example on how to validate the content of the MaskedTextBox](slug:common-features/input-validation#maskedtextbox).
...
See the [MaskedTextBox API Reference](slug:Marilo.Blazor.Components.MariloMaskedTextBox) for a full list of parameters, methods and events.
...
>tip To learn more about the appearance, anatomy, and accessibility of the MaskedTextBox, visit the [Progress Design System Kit documentation](https://www.marilo.com/design-system/docs/components/maskedtextbox/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.

## MaskedTextBox Reference and Methods


````RAZOR
<MariloButton OnClick="@FocusTextBox">Focus TextBox</MariloButton>

<MariloMaskedTextBox @ref="@MaskedTextBoxRef"
                      @bind-Value="@MaskedValue"
                      Mask="0000-0000-0000-0000"
                      Width="300px" />

@code{
    private MariloMaskedTextBox MaskedTextBoxRef { get; set; }
...
<MariloMaskedTextBox Mask="(+999) 000-0000" @bind-Value="@Phone"></MariloMaskedTextBox><br />
<MariloMaskedTextBox Mask="0000-0000-0000-0000" @bind-Value="@CardNumber"></MariloMaskedTextBox><br />
<MariloMaskedTextBox Mask="000-00-0000" @bind-Value="@SSN"></MariloMaskedTextBox><br />
<MariloMaskedTextBox Mask="L0L 0LL" @bind-Value="@UkPostcode"></MariloMaskedTextBox><br />
<MariloMaskedTextBox Mask="00000" @bind-Value="@ZipCode"></MariloMaskedTextBox><br />
<MariloMaskedTextBox Mask="00000-0000" @bind-Value="@ZipPlus4Code"></MariloMaskedTextBox><br />
...
<MariloMaskedTextBox Mask="@PercentageMask"
...
<MariloMaskedTextBox Mask="LA-\9\0\00000" @bind-Value="@invoiceNumber" IncludeLiterals="true"></MariloMaskedTextBox>
...
* [Live Demo: MaskedTextbox](https://demos.marilo.com/blazor-ui/maskedtextbox/overview)
* [Live Demo: MaskedTextbox Validation](https://demos.marilo.com/blazor-ui/maskedtextbox/validation)
* [Add Floating Label](slug:inputs-kb-floating-label)
* [MaskedTextBox API Reference](slug:Marilo.Blazor.Components.MariloMaskedTextBox)
