...
tags: marilo,blazor,date,range,picker,daterangepicker,overview
published: True
position: 0
...
The <a href="https://www.marilo.com/blazor-ui/daterange-picker" target="_blank">Blazor DateRange Picker component</a> allows the user to select a date range (start and end date) - both from a visual list ([Marilo UI for Blazor Calendar](slug:components/calendar/overview)) or to type it into a [date input](slug:components/dateinput/overview) that can accept only dates. You can control the format shown in the input, and dates the user cannot select, as well as implement validation and respond to events.

## Creating Blazor Date Range Picker

1. Use the `MariloDateRangePicker` tag to add the component to your razor page.
...
| `DisabledDates` | `List<DateTime>` | A list of dates that can not be selected as the start or end of the range. See the <a href="https://demos.marilo.com/blazor-ui/daterangepicker/disabled-dates" target="_blank">Live Demo: Date Range Picker Disabled Dates</a>. |
...
Add a reference to the component instance to use the [Date Range Picker's methods](slug:Marilo.Blazor.Components.MariloDateRangePicker-1).
...
````RAZOR
<MariloButton OnClick="@FocusStart">Focus Start TextBox</MariloButton>
<MariloButton OnClick="@FocusEnd">Focus End TextBox</MariloButton>
<MariloButton OnClick="@OpenPicker">Open DateRangePicker</MariloButton>

<MariloDateRangePicker @ref="@DateRangePickerRef"
...
@code {
    ...
    private MariloDateRangePicker<DateTime> DateRangePickerRef { get; set; }
...
* [Live Demo: Date Range Picker](https://demos.marilo.com/blazor-ui/daterangepicker/overview)
* [Input Validation](slug:common-features/input-validation)
* [Supported Input Date Formats](slug:components/dateinput/supported-formats)
* [DateRangePicker API Reference](slug:Marilo.Blazor.Components.MariloDateRangePicker-1)
