...
tags: marilo,blazor,daterangepicker,template
published: True
position: 15
...
````RAZOR
<MariloDateRangePicker StartValue="@StartDate"
                        EndValue="@EndDate"
                        Format="dd MMMM yyyy"
    ...
    <HeaderTemplate>
        ...
        <span style="padding-right: .6em;">
            <MariloSvgIcon Icon="@SvgIcon.ParameterDateTime" /> Showing
            <strong>
...
@code {
    MariloDateRangePicker<DateTime?> Picker { get; set; }
