...
The Marilo [Blazor Diagram](slug:diagram-overview) provides a few built-in layouts, so that you don't have to define the positions of all shapes and connections manually. The Diagram supports the most popular layout algorithms, including tree layout, force-directed layout and layered layout.
...
````RAZOR
<MariloDiagram Zoom="0.5" Height="360px">
    <DiagramLayout Type="@DiagramLayoutType.Tree">
...
ComponentSpacingX:
<MariloNumericTextBox @bind-Value="@XSpacing" Width="80px" Step="30" />
ComponentSpacingY:
<MariloNumericTextBox @bind-Value="@YSpacing" Width="80px" Step="30" />
OffsetX:
<MariloNumericTextBox @bind-Value="@XOffset" Width="80px" Step="30" />
OffsetY:
<MariloNumericTextBox @bind-Value="@YOffset" Width="80px" Step="30" />
Width:
<MariloNumericTextBox @bind-Value="@LayoutWidth" Width="80px" Step="200" />
