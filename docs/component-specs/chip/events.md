...
slug: chip-events
tags: marilo,blazor,chip,events
published: true
position: 20
components: ["chip"]
---
...
This article showcases the available events in the Marilo Chip component, together with a complete [example](#example).
...
````RAZOR
<MariloChip Selected="@IsChipSelected"
...
* [Live Demo: Chip Events](https://demos.marilo.com/blazor-ui/chip/events)
