...
tags: marilo,blazor,scheduler,navigation
published: true
position: 4
...
````RAZOR
Change active date:
<MariloDatePicker @bind-Value="@StartDate" />
<br />
Change current View:
<MariloDropDownList Data="@AvailableViews" @bind-Value="@CurrView" />


<MariloScheduler Data="@Appointments" @bind-Date="@StartDate" @bind-View="@CurrView" Height="600px">
    <SchedulerViews>
