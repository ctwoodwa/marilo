...
tags: marilo,blazor,scheduler,toolbar
published: True
position: 2
...
The [Blazor Scheduler toolbar](https://demos.marilo.com/blazor-ui/scheduler/toolbar) can render built-in and custom tools. This article shows how to use and customize the toolbar.
...
Add a `<SchedulerToolBar>` tag inside `<MariloScheduler>` to configure the toolbar, for example:
...
<MariloScheduler Data="@Appointments"
    ...
    <SchedulerToolBar>
        ...
        <SchedulerToolBarCustomTool>
            <MariloButton OnClick="@OnCustomToolClick">Show When the Trip to Hawaii Ends</MariloButton>
        </SchedulerToolBarCustomTool>
    </SchedulerToolBar>
    <SchedulerViews>
        <SchedulerDayView />
...
* [Scheduler Live Demo](https://demos.marilo.com/blazor-ui/scheduler/overview)
* [Scheduler Toolbar Demo](https://demos.marilo.com/blazor-ui/scheduler/toolbar)