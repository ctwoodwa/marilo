...
tags: marilo,blazor,scheduler,view,timeline
published: True
position: 5
...
<MariloScheduler Data="@Appointments" @bind-Date="@StartDate" Width="1000px">
    <SchedulerViews>
...
* [Live Demo: Scheduler Timeline View](https://demos.marilo.com/blazor-ui/scheduler/timeline-view)
