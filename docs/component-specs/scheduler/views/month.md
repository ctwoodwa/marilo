...
tags: marilo,blazor,scheduler,view,month
published: True
position: 4
...
<MariloScheduler Data="@Appointments" @bind-Date="@StartDate" @bind-View="@SelectedView" Height="600px">
    <SchedulerViews>
...
* [Live Demo: Scheduler Month View](https://demos.marilo.com/blazor-ui/scheduler/month-view)
