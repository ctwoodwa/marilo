...
tags: marilo,blazor,scheduler,view,agenda
published: True
position: 6
...
<MariloCheckBox @bind-Value="@HideEmptyDays" Id="hide-emptydays-checkbox"></MariloCheckBox>

<MariloScheduler Data="@Appointments" @bind-Date="@StartDate" Width="800px">
    <SchedulerViews>
...
* [Live Demo: Scheduler Agenda View](https://demos.marilo.com/blazor-ui/scheduler/agenda-view)
