...
tags: marilo,blazor,scheduler,observable,data,new,collection
published: True
position: 40
...
You can refresh the Scheduler data by using the Rebind method exposed to the reference of the MariloScheduler.
...
<MariloButton OnClick="@AddAppointment">Add appointment</MariloButton>

<MariloButton OnClick="@RemoveAppointment">Remove appointment</MariloButton>

<MariloButton OnClick="@ChangeData">Change data</MariloButton>

<MariloScheduler @ref="SchedulerRef" Data="@Appointments" @bind-Date="@StartDate" @bind-View="@CurrView" Height="600px" Width="800px">
    <SchedulerViews>
...
@code {
    MariloScheduler<SchedulerAppointment> SchedulerRef { get; set; }
...
<MariloScheduler Data="@Appointments" @bind-Date="@StartDate" @bind-View="@CurrView" Height="600px" Width="800px">
    <SchedulerViews>
        <SchedulerDayView StartTime="@DayStart" />
        <SchedulerWeekView StartTime="@DayStart" />
        <SchedulerMultiDayView StartTime="@DayStart" NumberOfDays="10" />
