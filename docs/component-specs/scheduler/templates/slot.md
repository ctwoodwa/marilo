...
tags: marilo,blazor,scheduler,templates,slot,alldayslot,dateheader
published: True
position: 15
...
Use the `AllDaySlotTemplate` to provide a custom rendering for the cells in the Marilo Scheduler for Blazor that span across a full day. This template can be defined for the [Day, Multiday, and Week Scheduler views](slug:scheduler-views-overview). 
...
Use the `SlotTemplate` to provide a custom rendering for the cells in the Marilo Scheduler for Blazor. This template can be defined for the [Day, Multiday, Month, Timeline, and Week Scheduler views](slug:scheduler-views-overview). 
...
<MariloScheduler @bind-Date="@SelectedDate" Height="600px" Data="@Data"
                  @bind-View="@CurrView"
    ...
    <SchedulerViews>
        <SchedulerDayView>
            <SlotTemplate>
                ...
                {
                    <div style="color: green;"><MariloSvgIcon Icon="@SvgIcon.Pause"></MariloSvgIcon>Lunch Break</div>
                }
            </SlotTemplate>
            <AllDaySlotTemplate>
 ...
 * [Live Demo: Scheduler Templates](https://demos.marilo.com/blazor-ui/scheduler/templates)
