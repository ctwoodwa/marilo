...
tags: marilo,blazor,scheduler,read,navigate,manual,data,data source
published: false
position: 15
...
<MariloGrid Data=@GridData TotalCount=@Total
...
>caption If you have all the data at once, the Marilo .ToDataSourceResult(request) extension method can manage the operations for you
...
<MariloGrid Data=@GridData TotalCount=@Total OnRead=@ReadItems
