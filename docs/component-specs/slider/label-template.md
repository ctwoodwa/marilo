...
tags: marilo,blazor,slider,label,template
published: true
position: 10
components: ["slider"]
---
...
<MariloSlider @bind-Value="@TheValue"
               Min="50.0m"
               Max="170.0m"
               SmallStep="5m"
               LargeStep="20m"
...
<MariloSlider @bind-Value="@TheIndex"
               Min="@Min"
               Max="@Max"
               SmallStep="@Step"
               LargeStep="@Step"
...
* [Live Demo: Slider Label Template](https://demos.marilo.com/blazor-ui/slider/label-template)