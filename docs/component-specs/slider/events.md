...
slug: slider-events
tags: marilo,blazor,slider,events
published: true
position: 20
components: ["slider"]
---
...
This article showcases the available events in the Marilo Slider component:
...
<br />
<br />
<MariloSlider Value="@TheValue" ValueChanged="@( (int v) => ValueChangedHandler(v))"
...
<br />
<br />
<MariloSlider Value="@TheValue" OnChange="@OnChangeHandler"
               SmallStep="5" LargeStep="20" Min="0" Max="100" Width="500px">
</MariloSlider>
