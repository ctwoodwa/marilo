...
tags: marilo,blazor,signature,overview
published: True
position: 0
...
This article provides information about the <a href = "https://www.marilo.com/blazor-ui/signature" target="_blank">Blazor Signature component</a> and its core features.

The Blazor Signature component provides an area where users can draw their signatures with a mouse, pen, or with their fingertips. You can use the component in any application where the users must sign a document. The Blazor Signature integrates easily with the [MariloForm](slug:form-overview). The component stores the value of the signature as a <a href="https://learn.microsoft.com/en-us/dotnet/api/system.buffers.text.base64?view=net-6.0">base64 string</a>

## Creating Blazor Signature

1. Use the `MariloSignature` tag to add the component to your razor page.
...
````RAZOR
<MariloSignature @bind-Value="@SignatureValue" Width="300px" Height="300px">
</MariloSignature>
...
{
    <p><MariloButton OnClick="@SavePng">Save PNG Image</MariloButton></p>
...
<MariloButton OnClick="@RefreshClickHandler">Refresh the Signature</MariloButton>
...
@code {
    private MariloSignature SignatureReference { get; set; }
...
* [Live Demo: Signature](https://demos.marilo.com/blazor-ui/signature/overview)
* [Signature API Reference](slug:Marilo.Blazor.Components.MariloSignature)
