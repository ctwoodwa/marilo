...
tags: marilo,blazor,radial,gauge,overview
published: True
position: 0
...
The <a href = "https://www.marilo.com/blazor-ui/radial-gauge" target="_blank">Marilo Radial Gauge for Blazor</a> represents numerical values on a [scale](slug:radial-gauge-scale) of ranges in a radial format.

## Creating Radial Gauge

1. Add the `<MariloRadialGauge>` tag to your razor page.
...
>caption Basic Marilo Radial Gauge for Blazor.
...
<MariloButton OnClick="@ChangeHeight">Change the height</MariloButton>

<MariloRadialGauge @ref="@RadialGaugeRef" Height="@Height">
    <RadialGaugePointers>
        <RadialGaugePointer Value="20">
        </RadialGaugePointer>
    </RadialGaugePointers>
...
@code{
    Marilo.Blazor.Components.MariloRadialGauge RadialGaugeRef { get; set; }
...
* [Live Demo: Radial Gauge](https://demos.marilo.com/blazor-ui/radialgauge/overview)
