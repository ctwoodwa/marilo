...
tags: marilo,blazor,circular,gauge,scale
published: True
position: 5
...
The scale of the Circular Gauge renders the values, pointers and labels. You can customize it by adding an instance of the `<CircularGaugeScale>` to the `<CircularGaugeScales>` collection, child tag of the `<MariloCircularGauge>`.
...
* [Live Demo: Circular Gauge - Scale Options](https://demos.marilo.com/blazor-ui/circulargauge/scale-options)
