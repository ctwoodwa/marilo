...
tags: marilo,blazor,circular,gauge,overview
published: True
position: 0
...
The <a href = "https://www.marilo.com/blazor-ui/circular-gauge" target="_blank">Marilo Circular Gauge for Blazor</a> represents [numerical values](slug:circular-gauge-pointers) on a circular [scale](slug:circular-gauge-scale).

## Creating Blazor Circular Gauge

1. Add the `<MariloCircularGauge>` tag.
...
>caption Basic Marilo Circular Gauge for Blazor.

````RAZOR
@* Setup a basic circular gauge with center label template *@

<MariloCircularGauge Width="100px" Height="100px">
...
<MariloButton OnClick="@ChangeTheHeight">Change the Height of the component</MariloButton>

<MariloCircularGauge @ref="@CircularGaugeRef" Height="@Height">
    <CircularGaugePointers>
...
@code {
    Marilo.Blazor.Components.MariloCircularGauge CircularGaugeRef { get; set; }
