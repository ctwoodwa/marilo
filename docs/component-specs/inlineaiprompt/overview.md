...
tags: marilo,blazor,inlineaiprompt,overview
published: True
position: 0
...
The Marilo InlineAIPrompt for Blazor is a popup-based component that lets you interact with AI language models right inside your content.
...
1. Add the `<MariloInlineAIPrompt>` tag.
...
>caption Marilo Blazor InlineAIPrompt

````Razor
<div class="products-container">
    @foreach (var product in Products)
    {
        <MariloButton Class="product-card"
...
Get familiar with all InlineAIPrompt parameters, methods, events, and nested tags in the [InlineAIPrompt API Reference](slug:Marilo.Blazor.Components.MariloInlineAIPrompt).
...
<div class="destinations-container">
    ...
    {
        <MariloButton Class="destination-card"
...
* [Live Demo: InlineAIPrompt](https://demos.marilo.com/blazor-ui/inlineaiprompt/overview)