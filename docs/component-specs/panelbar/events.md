...
tags: marilo,blazor,panelbar,events
published: True
position: 25
components: ["panelbar"]
---
...
<div style="width: 30%;">
    <MariloPanelBar Data="@Items" OnItemClick="@OnItemClickHandler">
    </MariloPanelBar>
</div>
...
<div style="width: 30%;">
    <MariloPanelBar Data="@Items" ExpandedItems="@ExpandedItems" ExpandedItemsChanged="@ExpandedItemsChanged">
    </MariloPanelBar>
</div>
...
<div style="width: 30%;">
    <MariloPanelBar Data="@Items" OnItemRender="@OnItemRenderHandler">
    </MariloPanelBar>
</div>
...
````RAZOR
<MariloPanelBar Data="@PanelBarItems"
