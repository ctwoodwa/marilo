...
page_title: Marilo UI for Blazor PanelBar Documentation | PanelBar Accessibility
description: "Get started with the Marilo UI for Blazor PanelBar and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Marilo UI for Blazor PanelBar provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the PanelBar keyboard navigation works, refer to the [Blazor PanelBar Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/panelbar/keyboard-navigation).
