...
tags: marilo,blazor,panelbar,data,bind,databind,databinding,basics
published: True
position: 0
components: ["panelbar"]
---
...
* `Icon` - The [Marilo Font or SVG icon](slug:common-features-icons) that will be rendered in the item. Read more in the [Icons article](slug:panelbar-icons).
...
* Add one `MariloPanelBarBinding` without a level to set the default bindings.
* Add `MariloPanelBarBinding` for each level where you explicitly set the field bindings to your custom fields.
...
## See Also
  ...
  * [Live Demo: PanelBar Flat Data](https://demos.marilo.com/blazor-ui/panelbar/flat-data)
  * [Live Demo: PanelBar Hierarchical Data](https://demos.marilo.com/blazor-ui/panelbar/hierarchical-data)
