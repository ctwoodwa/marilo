...
slug: panelbar-icons
tags: marilo,blazor,panelbar,icon,iconclass,image
published: True
position: 15
components: ["panelbar"]
---
...
You can add [Marilo Font or SVG icons](slug:common-features-icons) to the PanelBar items. The component also supports custom icons.
...
>caption How to use icons in the Marilo PanelBar

````RAZOR
<MariloPanelBar Data="@PanelBarData">
    <PanelBarBindings>
...
* [Live Demos: PanelBar](https://demos.marilo.com/blazor-ui/panelbar/overview)
