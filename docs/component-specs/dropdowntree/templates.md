...
description: Use templates in the Marilo DropDownTree for Blazor to customize the component and items' rendering and appearance.
slug: dropdowntree-templates
tags: marilo,blazor,dropdowntree,templates
published: True
...
<MariloDropDownTree @ref="@DropDownTreeRef"
    ...
    <NoDataTemplate>
        <MariloButton OnClick="@OnLoadItemsClick">Load Items</MariloButton>
    </NoDataTemplate>
    <ValueTemplate>
        @{ var dataItem = (TreeItem)context; }

        <MariloSvgIcon Icon="@SvgIcon.Unlock" />
        <strong style="color: var(--kendo-color-primary)">@dataItem.Text</strong>
    </ValueTemplate>
</MariloDropDownTree>

<MariloButton OnClick="@OnRemoveItemsClick">Remove Data</MariloButton>
<MariloButton OnClick="@OnLoadItemsClick">Load Data</MariloButton>
