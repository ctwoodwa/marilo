...
description: Lazy load child items on demand with the Marilo DropDownTree for Blazor.
...
* [Live Demo: DropDownTree Demos](https://demos.marilo.com/blazor-ui/dropdowntree)
