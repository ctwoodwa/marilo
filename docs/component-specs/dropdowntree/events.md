...
description: The article describes the Marilo Blazor DropDownTree component events and event arguments.
...
This article describes the available events in the Marilo DropDownTree for Blazor:
...
````RAZOR.skip-repl
<MariloDropDownTree ExpandedItems="@DropDownTreeExpandedItems"
...
````RAZOR.skip-repl
<MariloDropDownTree OnBlur="@OnDropDownTreeBlur" />
...
````RAZOR.skip-repl
<MariloDropDownTree OnClose="@OnDropDownTreeClose" />
...
````RAZOR.skip-repl
<MariloDropDownTree Data="@DropDownTreeData"
...
````RAZOR.skip-repl
<MariloDropDownTree OnFocus="@OnDropDownTreeFocus" />
...
````RAZOR.skip-repl
<MariloDropDownTree OnItemClick="@OnDropDownTreeItemClick" />
...
````RAZOR.skip-repl
<MariloDropDownTree OnItemRender="@OnDropDownTreeItemRender" />
...
````RAZOR.skip-repl
<MariloDropDownTree OnOpen="@OnDropDownTreeOpen" />
...
````RAZOR.skip-repl
<MariloDropDownTree Value="@DropDownTreeValue"
...
<div style="display: flex; gap: 2em; justify-content: space-between;">
    ...
    <div style="max-height: 90vh; overflow: auto; flex: 0 0 50%;">
        <p><label class="k-checkbox-label"><MariloCheckBox @bind-Value="@ShowOnItemRender"/> Show OnItemRender events</label></p>
        <MariloButton OnClick="@(() => DropDownTreeEventLog.Clear())">Clear Log</MariloButton>
        <ul>
