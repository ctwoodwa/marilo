...
tags: marilo,blazor,autocomplete,events
published: true
position: 35
...
This article explains the events available in the Marilo AutoComplete for Blazor:
...
<MariloAutoComplete Data="@AutoCompleteData"
...
from model: @Role
<br />
<MariloAutoComplete Data="@Suggestions" Value="@Role" ValueChanged="@( (string v) => MyValueChangeHandler(v) )">
</MariloAutoComplete>
...
from model: @Role
<br />
<MariloAutoComplete Data="@Suggestions" @bind-Value="@Role" OnChange="@MyOnChangeHandler" >
</MariloAutoComplete>
...
@code {
    ...
    async Task ReadItems(AutoCompleteReadEventArgs args)
    {
        ...
        {
            Marilo.DataSource.FilterDescriptor filter = args.Request.Filters[0] as Marilo.DataSource.FilterDescriptor;
...
>caption Filter large local data through the Marilo DataSource extensions
...
@code {
    ...
    {
        //using Marilo extension methods to filter the data
...
<MariloAutoComplete @bind-Value="@TheValue" Data="@Suggestions"
