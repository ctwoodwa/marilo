...
tags: marilo,blazor,autocomplete,data,bind,binding,databind
published: True
position: 5
...
<br />
<MariloAutoComplete Data="@Suggestions" @bind-Value="@FirstValue" />

<br />
User input 2: @SecondValue
<br />
<MariloAutoComplete Data="@ArraySuggestions" @bind-Value="@SecondValue" />
