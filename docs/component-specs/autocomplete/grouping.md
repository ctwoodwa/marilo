...
tags: marilo,blazor,autocomplete,group,grouping
published: True
position: 15
...
* A grouped AutoComplete will provide a `Groups` property with a single [`GroupDescriptor`](slug:Marilo.DataSource.GroupDescriptor) in the [`DataSourceRequest`](slug:Marilo.DataSource.DataSourceRequest) argument of its [OnRead event](slug:autocomplete-events#onread). This will allow the developer to apply grouping with [manual data operations](slug:components/grid/manual-operations).

## See Also

  * [Live Demo: AutoComplete Grouping](https://demos.marilo.com/blazor-ui/autocomplete/grouping)
