...
tags: marilo,blazor,combo,autocomplete,filter
published: True
position: 10
...
The AutoComplete component can filter the available suggestions, according to the current input. In this way users can find the desired value faster. To see the difference in behavior, visit the [Live Demo: AutoComplete Filtering](https://demos.marilo.com/blazor-ui/autocomplete/filtering) page.
...
<ul>
    ...
    <li>
        <label>
            Debounce delay:
            <MariloNumericTextBox @bind-Value="@AutoCompleteDebounceDelay" Min="0" Width="120px" />
        </label>
    </li>
</ul>
...
<MariloAutoComplete Data="@Suggestions"
...
* [Live Demo: AutoComplete Filtering](https://demos.marilo.com/blazor-ui/autocomplete/filtering)
