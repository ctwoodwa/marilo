...
tags: marilo,blazor,rating,templates
published: True
position: 11
components: ["rating"]
---
    ...
    <ItemTemplate>
        @{
            if (context.Index + 1 > 3)
            {
                ...
                {
                    <MariloSvgIcon Icon="@SvgIcon.Heart" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></MariloSvgIcon>
                }
                else
                {
                    <MariloSvgIcon Icon="@SvgIcon.HeartOutline" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></MariloSvgIcon>
                }
            }
            else
            {
                if (context.Selected || context.Highlighted)
                {
                    <MariloSvgIcon Icon="@SvgIcon.Star" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></MariloSvgIcon>
                }
                else
                {
                    <MariloSvgIcon Icon="@SvgIcon.StarOutline" Size="@ThemeConstants.SvgIcon.Size.ExtraLarge"></MariloSvgIcon>
                }
            }
        }
    </ItemTemplate>
...
* [Live Demo: Rating Templates](https://demos.marilo.com/blazor-ui/rating/templates)