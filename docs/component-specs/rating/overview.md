...
The <a href = "https://www.marilo.com/blazor-ui/rating" target="_blank">Blazor Rating</a> is a component that allows you to intuitively rate by selecting number of items stars from a predefined number of items.

## Creating Blazor Rating

1. Add the `<MariloRating>` tag to a Razor file.
...
| ----------- | ----------- | ----------- |
| `AriaLabel` | `string` | The `aria-label` attribute of the `<span class="marilo-blazor k-rating">` element that represents the Rating component. |
| `AriaLabelledBy` | `string` | The `aria-labelledby` attribute of the `<span class="marilo-blazor k-rating">` element that represents the Rating component. |
| `Class` | `string` | The `class` attribute of the `<span class="marilo-blazor k-rating">` element. Use it to apply custom styles or [override the theme](slug:themes-override). |
...
* [Live Rating Demos](https://demos.marilo.com/blazor-ui/rating/overview)
* [Rating API Reference](slug:Marilo.Blazor.Components.MariloRating)
