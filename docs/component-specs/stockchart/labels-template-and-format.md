...
tags: marilo,blazor,stock,stockchart,chart,label,template,format,customize
published: true
position: 23
...
>tip The template syntax works the same way for the Marilo UI for Blazor Chart and StockChart.
...
* [Live Demos: StockChart](https://demos.marilo.com/blazor-ui/stockchart/overview)
