...
tags: marilo,blazor,stock,chart,navigator
published: true
position: 2
...
1. set up a [`<MariloStockChart>`](slug:stockchart-overview)
1. add a `<StockChartNavigator>` inside the main `<MariloStockChart>`
