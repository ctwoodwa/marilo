...
tags: marilo,blazor,stock,chart,tooltip,shared,tooltips
published: True
position: 2
components: ["stockchart"]
---
# Shared Tooltip for Marilo Blazor Stock Chart

The Marilo Stock Chart allows you to show a unified tooltip for all categories in the Chart.
...
1. Inside the `<MariloStockChart>` tag, add the `<StockChartTooltip>` tag.
