...
tags: marilo,blazor,stock,chart,candlestick
published: True
position: 0
...
1. set the `DateField` property of the `MariloStockChart` to the corresponding field in the model that carry the value.
