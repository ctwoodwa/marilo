...
description: Expand Items in the Marilo TreeView.
slug: treeview-expand-items
tags: marilo,blazor,treeview,expand,items
published: True
position: 4
components: ["treeview"]
---
...
<p>
    <label>Item Id: <MariloNumericTextBox @bind-Value="@ItemToExpand" Width="80px" /></label>
    <MariloButton OnClick="@ExpandItem">Expand Item @ItemToExpand</MariloButton>
</p>
<p>
    <MariloButton OnClick="@ExpandRoot">Expand Root Items</MariloButton>
    <MariloButton OnClick="@ExpandAll">Expand All</MariloButton>
    <MariloButton OnClick="@CollapseAll">Collapse All</MariloButton>
</p>
