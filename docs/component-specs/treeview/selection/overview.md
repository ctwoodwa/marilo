...
tags: marilo,blazor,treeview,selection,overview
published: True
position: 1
components: ["treeview"]
---
...
@if (SelectedItems.Any())
{
    ...
    <div>
        Selected item: <strong> <MariloSvgIcon Icon="@selectedItem.Icon" /> @selectedItem.Text</strong>
    </div>
}
...
## See Also
  ...
  * [Live Demo: TreeView Selection](https://demos.marilo.com/blazor-ui/treeview/selection)
