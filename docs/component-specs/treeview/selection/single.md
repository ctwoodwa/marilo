...
tags: marilo,blazor,treeview,selection,single
published: True
position: 5
components: ["treeview"]
---
...
To use **single** node selection, set the `SelectionMode` parameter to `Marilo.Blazor.TreeViewSelectionMode.Single`.
...
@if (SelectedItems.Any())
{
    ...
    <div>
        ...
        <div class="card" style="width: 15rem">
            <span><strong>Icon:</strong> <MariloSvgIcon Icon="@selectedItem.Icon" /></span>
