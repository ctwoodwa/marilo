...
tags: marilo,blazor,treeview,selection,multiple
published: True
position: 10
components: ["treeview"]
---
...
To use **multiple** node selection, set the `SelectionMode` parameter to `Marilo.Blazor.TreeViewSelectionMode.Multiple`.
...
@if (SelectedItems.Any())
{
    ...
    foreach (var item in SelectedItems)
    {
        <div class="card" style="width: 15rem">
            <span><strong>Icon:</strong> <MariloSvgIcon Icon="@((item as TreeItem).Icon)" /></span>
