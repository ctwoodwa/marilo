...
| --- | --- | --- |
| `Class` | `string` | The additional CSS class that will be rendered on the `ul.mar-treeview` element. Use it to apply custom styles or [override the theme](slug:themes-override). Inherited from `MariloComponentBase`. |
