...
slug: treeview-icons
tags: marilo,blazor,treeview,icon,iconclass,image
published: True
position: 15
components: ["treeview"]
---
...
You can add [Marilo Font or SVG icons](slug:common-features-icons) to the TreeView items. The component also supports custom icons.
...
>caption How to use icons in the Marilo TreeView
