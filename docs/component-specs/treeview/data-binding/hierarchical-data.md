...
tags: marilo,blazor,treeview,data,bind,databind,databinding,hierarchical
published: True
position: 2
components: ["treeview"]
---
...
<MariloTreeView Data="@HierarchicalData" @bind-ExpandedItems="@ExpandedItems">
    <TreeViewBindings>
...
## See Also
  ...
  * [Live Demo: TreeView Hierarchical Data](https://demos.marilo.com/blazor-ui/treeview/hierarchical-data)
