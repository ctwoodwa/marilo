...
| `Icon` | Defines a [Marilo Font and Svg icon](slug:common-features-icons) |
...
* [Live Demo: Multiple Level Bindings](https://demos.marilo.com/blazor-ui/treeview/bindings)
