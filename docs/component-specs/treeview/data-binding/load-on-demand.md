...
tags: marilo,blazor,treeview,data,bind,databind,databinding,load,demand
published: True
position: 3
components: ["treeview"]
---
...
<MariloTreeView Data="@HierarchicalData" OnExpand="@LoadChildren">
    <TreeViewBindings>
...
<MariloTreeView Data="@FlatData" OnExpand="@LoadChildren">
    <TreeViewBindings>
...
@code {
    ...
    private async Task LoadChildren(TreeViewExpandEventArgs args)
    {
        ...
        if (args.Expanded && args.Item is ProductCategoryItem)
        {
            ...
            // the AddRange() method comes from the Marilo.DataSource.Extensions
...
## See Also
  ...
  * [Live Demo: TreeView Load on Demand](https://demos.marilo.com/blazor-ui/treeview/lazy-loading)
