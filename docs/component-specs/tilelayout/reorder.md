...
tags: marilo,blazor,tile,layout,dashboard,reorder
published: True
position: 20
...
To enable reordering, set the `Reorderable` parameter of the main `MariloTileLayout` tag to `true`.
...
````RAZOR
<MariloTileLayout ColumnWidth="200px"
                   RowHeight="150px"
                   Width="700px"
                   Columns="3"
                   Reorderable="true">
...
* [Live Demo: TileLayout Reordering](https://demos.marilo.com/blazor-ui/tilelayout/reordering)
