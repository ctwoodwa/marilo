...
tags: marilo,blazor,tile,layout,dashboard,state
published: True
position: 25
...
You can see this feature in the [Live Demo: TileLayout State](https://demos.marilo.com/blazor-ui/tilelayout/persist-state).
...
<MariloButton OnClick="@SaveState" Icon="@SvgIcon.Save" Class="mr-sm">Save State</MariloButton>
<MariloButton OnClick="@ReloadPage" Icon="@SvgIcon.ArrowRotateCw" Class="mr-sm">Reload the page</MariloButton>
<MariloButton OnClick="@LoadState" Icon="@SvgIcon.Download" Class="mr-sm">Load last State</MariloButton>
<MariloButton OnClick="@SetExplicitState" Icon="@SvgIcon.Gear" Class="mr-sm">Configure State</MariloButton>

<MariloTileLayout @ref="@TileLayoutInstance"
                   Columns="3"
                   Resizable="true"
                   Reorderable="true">
    <TileLayoutItems>
...
@code {
    MariloTileLayout TileLayoutInstance { get; set; }
    TileLayoutState SavedState { get; set; }
    
    string stateStorageKey = "MariloBlazorTileLayoutStateDocsKey";
...
* [Live Demo: TileLayout State](https://demos.marilo.com/blazor-ui/tilelayout/persist-state)
