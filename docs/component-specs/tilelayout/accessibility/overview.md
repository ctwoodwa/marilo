...
page_title: Marilo UI for Blazor TileLayout Documentation | TileLayout Accessibility Overview
description: "Get started with the Marilo UI for Blazor TileLayout and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
tags: marilo,blazor,accessibility,wai-aria,wcag,tilelayout
...
The illustrative example below shows the tile resize action, achievable through the [DropDown Button](slug:dropdownbutton-overview). Marilo UI for Blazor aims to offer a versatile API that allows users to trigger all functions programmatically or externally, meeting diverse accessibility requirements for any applications.
            ...
            <TileLayoutItem RowSpan="@item.RowSpan" ColSpan="@item.ColSpan">
                <HeaderTemplate>
                    <div class="header">
                        ...
                        <MariloDropDownButton AriaLabel="Resize Options" ShowArrowButton="false" FillMode="@ThemeConstants.DropDownButton.FillMode.Clear" Icon="@SvgIcon.MoreVertical">
                            <DropDownButtonItems>
                                <DropDownButtonItem OnClick="@(() => HandleTileResize(item))" Icon="@SvgIcon.ImageResize">
                                    Resize tile
                                    <MariloSvgIcon Icon="@SvgIcon.WindowRestore" Class="window-restore" />
                                </DropDownButtonItem>
                            </DropDownButtonItems>
...
<MariloDialog @bind-Visible="@Visible"
    ...
    <DialogContent>
        ...
        <div class="example">
            <div class="column-wrapper">
                <MariloDropDownList Data="@ColSpanOptions"
            ...
            <div class="row-wrapper">
                <MariloDropDownList Data="@RowSpanOptions"
    ...
    <DialogButtons>
        ...
        <MariloButton AriaLabel="Cancel Resize" OnClick="@(() => { Visible = false; })"><MariloSvgIcon Icon="@SvgIcon.Cancel" /><span style="margin-left: 5px;">Cancel</span></MariloButton>
    </DialogButtons>
</MariloDialog>
...
## See also
 * [Live demo: TileLayout Resizing](https://demos.marilo.com/blazor-ui/tilelayout/resizing)