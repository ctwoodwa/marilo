...
page_title: Marilo UI for Blazor Splitter Documentation | Splitter Accessibility
...
Out of the box, the Marilo UI for Blazor Splitter provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For details on how the Splitter keyboard navigation works, refer to the [Blazor Splitter Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/splitter/keyboard-navigation).
