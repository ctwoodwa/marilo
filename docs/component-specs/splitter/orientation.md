...
tags: marilo,blazor,splitter,orientation,horizontal,vertical
published: True
position: 8
components: ["splitter"]
---
...
<p>
    ...
    <MariloRadioGroup Data="@OrientationOptions" Layout="RadioGroupLayout.Horizontal"
                       @bind-Value="@SelectedSplitterOrientation.Value" />
</p>

<MariloSplitter Orientation="@SelectedSplitterOrientation.Value"
...
You can create more complex layouts that include both horizontal and vertical Splitters. To do that, add a Marilo Splitter as a child of another Splitter's pane. Usually, the nested Splitter should be 100% high.
...
* [Live Demo: Splitter Orientation](https://demos.marilo.com/blazor-ui/splitter/orientation)
