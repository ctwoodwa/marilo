...
slug: splitter-panes
tags: marilo,blazor,splitter,panes
published: True
position: 3
...
````RAZOR
<MariloSplitter Width="600px" Height="300px">
    <SplitterPanes>
...
<MariloRadioGroup Data="@SplitterOrientations"
                   @bind-Value="@SplitterOrientation"
                   Layout="@RadioGroupLayout.Horizontal" />

<label><MariloCheckBox @bind-Value="@ShouldSetSplitterHeight" /> Set Splitter Height <code>@SplitterHeight</code></label>
<br />
<label><MariloCheckBox @bind-Value="@ShouldExpandPanesVertically" /> Expand Panes without Splitter Height</label>

<br />
<br />

<MariloSplitter Height="@SplitterHeight"
    ...
    <SplitterPanes>
        <SplitterPane Collapsible="@FirstPaneCollapsible"
            ...
            <ul style="list-style-type: disc;">
                <li>
                    Size: <MariloNumericTextBox Value="@FirstPaneSizeNumber"
                ...
                <li><label><MariloCheckBox @bind-Value="@FirstPaneCollapsible" /> Collapsible</label></li>
                <li><label><MariloCheckBox @bind-Value="@FirstPaneResizable" /> Resizable</label></li>
        ...
        <SplitterPane Collapsible="@MiddlePaneCollapsible"
            ...
            <ul style="list-style-type: disc;">
                ...
                <li><label><MariloCheckBox @bind-Value="@MiddlePaneCollapsible" /> Collapsible</label></li>
                <li><label><MariloCheckBox @bind-Value="@MiddlePaneResizable" /> Resizable</label></li>
        ...
        <SplitterPane Collapsible="@LastPaneCollapsible"
            ...
            <ul style="list-style-type: disc;">
                <li>
                    Size: <MariloNumericTextBox Value="@LastPaneSizeNumber"
                ...
                <li><label><MariloCheckBox @bind-Value="@LastPaneCollapsible" /> Collapsible</label></li>
                <li><label><MariloCheckBox @bind-Value="@LastPaneResizable" /> Resizable</label></li>
