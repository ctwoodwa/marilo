...
tags: marilo,blazor,splitter,overview
published: True
position: 0
components: ["splitter"]
---
...
````RAZOR
<MariloSplitter Orientation="@SplitterOrientation.Horizontal"
                 Width="80%"
                 Height="200px">
    <SplitterPanes>
...
>tip The following sample app shows how to create a 100%-high page layout with a Splitter that includes a header, footer, and sidebar: <a href="https://github.com/marilo/blazor-ui/tree/master/splitter/use-100-percent-viewport" target="_blank">How to make the Splitter take up 100% of the viewport</a>.
...
Add a reference to the component instance to use the [Splitter methods](slug:Marilo.Blazor.Components.MariloSplitter#methods).
...
````RAZOR
<MariloButton OnClick="@GetSplitterState">Get Splitter State</MariloButton>

<MariloSplitter @ref="@SplitterRef"
                 Height="200px">
    <SplitterPanes>
        <SplitterPane>
...
@code {
    private MariloSplitter? SplitterRef { get; set; }
...
* [Live Demo: Splitter](https://demos.marilo.com/blazor-ui/splitter/overview)
* [Splitter API Reference](slug:Marilo.Blazor.Components.MariloSplitter)
* [SplitterPane API Reference](slug:Marilo.Blazor.Components.SplitterPane)
