...
slug: splitter-state
tags: marilo,blazor,splitter,state
published: true
position: 10
components: ["splitter"]
---
...
This article explains how to save, restore and programmatically control the state of the Marilo Splitter for Blazor.
...
<div>
    <MariloButton OnClick="@SaveStateToJson">Save State to JSON</MariloButton>
    <MariloButton OnClick="@ReloadPage">Reload the Page</MariloButton>
    <MariloButton OnClick="@LoadStateFromJson">Load State from JSON</MariloButton>
    <MariloButton OnClick="@SetCustomState">Set custom state</MariloButton>
</div>

<div style="width: 500px; height: 200px;">
    <MariloSplitter @ref="@Splitter"
                     Width="100%"
                     Height="100%">
        <SplitterPanes>
...
@code {
    ...
    MariloSplitter Splitter { get; set; }
