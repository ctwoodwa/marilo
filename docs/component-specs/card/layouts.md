...
slug: card-layouts
tags: marilo,blazor,card,layouts
published: True
position: 11
components: ["card"]
---
...
The Marilo Themes provide the following layouts through built-in classes:
...
In addition, any layout can be created with suitable CSS code. For example - a [Tile layout of Cards that wrap to multiple rows](https://demos.marilo.com/blazor-ui/card/data-cards).
...
## See Also
  ...
  * [Live Demo: Card Layouts](https://demos.marilo.com/blazor-ui/card/layouts)