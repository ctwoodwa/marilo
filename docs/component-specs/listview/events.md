...
tags: marilo,blazor,listview,events
published: true
position: 20
components: ["listview"]
---
...
This article explains the events available in the Marilo ListView for Blazor:
...
<MariloListView Data="@ListViewData" 
                 Pageable="true"
...
<MariloListView Data="@ListViewData" Pageable="true" PageChanged="@PageChangedHandler">
    <Template>
        <h6>@context.Name</h6>
    </Template>
</MariloListView>
