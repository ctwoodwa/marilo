...
tags: marilo,blazor,listview,paging
published: True
position: 4
components: ["listview"]
---
...
<MariloListView Data="@ListViewData" Pageable="true" PageSize="15">
    <Template>
...
* [Live Demo: ListView](https://demos.marilo.com/blazor-ui/listview/overview)
