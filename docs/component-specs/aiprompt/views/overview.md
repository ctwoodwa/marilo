...
tags: marilo,blazor,aiprompt,ai,prompt,view,overview
published: True
position: 0
components: ["aiprompt"]
---
...
| `ButtonIcon` | `object` | The [Marilo Font or SVG icon](slug:common-features-icons) rendered within the toolbar button associated with the view. |
...
<MariloAIPrompt OnPromptRequest="@HandlePromptRequest"></MariloAIPrompt>
