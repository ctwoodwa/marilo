...
tags: marilo,blazor,aiprompt,ai,prompt,commands
published: True
position: 30
components: ["aiprompt"]
---
...
| `Icon` | `object` | The [Marilo Font or SVG icon](slug:common-features-icons) rendered before the title within the Command view. |
