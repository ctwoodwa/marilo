...
tags: marilo,blazor,aiprompt,ai,prompt,toolbar
published: True
position: 20
components: ["aiprompt"]
---
...
You can add multiple buttons to the Marilo AIPrompt. To do that you should add the `<AIPromptToolBarButton>` to the `<AIPromptToolBar>`.
...
<MariloAIPrompt OnPromptRequest="@HandlePromptRequest">
    <AIPromptToolBar>
        ...
        <AIPromptToolBarTemplateItem>
            <MariloSplitButton OnClick="@OnSplitButtonClick">
...
* [Live Demo: AIPrompt Overview](https://demos.marilo.com/blazor-ui/aiprompt/overview)