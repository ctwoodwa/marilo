...
slug: sankey-events
tags: marilo,blazor,sankey,diagram,chart,events
published: True
position: 9
components: ["general"]
---
...
This article explains the available events for the Marilo Sankey Diagram for Blazor:
...
<div style="display:flex; justify-content:stretch">
    ...
    <div style="border:1px solid gray; margin-left:30px; width:400px; height:600px; overflow-y:auto;">
        <div style="display:flex; justify-content:space-between; align-items: baseline; padding:5px">
            <h3>Events log:</h3>
            <MariloButton Icon="@SvgIcon.X" OnClick="@(()=> EventLog = string.Empty)">Clear log</MariloButton>
        </div>
...
* [Live Demo: Sankey Diagram Events](https://demos.marilo.com/blazor-ui/sankey/events)
