...
tags: marilo,blazor,sankey,diagram,chart,data,binding
published: True
position: 3
components: ["general"]
---
...
The Sankey diagram for Blazor requires its `Data` parameter to provide all the data for its nodes, links and labels. The `Data` parameter accepts an object of type [`SankeyData`](slug:Marilo.Blazor.Components.SankeyData) that contains the following properties:
...
| `Highlight` | [`SankeyDataLinkHighlight`](slug:Marilo.Blazor.Components.SankeyDataLinkHighlight) | The opacity of the active and inactive links when the user hovers a link. |
...
| `Label` | [`SankeyDataNodeLabel`](slug:Marilo.Blazor.Components.SankeyDataNodeLabel) | Contains all the information for the node label - text, alignment, color, border and more. |
| `Offset` | [`SankeyDataNodeOffset`](slug:Marilo.Blazor.Components.SankeyDataNodeOffset)| The left and top offset of the node from the `<div class="k-sankey">` container. |
...
| `Align` | [`SankeyNodesAlign?` enum](slug:marilo.blazor.sankeynodesalign) <br/> (`Stretch`) | The alignment of the node.|
...
* [Live Demo: Sankey Diagram](https://demos.marilo.com/blazor-ui/sankey/overview)
