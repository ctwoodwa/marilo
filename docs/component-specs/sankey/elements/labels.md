...
slug: sankey-labels
tags: marilo,blazor,sankey,diagram,chart,labels
published: True
position: 5
components: ["sankey"]
---
...
To customize the labels, declare a `<SankeyLabels>` tag as a direct child of `<MariloSankey>`. The `<SankeyLabels>` tag has the following parameters:

| Parameter | Type and Default&nbsp;Value | Description |
| --------- | ---- | ----------- |
| `Align` | [`SankeyLabelsAlign` enum](slug:marilo.blazor.sankeylabelsalign) <br/> (`Left`) | The alignment of the labels. |
...
| `Position` | [`SankeyLabelsPosition` enum](slug:marilo.blazor.sankeylabelsposition) <br/> (`Inside`) | The position of the labels. |
...
| `DashType` | [`DashType` enum](slug:marilo.blazor.dashtype) <br/> (`Solid`) | The style of the border. |
