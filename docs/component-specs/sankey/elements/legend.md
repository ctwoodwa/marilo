...
slug: sankey-legend
tags: marilo,blazor,sankey,diagram,chart,legend
published: True
position: 11
components: ["sankey"]
---
...
The Marilo Sankey Diagram for Blazor can show a legend, which is a visual guide with details about the nodes. This article explores how to customize the Sankey legend.

## Basic Customization

To customize the legend in the Sankey chart, declare a `<SankeyLegend>` tag as a direct child of `<MariloSankey>`. The `<SankeyLegend>` tag has the following parameters:

| Parameter | Type and Default&nbsp;Value | Description |
| --------- | ---- | ----------- |
| `Align` | [`SankeyLegendAlign` enum](slug:marilo.blazor.sankeylegendalign) <br/> (`Start`) | The alignment of the legend. |
...
| `Orientation` | [`SankeyLegendOrientation` enum](slug:marilo.blazor.sankeylegendorientation) <br/> (`Horizontal`)  | The orientation of the legend. |
| `Position` | [`SankeyLegendPosition` enum](slug:marilo.blazor.sankeylegendposition) <br/> (`Bottom`)| The position of the legend. |
...
* [`Border`](slug:marilo.blazor.components.sankeylegendborder)
* [`Item`](slug:marilo.blazor.components.sankeylegenditem)
* [`Labels`](slug:marilo.blazor.components.sankeylegendlabels) - exposes additional nested options. The structure of the nested tags is `<SankeyLegendLabels*Specifics*>`, where the specifics can be:
    * [`Margin`](slug:marilo.blazor.components.sankeylegendlabelsmargin)
    * [`Padding`](slug:marilo.blazor.components.sankeylegendlabelspadding)
* [`Margin`](slug:marilo.blazor.components.sankeylegendmargin)
* [`Padding`](slug:marilo.blazor.components.sankeylegendpadding)
* [`Title`](slug:marilo.blazor.components.sankeylegendtitle) - exposes additional nested options. The structure of the nested tags is `<SankeyLegendTitle*Specifics*>`, where the specifics can be:
    * [`Border`](slug:marilo.blazor.components.sankeylegendtitleborder)
    * [`Margin`](slug:marilo.blazor.components.sankeylegendtitlemargin)
    * [`Padding`](slug:marilo.blazor.components.sankeylegendtitlepadding)  
...
* [Live Demo: Sankey Diagram Configuration](https://demos.marilo.com/blazor-ui/sankey/configuration)
