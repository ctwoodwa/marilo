...
slug: sankey-title
tags: marilo,blazor,sankey,diagram,chart,title
published: True
position: 7
components: ["sankey"]
---
...
1. Declare a `<SankeyTitle>` tag as a direct child of `<MariloSankey>`.
...
| --------- | ---- | ----------- |
| `Align` | [`SankeyTitleAlign` enum](slug:marilo.blazor.sankeytitlealign) <br/> (`Left`) | The alignment of the title. |
...
| `Position` | [`SankeyTitlePosition` enum](slug:marilo.blazor.sankeytitleposition) <br/> (`Top`)| The position of the title. |
...
* [`Border`](slug:marilo.blazor.components.sankeytitleborder)
* [`Margin`](slug:marilo.blazor.components.sankeytitlemargin)
* [`Padding`](slug:marilo.blazor.components.sankeytitlepadding)
