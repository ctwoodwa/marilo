...
slug: sankey-links
tags: marilo,blazor,sankey,diagram,chart,links
published: True
position: 3
components: ["sankey"]
---
...
To customize the nodes, declare the `<SankeyLinks>` tag as a direct child of `<MariloSankey>`. The `<SankeyLinks>` tag exposes the following parameters:

| Parameter | Type and Default&nbsp;Value | Description |
| --------- | ---- | ----------- |
| `ColorType` | [`SankeyLinksColorType` enum](slug:marilo.blazor.sankeylinkscolortype) <br /> (`Static`) | The origin of the link color: could be based on the `Color` property, on the source node color, or on the target node color. |
