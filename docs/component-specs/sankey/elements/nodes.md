...
slug: sankey-nodes
tags: marilo,blazor,sankey,diagram,chart,nodes
published: True
position: 0
components: ["sankey"]
---
...
To customize the nodes, declare the `<SankeyNodes>` tag as a direct child of `<MariloSankey>`. The `<SankeyNodes>` tag exposes the following parameters:

| Parameter | Type and Default&nbsp;Value | Description |
| --------- | ---- | ----------- |
| `Align` | [`SankeyNodesAlign` enum](slug:marilo.blazor.sankeynodesalign) <br/> (`Stretch`) | The nodes alignment. |
