...
tags: marilo,blazor,sankey,diagram,chart,overview
published: True
position: 0
components: ["general"]
---
...
The Blazor Sankey diagram provides various parameters to configure the component. Also check the [Sankey public API](slug:Marilo.Blazor.Components.MariloSankey).
...
* [Live Demos: Sankey diagram](https://demos.marilo.com/blazor-ui/sankey/overview)
* [Sankey diagram API Reference](slug:Marilo.Blazor.Components.MariloSankey)
