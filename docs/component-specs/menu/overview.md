...
tags: marilo,blazor,menu,overview
published: True
position: 0
components: ["menu"]
---
...
The following table lists Context Menu parameters, which are not related to other features on this page. Check the [Menu API Reference](slug:Marilo.Blazor.Components.MariloMenu-1) for a full list of properties, methods and events.
...
* [Live Demo: Menu](https://demos.marilo.com/blazor-ui/menu/overview)
* [Menu API Reference](slug:Marilo.Blazor.Components.MariloMenu-1)
