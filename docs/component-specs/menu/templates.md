...
<MariloMenu Data="@MenuItems" OnClick="@((MenuItem item) => OnClick(item))">
    <ItemTemplate Context="item">
        @{
            @*
        ...
        MenuItems = new List<MenuItem>()
        {
            ...
            new MenuItem()
            {
                ...
                Items = new List<MenuItem>()
                {
                    ...
                    {
                        Text = "Documentation",
                        Href = "https://docs.marilo.com/blazor-ui/introduction",
                        Icon = SvgIcon.Star
                    },
                    new MenuItem()
                    {
                        Text = "Demos",
                        Href = "https://demos.marilo.com/blazor-ui",
                        Icon = SvgIcon.Star
                    }
                }
            }
...
* [Live Demo: Menu Template](https://demos.marilo.com/blazor-ui/menu/template)
