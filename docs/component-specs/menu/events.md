...
tags: marilo,blazor,menu,events
published: true
position: 20
components: ["menu"]
---
...
This article describes the events available in the Marilo Menu for Blazor:
...
<MariloMenu Data="@MenuItems" OnClick="@((MenuItem item) => OnClickHandler(item))">
</MariloMenu>
