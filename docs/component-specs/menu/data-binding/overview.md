...
tags: marilo,blazor,menu,data,bind,databind,databinding,basics
published: True
position: 0
components: ["menu"]
---
...
* `Icon` - The [Marilo Font or SVG icon](slug:common-features-icons) that will be rendered in the item. Read more in the [Icons article](slug:breadcrumb-icons).
...
The properties of a menu item match directly to a field of the model the menu is bound to. You provide that relationship by providing the name of the field from which the corresponding information is present. To do this, use the properties in the main `MariloMenu` tag:
    ...
    protected override void OnInitialized()
    {
        MenuItems = new List<MenuItem>()
        {
            ...
            new MenuItem()
            {
                ...
                SectionId = 6,
                Section = "What's new",
                Page = "https://www.marilo.com/support/whats-new"
            },
            new MenuItem()
            {
                Id = 9,
                ...
                Page = "https://www.marilo.com/support/whats-new/blazor-ui/release-history"
            },
            new MenuItem()
            {
                Id = 10,
            ...
            new MenuItem()
            {
                ...
                SectionId = 6,
                Section = "Roadmap",
                Page = "https://www.marilo.com/support/whats-new/blazor-ui/roadmap"
...
## See Also
  ...
  * [Live Demo: Menu Flat Data](https://demos.marilo.com/blazor-ui/menu/flat-data)
  * [Live Demo: Menu Hierarchical Data](https://demos.marilo.com/blazor-ui/menu/hierarchical-data)
