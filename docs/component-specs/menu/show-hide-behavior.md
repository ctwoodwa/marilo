...
tags: marilo,blazor,menu,show,hide,events,hover,click,mouseleave,mouseenter
published: true
position: 3
components: ["menu"]
---
...
* The `ShowOn` parameter accepts a value from the `Marilo.Blazor.MenuShowEvent` enum:
...
* The `HideOn` parameter accepts a value from the `Marilo.Blazor.MenuHideEvent` enum:
