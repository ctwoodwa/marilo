...
tags: marilo,blazor,DatePicker,events
published: true
position: 20
...
This article describes the events of the Marilo DatePicker for Blazor.
...
<MariloDatePicker @bind-Value="@DatePickerValue"
...
As an argument, the event handler receives a [`DatePickerCalendarCellRenderEventArgs` object](slug:marilo.blazor.components.datepickercalendarcellrendereventargs), which contains the following properties:
...
The event handler receives as an argument an [`DatePickerCloseEventArgs` object](slug:marilo.blazor.components.datepickercloseeventargs) that contains:
...
As an argument, the event handler receives a [`DatePickerOpenEventArgs` object](slug:Marilo.Blazor.Components.DatePickerOpenEventArgs), which contains the following properties:
...
<MariloDatePicker Value="@DatePickerValue" 
