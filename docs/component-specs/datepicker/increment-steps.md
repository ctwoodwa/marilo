...
tags: marilo,blazor,Datepicker,step
published: true
position: 10
...
<MariloDatePicker Format="yyyy MMM dd" @bind-Value="@selectedDate" Width="250px">
...
* [Live Demo: Date Picker Incremental Steps](https://demos.marilo.com/blazor-ui/datepicker/incremental-steps)
