...
slug: dialog-events
tags: marilo,blazor,dialog,events
published: True
position: 10
components: ["dialog"]
---
...
This article explains the events available in the Marilo Dialog for Blazor:
...
<MariloButton OnClick="@ToggleDialog">Toggle the Dialog</MariloButton>

<MariloDialog Visible="@Visible" VisibleChanged="@VisibleChangedHandler"
               Title="@Title">
    <DialogContent>
        A new version of <strong>Marilo UI for Blazor</strong> is available. Would you like to download and install it now?
    </DialogContent>
    <DialogButtons>
        <MariloButton OnClick="@ToggleDialog">Skip this version</MariloButton>
        <MariloButton OnClick="@ToggleDialog">Remind me later</MariloButton>
        <MariloButton OnClick="@ToggleDialog" ThemeColor="primary">Install update</MariloButton>
    </DialogButtons>
</MariloDialog>
...
<MariloButton OnClick="@(() => { Visible = true; })">Toggle the Dialog</MariloButton>
...
<MariloDialog Visible="@Visible" VisibleChanged="@VisibleChangedHandler"
    ...
    <DialogContent>
        ...
        <label>
            ...
            <MariloCheckBox @bind-Value="@isClosable" />
        </label>
    </DialogContent>
</MariloDialog>
