...
tags: marilo,blazor,dialog,integration
published: True
position: 9
components: ["dialog"]
---
...
1. Include the [Marilo CheckBox](slug:checkbox-overview) as `DialogContent`.
...
<MariloDialog @ref="DialogRef" Visible="true">
    <DialogContent>
        <MariloCheckBox Id="MyCheckBox" @bind-Value="@IsSelected" OnChange="@OnCheckBoxValueChanged" />
...
@code {
    ...
    private MariloDialog DialogRef { get; set; }
...
1. Include the [Marilo Filter](slug:filter-overview) inside `<DialogContent>`.
...
<MariloDialog @ref="DialogRef" Visible="true" Width="66vw" Height="66vh">
    <DialogContent>
