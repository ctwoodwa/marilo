...
tags: marilo,blazor,filter,filterfields,templates
published: True
position: 10
components: ["filter"]
---
...
The `context` of the`ValueTemplate` is of type [`FilterFieldValueTemplateContext`](slug:marilo.blazor.components.filterfieldvaluetemplatecontext). You can get and set its `FilterDescriptor` property, which is of type [`FilterDescriptor`](slug:marilo.datasource.filterdescriptor).
...
<MariloFilter Value="@FilterValue" OnUpdate="@OnUpdate">
    <FilterFields>
        ...
        <FilterField Name="@(nameof(Food.Price))" Type="@(typeof(decimal))" Label="Price">
            <ValueTemplate>
                <MariloNumericTextBox Value="@((decimal?)context.FilterDescriptor.Value)"
                                       Format="C"
                                       Step="0.01m"
...
## See Also
  ...
  * [Live Demo: Filter](https://demos.marilo.com/blazor-ui/filter/templates)
