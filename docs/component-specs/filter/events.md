...
slug: filter-events
tags: marilo,blazor,filter,events,event
published: true
position: 11
components: ["filter"]
---
...
This article explains the available events for the Marilo Filter for Blazor:
...
<MariloFilter Value="@Value" OnUpdate="@OnFilterUpdate">
    <FilterFields>
