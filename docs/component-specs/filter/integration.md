...
tags: marilo,blazor,filter,integration
published: True
position: 3
components: ["filter"]
---
...
To integrate the Filter with the Marilo Chart:
...
<MariloFilter Value="@FilterValue" OnUpdate="@OnUpdate">
    <FilterFields>
...
To integrate the Filter with the Marilo Grid:
...
<MariloFilter Value="FilterValue" OnUpdate="@OnFilterUpdate">
    <FilterFields>
...
<p>
    <MariloButton ThemeColor="@ThemeConstants.Button.ThemeColor.Primary"
                   OnClick="@ApplyFilters">Apply Filters</MariloButton>
</p>
...
To integrate the Filter with the Marilo ListView:
...
To integrate the Filter with the Marilo TreeList:
...
To integrate the Filter with the Marilo TreeView:
...
<MariloTreeView Data="@FlatData" @bind-ExpandedItems="@ExpandedItems">
    <TreeViewBindings>
...
* [Online Demo: Filter](https://demos.marilo.com/blazor-ui/filter/overview)
