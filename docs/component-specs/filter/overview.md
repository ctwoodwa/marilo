...
tags: marilo,blazor,filter,overview
published: True
position: 0
components: ["filter"]
---
...
The <a href="https://www.marilo.com/blazor-ui/filter" target="_blank">Blazor Filter component</a> serves as a complementary addition to data-bound components that do not have built-in filtering.
...
1. Use the `MariloFilter` tag to add the component to your razor page.
...
>caption A basic configuration of the Marilo Filter.
...
<MariloFilter @ref="FilterRef" Value="@FilterValue" OnUpdate="@OnUpdate">
    <FilterFields>
...
@code {
    private MariloFilter? FilterRef { get; set; }
...
* [Live Demo: Filter](https://demos.marilo.com/blazor-ui/filter/overview)
