...
tags: marilo,blazor,barcode,qrcode,overview
published: True
position: 0
components: ["qrcode"]
---
...
The <a href="https://www.marilo.com/blazor-ui/qr-code" target="_blank">Blazor QRCode component</a> generates **Canvas** and **SVG** images that represent Quick Response (QR) codes.
...
1. Use the `MariloQRCode` tag to add the component to your razor page.
...
>caption Basic Marilo QRCode

````RAZOR
<MariloQRCode Value="https://www.marilo.com/blazor-ui"
               Size="200px">
</MariloQRCode>
````
...
* [Live Demo: QRCode](https://demos.marilo.com/blazor-ui/qrcode/overview)
