...
tags: marilo,blazor,combobox,combo,events
published: true
position: 40
components: ["combobox"]
---
...
@selectedValue
<br /><br />
<MariloComboBox Data="@myComboData" TextField="MyTextField" ValueField="MyValueField"
...
<MariloComboBox TItem="@String" TValue="@String"
                     OnRead="@ReadItems"
...
<MariloComboBox TItem="@Car" TValue="@(int?)"
                 OnRead="@ReadItems"
...
<MariloComboBox @bind-Value="@TheValue" Data="@Suggestions"
