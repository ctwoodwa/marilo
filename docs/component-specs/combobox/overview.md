...
tags: marilo,blazor,combobox,combo,overview
published: True
position: 0
components: ["combobox"]
---
...
<MariloComboBox Data="@myComboData" TextField="MyTextField" ValueField="MyValueField" @bind-Value="selectedValue"
...
````RAZOR
<MariloComboBox Data="@ComboBoxData"
...
@code {
    private MariloComboBox<string, string> ComboBoxRef { get; set; }
...
* [Live Demo: ComboBox](https://demos.marilo.com/blazor-ui/combobox/overview)
* [Live Demo: ComboBox Validation](https://demos.marilo.com/blazor-ui/combobox/validation)
* [ComboBox API Reference](slug:Marilo.Blazor.Components.MariloComboBox-2)
