...
tags: marilo,blazor,dropdownbutton,appearance,styling
published: True
position: 10
...
````RAZOR
<MariloDropDownButton FillMode="@ThemeConstants.DropDownButton.FillMode.Solid"
...
<MariloDropDownButton FillMode="solid"
                       Rounded="lg"
                       Size="lg"
                       ThemeColor="primary">
    <DropDownButtonContent> Foo </DropDownButtonContent>
...
@foreach (var item in FillModes)
{
    ...
    <MariloDropDownButton FillMode="@fillMode">
...
@foreach (var item in RoundedOptions)
{
    ...
    <MariloDropDownButton Rounded="@rounded">
...
@foreach (var item in Sizes)
{
    ...
    <MariloDropDownButton Size="@size">
...
@foreach (var item in ThemeColors)
{
    ...
    <MariloDropDownButton ThemeColor="@themeColor">
...
* [Live Demo: DropDownButton Appearance](https://demos.marilo.com/blazor-ui/dropdownbutton/appearance)
