...
tags: marilo,blazor,dropdownbutton,icons
published: True
position: 5
...
The `<MariloDropDownButton>` and `<DropDownButtonItem>` provide an `Icon` parameter that allows you to add an icon to the main button and all secondary action items.
...
````RAZOR
<MariloDropDownButton Icon="@SvgIcon.User">
    ...
    <DropDownButtonItems>
        ...
        <DropDownButtonItem> <MariloLoader /> Custom Markup </DropDownButtonItem>
    </DropDownButtonItems>
...
* [Live Demo: DropDownButton Overview](https://demos.marilo.com/blazor-ui/dropdownbutton/overview)
