...
tags: marilo,blazor,filemanager,contextmenu, menu, context
published: True
position: 3
...
The component uses the Marilo UI for [Blazor ContextMenu](slug:contextmenu-overview) and provides the following commands:
