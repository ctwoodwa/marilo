...
tags: marilo,blazor,filemanager,toolbar, commands
published: True
position: 15
...
Add a `<FileManagerToolBar>` tag inside `<MariloFileManager>` to configure a custom toolbar, for example:
...
<MariloFileManager @ref="@FileManagerRef"
    ...
    <FileManagerToolBar>
        ...
        <FileManagerToolBarCustomTool>
            <MariloButton Icon="@SvgIcon.Trash"
                           ...
                           Enabled="@SelectedItems.Any()">Delete</MariloButton>
        </FileManagerToolBarCustomTool>
    </FileManagerToolBar>
</MariloFileManager>

@code {
    private MariloFileManager<FlatFileEntry> FileManagerRef;
...
* [Live Demo: FileManager Toolbar](https://demos.marilo.com/blazor-ui/filemanager/toolbar)
