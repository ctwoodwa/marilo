...
tags: marilo,blazor,upload,files
published: True
position: 17
...
>tip Before you continue, make sure you are familiar with the features and API of the [Marilo Upload component](slug:upload-overview).
...
The `FileManagerController` class below assumes that the project name and namespace is `MariloBlazorApp`. The FileManager `Data` is the contents of the application's `wwwroot` folder.
...
* [FileManager Upload Demo](https://demos.marilo.com/blazor-ui/upload/overview)
