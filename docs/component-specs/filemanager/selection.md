...
tags: marilo,blazor,filemanager,selection,item,file,folder,selected,items
published: True
position: 10
...
* [Live Demo: FileManager Selection](https://demos.marilo.com/blazor-ui/filemanager/selection)
