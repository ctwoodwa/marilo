...
description: Events available in the Marilo Blazor Data Pager component.
slug: pager-events
tags: marilo,blazor,pager,paging,events
published: True
position: 20
components: ["pager"]
---
...
This article explains the events available in the Marilo Pager for Blazor:
