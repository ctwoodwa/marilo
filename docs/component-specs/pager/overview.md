...
slug: pager-overview
tags: marilo,blazor,pager,paging
published: True
position: 1
components: ["pager"]
---
...
The <a href="https://www.marilo.com/blazor-ui/pager" target="_blank">Blazor Pager component</a> will enable you to add paging for your data in a Blazor application. We use it in components like the Grid and ListView, and you can also use it for your own templates and data as a standalone component.
...
1. Add the `MariloPager` tag to a Razor file.
...
>caption Use the MariloPager to paginate your own data and content.

````RAZOR
<MariloPager Total="@Games.Count" PageSize="@PageSize" @bind-Page="@Page"></MariloPager>
...
| --- | --- | --- |
| `Size` | `Marilo.Blazor.ThemeConstants.Pager.Size` | Adjust the size of the Pager |
...
<div class="mb-3">
    <label class="text-info">
        Select a page:
        <MariloNumericTextBox @bind-Value="@Page" />
    </label>
</div>

<MariloPager Total="30" PageSize="@PageSize" @bind-Page="@Page" />
...
* [Live Pager Demos](https://demos.marilo.com/blazor-ui/pager/overview)
* [Pager API Reference](slug:Marilo.Blazor.Components.MariloPager)
