...
tags: marilo,blazor,textbox,events
published: true
position: 20
components: ["textbox"]
---
...
This article explains the events available in the <a href = "https://www.marilo.com/blazor-ui/textbox" target="_blank">Marilo Textbox for Blazor</a>:
...
````RAZOR
<MariloTextBox Value="@TextBoxValue"
