...
tags: marilo,blazor,fileselect,async,overview
published: True
position: 0
...
The <a href = "https://www.marilo.com/blazor-ui/fileselect" target="_blank">Marilo UI for Blazor FileSelect component</a> helps users select one or more files from their local file system.
...
1. Add the `MariloFileSelect` tag.
...
Additionally, you may define an external drop zone by using the [Marilo UI for Blazor DropZone component](slug:dropzone-overview).
...
You can use the functionality of the built-in template and modify the appearance of the **Select files...** button. [Read more about the Marilo FileSelect templates...](slug:fileselect-templates)
...
For a complete list of all FileSelect methods, see the [FileSelect API reference](slug:Marilo.Blazor.Components.MariloFileSelect#methods).
...
<MariloFileSelect @ref="@FileSelectRef" />

@code {
    private MariloFileSelect FileSelectRef { get; set; }
...
* [FileSelect API](slug:Marilo.Blazor.Components.MariloFileSelect)
* [Live Demo: FileSelect](https://demos.marilo.com/blazor-ui/fileselect/overview)
