...
tags: marilo,blazor,fileselect,templates
published: True
position: 30
...
<MariloFileSelect>
    <SelectFilesButtonTemplate>
        <MariloSvgIcon Icon="@SvgIcon.Upload" />
...
```CSHTML
<MariloFileSelect @ref="@FileSelectRef" Files="@InitialFiles">
...
```CSHTML
<MariloFileSelect Files="@InitialFiles">
