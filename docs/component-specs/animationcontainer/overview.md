...
tags: marilo,blazor,animation,container
published: True
position: 0
...
````RAZOR
<MariloButton OnClick="@ToggleAnimationContainer">Toggle Animation Container</MariloButton>

<MariloAnimationContainer @ref="@TAC"
...
</MariloAnimationContainer>

@code {
    private MariloAnimationContainer TAC { get; set; }
...
* [Live Demos: Animation Container](https://demos.marilo.com/blazor-ui/animationcontainer/overview)
* [AnimationContainer API Reference](slug:Marilo.Blazor.Components.MariloAnimationContainer)
