...
tags: marilo,blazor,map,layers,shape
published: True
position: 7
components: ["map"]
---
...
Marilo Map supports all **Geometry** and **Feature Objects**, as well as the **Geometry** and **Feature Collections** from the GeoJSON Specification (which could be found at https://geojson.org).
...
@code {
    ...
    {
        WorldData = await new HttpClient().GetStringAsync("https://raw.githubusercontent.com/marilo/blazor-ui/master/map/world-data.json");
