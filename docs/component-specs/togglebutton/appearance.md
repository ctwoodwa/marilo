...
tags: marilo,blazor,button,toggle,togglebutton,appearance
published: True
position: 35
...
The `FillMode` toggles the background and border of the MariloToggleButton. You can set the parameter to a member of the `Marilo.Blazor.ThemeConstants.Button.FillMode` class:
...
@{ 
    ...
    foreach (var field in fields)
    {
        ...
        <div style="float:left; margin: 20px;">
            <MariloToggleButton FillMode="@fillmode">@fillmode</MariloToggleButton>
        </div>
    }
}
````
...
@{
    ...
    foreach (var field in fields)
    {
        ...
        <div style="float:left; margin: 20px;">
            <MariloToggleButton Rounded="@rounded">@rounded</MariloToggleButton>
        </div>
    }
}
````
...
@{
    ...
    foreach (var field in fields)
    {
        ...
        <div style="float:left; margin: 20px;">
            <MariloToggleButton Size="@size">@size</MariloToggleButton>
        </div>
    }
}
````
...
@{
    ...
    foreach (var field in fields)
    {
        ...
        <div style="float:left; margin: 20px;">
            <MariloToggleButton ThemeColor="@themeColor">@themeColor</MariloToggleButton>
        </div>
    }
}
````
