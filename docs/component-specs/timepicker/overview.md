...
tags: marilo,blazor,time,picker,timepicker,overview
published: True
position: 0
...
<MariloTimePicker Min="@Min" Max="@Max" Format="hh:mm:ss tt" @bind-Value="@selectedTime"></MariloTimePicker>
...
Add a reference to the component instance to use the [Time Picker's methods](slug:Marilo.Blazor.Components.MariloTimePicker-1).
...
````RAZOR
<MariloTimePicker @ref="@TimePickerRef"
...
@code {    
    ...
    private MariloTimePicker<DateTime> TimePickerRef { get; set; }
...
* [Live Demo: Time Picker](https://demos.marilo.com/blazor-ui/timepicker/overview)
* [Input Validation](slug:common-features/input-validation)
* [Supported Input Date Formats](slug:components/dateinput/supported-formats)
* [TimePicker API Reference](slug:Marilo.Blazor.Components.MariloTimePicker-1)
