...
tags: marilo,blazor,TimePicker,step
published: true
position: 5
...
<MariloTimePicker Format="hh:mm:ss tt" @bind-Value="@selectedTime">
...
* [Live Demo: Time Picker Incremental Steps](https://demos.marilo.com/blazor-ui/timepicker/incremental-steps)
