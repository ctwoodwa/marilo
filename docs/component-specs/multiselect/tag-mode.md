...
tags: marilo,blazor,multiselect,tag,mode,single,multiple,summary
published: True
position: 17
...
To configure the tag mode, use the `TagMode` parameter. It accepts a member of the `Marilo.Blazor.MultiSelectTagMode` enum.
...
## See Also
  ...
  * [Live Demo: MultiSelect Tag Mode](https://demos.marilo.com/blazor-ui/multiselect/tag-mode)
