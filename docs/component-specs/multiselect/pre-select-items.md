...
tags: marilo,blazor,multiselect,pre-select
published: True
position: 8
...
````RAZOR
Select IDs
<MariloNumericTextBox @bind-Value="@Id1" Min="1" Max="10" Width="70px" />
and
<MariloNumericTextBox @bind-Value="@Id2" Min="1" Max="10" Width="70px" />

<MariloButton OnClick="@SelectItems">Apply</MariloButton>
<MariloButton OnClick="@ClearSelection">Clear Selection</MariloButton>

<br />

<MariloMultiSelect Data="@Products"
