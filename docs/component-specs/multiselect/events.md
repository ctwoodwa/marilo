...
tags: marilo,blazor,multiselect,events
published: true
position: 35
...
This article explains the events available in the Marilo MultiSelect for Blazor:
...
<MariloMultiSelect Data="@MultiData"
                    Value="@MultiValues"
...
@result
<br />
<MariloMultiSelect Data="@Roles" @bind-Value="@TheValues" OnChange="@MyOnChangeHandler" />
<br />
from the model:
<ul>
...
<MariloMultiSelect TItem="@String" TValue="@String"
                    OnRead="@ReadItems"
...
<MariloMultiSelect TItem="@Car" TValue="@int"
                    OnRead="@ReadItems"
                    @bind-Value="@TheValues"
...
<MariloMultiSelect Data="@Options"
...
<MariloMultiSelect @bind-Value="@TheValues" Data="@Options"
