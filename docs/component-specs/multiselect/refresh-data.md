...
tags: marilo,blazor,multiselect,observable,data,new,collection
published: True
position: 30
...
You can refresh the data of the MultiSelect by using the `Rebind` method exposed to the reference of the MariloMultiSelect. If you have manually defined the [OnRead event](slug:multiselect-events#onread) the business logic defined in its event handler will be executed. 
...
<MariloButton OnClick="@RebindMultiSelect">Rebind the Multiselect</MariloButton>

<MariloMultiSelect TItem="@String"
                    TValue="@String"
                    @ref="@MultiSelectRef"
                    OnRead="@ReadItems"
...
@code{
    private MariloMultiSelect<string, string> MultiSelectRef { get; set; }
...
<MariloMultiSelect Data="@Options" @bind-Value="@TheValues"
...
<MariloTextBox @bind-Value="@ValuetoAdd"></MariloTextBox>
<MariloButton OnClick="@AddItem">Add new option</MariloButton>
<br />

<h4>Remove the last option</h4>
<MariloButton OnClick="@RemoveItem">Remove last item</MariloButton>
<br />

<h4>Load a collection of new options</h4>
<MariloButton OnClick="@LoadNewData">Load new options</MariloButton>
<br />
...
<MariloButton OnClick="@SetSelected">Set selected</MariloButton>
<br />

<h4>Clear selected values</h4>
<MariloButton OnClick="@ClearSelected">Clear selected</MariloButton>
<br />
