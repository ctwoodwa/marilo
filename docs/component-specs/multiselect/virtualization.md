...
tags: marilo,blazor,MultiSelect,virtualization
published: True
position: 25
...
Number of selected items: @SelectedValues?.Count
<br />
<MariloMultiSelect TItem="@Person" TValue="@int"
                    ScrollMode="@DropDownScrollMode.Virtual"
...
## See Also
  ...
  * [Live Demo: MultiSelect Virtualization](https://demos.marilo.com/blazor-ui/multiselect/virtualization)
