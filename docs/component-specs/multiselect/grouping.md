...
tags: marilo,blazor,multiselect,group,grouping
published: True
position: 15
...
* A grouped MultiSelect will provide a `Groups` property with a single [`GroupDescriptor`](slug:Marilo.DataSource.GroupDescriptor) in the [`DataSourceRequest`](slug:Marilo.DataSource.DataSourceRequest) argument of its [OnRead event](slug:multiselect-events#onread). This will allow the developer to apply grouping with [manual data operations](slug:components/grid/manual-operations).

## See Also

  * [Live Demo: MultiSelect Grouping](https://demos.marilo.com/blazor-ui/multiselect/grouping)
