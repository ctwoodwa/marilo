...
tags: marilo,blazor,multiselect,overview
published: True
position: 0
...
````RAZOR.skip-repl
<MariloMultiSelect Data="@MultiSelectData"
...
* [Live Demo: MultiSelect](https://demos.marilo.com/blazor-ui/multiselect/overview)
* [Live Demo: MultiSelect Validation](https://demos.marilo.com/blazor-ui/multiselect/validation)
* [MultiSelect API Reference](slug:Marilo.Blazor.Components.MariloMultiSelect-2)
