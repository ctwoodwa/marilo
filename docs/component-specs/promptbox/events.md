...
tags: marilo,blazor,promptbox,events,action,speech,files
published: true
position: 20
...
The event provides [`PromptBoxActionButtonEventArgs`](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.PromptBoxActionButtonEventArgs) containing the current text and action type.

>caption Handle action button interactions

````RAZOR
<MariloPromptBox @bind-Value="@Prompt"
...
When speech-to-text functionality is enabled, the PromptBox provides events through the [`PromptBoxSpeechToTextButtonSettings`](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.PromptBoxSpeechToTextButtonSettings):
...
File selection events are handled through the [`PromptBoxFileSelectButtonSettings`](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.PromptBoxFileSelectButtonSettings).
