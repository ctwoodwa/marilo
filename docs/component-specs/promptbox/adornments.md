...
tags: marilo,blazor,promptbox,adornments,templates,prefixes,suffixes
published: True
position: 10
...
<MariloPromptBox @bind-Value="@Prompt"
    ...
    <PromptBoxStartAffixTemplate>
        <MariloButton Icon="SvgIcon.User" 
...
<MariloPromptBox @bind-Value="@Prompt"
    ...
    <PromptBoxEndAffixTemplate>
        <div class="d-flex gap-1">
            <MariloButton Icon="SvgIcon.Image" 
                           FillMode="@ThemeConstants.Button.FillMode.Clear"
                           Size="@ThemeConstants.Button.Size.Small"
                           OnClick="OnImageClick"
                           Title="Add Image" />
            <MariloButton Icon="SvgIcon.Link" 
                           FillMode="@ThemeConstants.Button.FillMode.Clear"
                           Size="@ThemeConstants.Button.Size.Small"
                           OnClick="OnLinkClick"
                           Title="Add Link" />
            <MariloButton Icon="SvgIcon.Gear" 
                           FillMode="@ThemeConstants.Button.FillMode.Clear"
                           Size="@ThemeConstants.Button.Size.Small"
...
<MariloPromptBox @bind-Value="@Prompt"
    ...
    <PromptBoxTopAffixTemplate>
        <div class="p-2 border-bottom d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-1">
                <MariloButton OnClick="OnBoldClick"
                               FillMode="@ThemeConstants.Button.FillMode.Clear"
                               Size="@ThemeConstants.Button.Size.Small"
                               Icon="SvgIcon.Bold" />
                <MariloButton OnClick="OnItalicClick"
                               FillMode="@ThemeConstants.Button.FillMode.Clear"
                               Size="@ThemeConstants.Button.Size.Small"
                               Icon="SvgIcon.Italic" />
            </div>
...
<div class="prompt-container">
    <MariloPromptBox OnBlur="@(() => Logs.Add("PromptBox blurred"))"
                      DebounceDelay="0"
