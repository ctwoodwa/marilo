...
tags: marilo,blazor,promptbox,modes,singleline,multiline,auto
published: True
position: 15
...
<div class="d-flex flex-column gap-4">
    <div>
        ...
        <MariloPromptBox @bind-Value="@SingleLinePrompt"
    ...
    <div>
        ...
        <MariloPromptBox @bind-Value="@MultiLinePrompt"
    ...
    <div>
        <h4>Auto Mode</h4>
        <MariloPromptBox @bind-Value="@AutoPrompt"
