...
tags: marilo,blazor,promptbox,ai,communication,speech,files,input
published: True
position: 0
...
The <a href="https://www.marilo.com/blazor-ui/promptbox" target="_blank">Blazor PromptBox component</a> facilitates human-AI communication with a feature-rich input interface. It combines text input, speech-to-text functionality, file attachments, and intelligent layout adaptation to provide a comprehensive user experience for AI workflows.
...
1. Add the `<MariloPromptBox>` tag to a Razor file.
...
To review all available parameters for the PromptBox component, see the [PromptBox API Reference](https://docs.marilo.com/blazor-ui/api/Marilo.Blazor.Components.MariloPromptBox#parameters).
