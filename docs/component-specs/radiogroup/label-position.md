...
tags: marilo,blazor,radiobuttongroup,radio,list,label,position
published: True
position: 15
...
By default, the labels are after the buttons, and you can change that through the `LabelPosition` parameter that takes a member of the `Marilo.Blazor.RadioGroupLabelPosition` enum.
...
<br />
<MariloRadioGroup Data="@Data" @bind-Value="@SelectedValue" LabelPosition="@thePosition"></MariloRadioGroup>
@code{
