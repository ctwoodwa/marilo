...
tags: marilo,blazor,radio button,list,data,bind,binding,databind
published: True
position: 5
...
<br />
<MariloRadioGroup Data="@RadioGroupData" @bind-Value="@RadioGroupValue" />
...
<MariloRadioGroup @ref="@RadioGroupRef"
                   ...
                   @bind-Value="@RadioGroupValue" />
@code {
    private MariloRadioGroup<string, string>? RadioGroupRef { get; set; }
...
@code {
    private MariloRadioGroup<Gender, int>? RadioGroupRef { get; set; }
...
* [Live Demo: RadioGroup](https://demos.marilo.com/blazor-ui/radiogroup/overview)
