...
tags: marilo,blazor,radiobuttongroup,radio,list,layout
published: True
position: 10
...
By default, the list is vertical, and you can change that through the `Layout` parameter that takes a member of the `Marilo.Blazor.RadioGroupLayout` enum.

>caption Horizontal and Vertical layouts in the Marilo Blazor Button Group Component
...
<br />
<MariloRadioGroup Data="@Data" @bind-Value="@SelectedValue" Layout="@theLayout"></MariloRadioGroup>
@code{
...
<div style="width: 500px; border: 1px solid red;">
    <MariloRadioGroup Data="@RadioButtonsList"
...
* [Live Demo: RadioGroup Customization](https://demos.marilo.com/blazor-ui/radiogroup/customization)
