...
description: Learn how to apply styles to the Blazor Button component by Marilo UI.
slug: button-styling
tags: marilo,blazor,button,styling,
published: True
position: 10
components: ["button"]
---
...
````RAZOR
<MariloButton Class="my-button">Large button with red text</MariloButton>
