...
slug: button-type
tags: marilo,blazor,button,type
published: True
position: 3
components: ["button"]
---
...
````RAZOR
<MariloButton>Implicit SUBMIT</MariloButton>
<MariloButton ButtonType="@ButtonType.Submit">Explicit SUBMIT</MariloButton>
<MariloButton ButtonType="@ButtonType.Button">BUTTON</MariloButton>
<MariloButton ButtonType="@ButtonType.Reset">RESET</MariloButton>
````
