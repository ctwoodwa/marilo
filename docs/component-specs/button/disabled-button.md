...
description: Learn how to configure a disabled Blazor Button component by Marilo UI.
slug: button-disabled
tags: marilo,blazor,disabled,button,
published: True
position: 5
components: ["button"]
---
...
>caption Toggle Marilo Button Enabled State

````RAZOR
<p>
    <label>
        <MariloCheckBox @bind-Value="@ButtonIsEnabled" /> Toggle Button State
    </label>
</p>

<MariloButton Enabled="@ButtonIsEnabled">@ButtonText</MariloButton>
