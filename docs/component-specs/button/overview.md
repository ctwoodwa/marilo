...
tags: marilo,blazor,button,overview
published: True
position: 0
components: ["button"]
---
...
This article introduces the <a href="https://www.marilo.com/blazor-ui/buttons" target="_blank">Blazor Button component</a>, shows how to start using it, and lists its core features.
...
1. Use the `<MariloButton>` tag to add the component to your razor page.
...
>tip To learn more about the appearance, anatomy, and accessibility of the Button, visit the [Progress Design System Kit documentation](https://www.marilo.com/design-system/docs/components/button/)—an information portal offering rich component usage guidelines, descriptions of the available style variables, and globalization support details.
...
| `Icon` | `object` | The [icon rendered in the Button](slug:button-icons). Can be set to a predefined Marilo icon or a custom one. | 
...
Add a reference to the component instance to use the [Button methods](slug:Marilo.Blazor.Components.MariloButton). Be aware of the Blazor life cycle if you want to [focus the component on page load](slug:inputs-kb-focus#focus-on-page-load).

| Method | Description |
| --- | --- |

````RAZOR.skip-repl
<MariloButton @ref="ButtonRef">Hello!</MariloButton>
...
* [Live Demo: Button](https://demos.marilo.com/blazor-ui/button/overview)
* [Events](slug:button-events)
* [Type](slug:button-type)
* [Button API Reference](slug:Marilo.Blazor.Components.MariloButton)
