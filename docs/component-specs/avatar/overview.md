...
tags: marilo,blazor,avatar,overview
published: True
position: 0
components: ["avatar"]
---
...
The <a href="https://www.marilo.com/blazor-ui/avatar" target="_blank">Blazor Avatar component</a> is typically used to display images, icons or initials representing people or other entities.
...
1. Use the `MariloAvatar` tag to add the component to your razor page.

1. Declare your desired content (as `ChildContent`) inside the `MariloAvatar` tag - text, icon or image. This example demonstrates Avatar with initials (text).
...
<MariloAvatar Type="AvatarType.Text"
               ThemeColor="@Marilo.Blazor.ThemeConstants.Avatar.ThemeColor.Info">
    JD
</MariloAvatar>
````
...
## See Also
  ...
  * [Live Demo: Avatar](https://demos.marilo.com/blazor-ui/avatar/overview)