...
slug: avatar-types
tags: marilo,blazor,avatar,type,image,icon,text
published: True
position: 5
components: ["avatar"]
---
...
The Avatar serves as a wrapper - you should declare the desired content as `ChildContent` inside the `<MariloAvatar>` tag and specify the `Type` based on the content type.
...
<MariloAvatar Type="AvatarType.Image">

    <img src="https://demos.marilo.com/blazor-ui/images/panelbar/robert.jpg" />
...
<MariloAvatar Type="AvatarType.Icon">
