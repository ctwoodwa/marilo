...
tags: marilo,blazor,stacklayout,overview
published: True
position: 0
...
The <a href="https://www.marilo.com/blazor-ui/stacklayout" target="_blank">StackLayout for Blazor</a> is a component that easily aligns multiple elements in a vertical or horizontal order.

## Creating Blazor StackLayout

1. Use the `<MariloStackLayout>` tag to add the component to your razor page.

2. Inside the `<MariloStackLayout>` tag, add the desired HTML containers (e.g. `<div>`) or components. Each immediate child element will represent one stack layout item.
...
<div class="parent-container">
    <MariloStackLayout Orientation="@StackLayoutOrientation.Horizontal" 
                        Width="100%" 
                        Height="100%">
...
Sometimes you may need to create a more complex layout that includes both horizontal and vertical items. To do that, nest `MariloStackLayout` components inside one another.

>caption Use nested StackLayout to create a page layout.

````RAZOR
<MariloStackLayout Orientation="StackLayoutOrientation.Vertical" Height="100%">
    <div class="red">
        Header
    </div>
    <MariloStackLayout Orientation="StackLayoutOrientation.Horizontal">
...
## See Also
  ...
  * [Live StackLayout Demos](https://demos.marilo.com/blazor-ui/stacklayout/overview)
  * [StackLayout API Reference](slug:Marilo.Blazor.Components.MariloStackLayout)