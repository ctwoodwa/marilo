...
tags: marilo,blazor,grid,filtering,filter,row
published: True
position: 5
components: ["grid"]
---
...
Set the `FilterMode` parameter of the Marilo Grid to `GridFilterMode.FilterRow`.
...
>caption Filter Row in Marilo Grid
