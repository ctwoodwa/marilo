...
tags: marilo,blazor,grid,filtering,filter
published: True
...
This article explains the available filtering modes in the Marilo Grid for Blazor.
...
The ToolBar of the Marilo Grid for Blazor includes a [SearchBox](slug:grid-searchbox) that lets users amend filters and search across multiple fields simultaneously.
...
* [Live Demo: Grid Filter Row](https://demos.marilo.com/blazor-ui/grid/filter-row)
* [Live Demo: Grid Filter Menu](https://demos.marilo.com/blazor-ui/grid/filter-menu)
