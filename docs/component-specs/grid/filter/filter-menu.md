...
tags: marilo,blazor,grid,filtering,filter,menu
published: True
position: 10
components: ["grid"]
---
...
Set the `FilterMode` parameter of the Marilo Grid to `GridFilterMode.FilterMenu`.

>caption Filter Menu in Marilo Grid
