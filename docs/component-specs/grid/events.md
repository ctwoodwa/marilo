...
slug: grid-events
tags: marilo,blazor,grid,events
published: True
position: 100
components: ["grid"]
---
...
This article explains the events available in the Marilo Grid for Blazor. They are grouped logically.
...
<MariloDataGrid Data="@SampleGridData"
...
<MariloDataGrid Data="@GridData"
             ...
             Navigable="true">
        <MariloGridColumn Field="@nameof(Product.Id)" />
...
<MariloDataGrid Data="@GridData"
             ...
             Width="450px">
        <MariloGridColumn Field="@(nameof(SampleData.Id))" Width="120px" Locked="true" />
        <MariloGridColumn Field="@(nameof(SampleData.Name))" Width="200px" Title="Employee Name" />
        <MariloGridColumn Field="@(nameof(SampleData.Team))" Width="200px" Title="Team" />
</MariloDataGrid>
...
<MariloDataGrid Data="@MyData" Pageable="true" PageSize="30"
...
<MariloDataGrid Data="@MyData" Pageable="true" PageSize="30" Height="300px"
