...
tags: marilo,blazor,grid,templates,column,cell
published: True
position: 5
components: ["grid"]
---
...
<MariloDataGrid Data="@GridData" Height="400px">
        <MariloGridColumn Field="@(nameof(FoodItem.Id))" Title="Image">
            <Template>
                @{
                    ...
                    <img src="@($"https://demos.marilo.com/blazor-ui/images/{item.Id}.jpg")"
        ...
        <MariloGridColumn Field="@nameof(FoodItem.Organic)">
            <Template>
                ...
                Read-only Checkbox:
                <MariloCheckBox @bind-Value="@item.Organic" Enabled="false" />
                <br />
                or Icon:
