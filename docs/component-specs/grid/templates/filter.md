...
tags: marilo,blazor,grid,templates,filter
published: True
position: 35
components: ["grid"]
---
...
You can find more examples in the [Live Demo: Custom Filter Row](https://demos.marilo.com/blazor-ui/grid/custom-filter-row) that is available in your local installation under the `demos` folder. Also check [How to implement a filter operator dropdown list in a Filter Row Template](slug:grid-kb-filter-operator-dropdown) in order to mimic the default filter row UI.
...
<MariloDataGrid Data=@GridData FilterMode="@GridFilterMode.FilterRow"
        ...
        <MariloGridColumn Field="Price" Width="400px">
            <FilterCellTemplate>
                ...
                <MariloNumericTextBox Id="min"
                                       @bind-Value="@MinValue"
                                       OnChange="@SetupFilterRule">
                </MariloNumericTextBox>
                <label for="min">Max:&nbsp;</label>
                <MariloNumericTextBox Id="max"
                                       @bind-Value="@MaxValue"
                                       OnChange="@SetupFilterRule">
                </MariloNumericTextBox>
                <MariloButton ButtonType="ButtonType.Button"
...
You can find more examples in the [Live Demo: Custom Filter Menu](https://demos.marilo.com/blazor-ui/grid/custom-filter-menu) that is available in your local installation under the `demos` folder.
...
<MariloDataGrid Data="@GridData"
        ...
        <MariloGridColumn Field="@(nameof(Product.Size))">
            <FilterMenuTemplate>
                ...
                {
                    <div>
                        <MariloCheckBox Value="@(IsCheckboxInCurrentFilter(context.FilterDescriptor, size))"
                                         TValue="bool"
...
* [Live Demo: Grid Custom Filter Row](https://demos.marilo.com/blazor-ui/grid/custom-filter-row)
* [Live Demo: Grid Custom Filter Menu](https://demos.marilo.com/blazor-ui/grid/custom-filter-menu)
