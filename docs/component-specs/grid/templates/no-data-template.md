...
description: Use custom no data templates in the Marilo Grid for Blazor when the component has no items to display.
slug: grid-templates-no-data
tags: marilo, blazor, grid, templates
published: True
position: 38
components: ["grid"]
---
...
* [Live Demo: Grid - No Data Template](https://demos.marilo.com/blazor-ui/grid/no-data-template)
