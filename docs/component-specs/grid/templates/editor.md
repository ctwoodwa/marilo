...
tags: marilo,blazor,grid,templates,editor
published: True
position: 15
components: ["grid"]
---
...
````RAZOR.skip-repl
<EditorTemplate>
    <MariloTextArea @bind-Value="@((Product)context).Description" />
</EditorTemplate>
````
...
<EditorTemplate>
    @{
        ...
        <MariloTextArea @bind-Value="@editProduct.Description" />
    }
</EditorTemplate>
````
            ...
            <EditorTemplate>
                @{
                    ...
                    <div @onkeydown:stopPropagation>
                        <MariloTextArea @bind-Value="@item.Description"
                                         DebounceDelay="0" />
                    </div>
                }
            </EditorTemplate>
        ...
        <MariloGridColumn Field="@nameof(Product.HTMLDescription)">
            ...
            <EditorTemplate>
                @{
                    ...
                    <div @onkeydown:stopPropagation>
                        <MariloEditor @bind-Value="@item.HTMLDescription"></MariloEditor>
                    </div>
                }
            </EditorTemplate>
        </MariloGridColumn>
