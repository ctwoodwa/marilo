...
tags: marilo,blazor,grid,column,visible
published: True
position: 50
components: ["grid"]
---
...
<div>
    <MariloButton OnClick="@(() => isVisible = !isVisible)">Toggle the visibility of the Hire Date column</MariloButton>
</div>
...
## See Also
  ...
  * [Live Demo: Visible Columns](https://demos.marilo.com/blazor-ui/grid/columns)
