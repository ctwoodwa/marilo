...
tags: marilo,blazor,grid,column,automatic,automatically,generated,columns
published: true
position: 35
components: ["grid"]
---
...
<MariloDataGrid Data="@GridData" AutoGenerateColumns="true"
...
To set explicit position of the Automatically Generated Columns you can use the `GridAutoGeneratedColumns` tag inside `<MariloDataGrid>` and place it in the order you want it to have in relation to the columns you declare.
...
>tip To use the attributes listed above the `System.ComponentModel.DataAnnotations` using statement has to be present in the file with your model. With [Popup editing](https://demos.marilo.com/blazor-ui/grid/editing-popup), you can use validation attributes in addition to the customization attributes.
...
<div style="max-width: 800px;">
    ...
    <MariloDataGrid Data="@GridData"
        ...
        <GridToolBarTemplate>
            ...
            <MariloGridColumn Field="@nameof(GridDataModel.RegistrationDate)" Title="Registration Date" Width="200px" />
            <MariloGridCommandColumn Width="250px">
                <GridCommandButton Command="Edit" Icon="@SvgIcon.Pencil">Edit</GridCommandButton>
...
* [Live Demo: Auto Generated Columns](https://demos.marilo.com/blazor-ui/grid/column-auto-generation)
