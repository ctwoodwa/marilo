...
tags: marilo,blazor,grid,column,command
published: True
position: 5
components: ["grid"]
---
...
* You can customize the appearance of the `GridCommandButton` by applying the [appearance attributes available for the MariloButton](slug:button-appearance).
...
## See Also
  ...
  * [Live Demo: Grid Command Column](https://demos.marilo.com/blazor-ui/grid/editing-inline)
