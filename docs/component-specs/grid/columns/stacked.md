...
tags: marilo,blazor,grid,column,stacked
published: true
position: 37
components: ["grid"]
---
...
<MariloMediaQuery Media="(min-width:1200px)" OnChange="@( (bool matches) => IsLargeScreen = matches )" />
...
* [Live demo: Adaptive Grid](https://demos.marilo.com/blazor-ui/grid/adaptive)
* [Live demo: Grid and MediaQuery Integration](https://demos.marilo.com/blazor-ui/mediaquery/grid-integration)
