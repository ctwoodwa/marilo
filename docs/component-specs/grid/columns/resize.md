...
tags: marilo,blazor,grid,column,resize,drag
published: True
position: 20
components: ["grid"]
---
...
>caption How Column Resizing Works in the Marilo Grid
...
<MariloButton OnClick="@AutoFitSingleColumn">AutoFit ID Column</MariloButton>
...
## See Also
  ...
  * [Live Demo: Column Resizing](https://demos.marilo.com/blazor-ui/grid/column-resizing)
