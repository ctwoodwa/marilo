...
tags: marilo,blazor,grid,hierarchy,detail,detail template
published: True
position: 40
components: ["grid"]
---
...
* [Load Hierarchical Data On Demand](https://github.com/marilo/blazor-ui/tree/master/grid/load-on-demand-hierarchy)

* [Multi-Level Hierarchy](slug:grid-three-level-hierarchy)

* [Align Columns in Nested Grids](slug:grid-kb-align-columns-hierarchy)

* [Custom Excel Export that Includes Hierarchy](https://github.com/marilo/blazor-ui/tree/master/grid/export-to-xlsx-hierarchy)
...
* [Live Demo: Grid Hierarchy](https://demos.marilo.com/blazor-ui/grid/hierarchy)
