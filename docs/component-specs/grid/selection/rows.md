...
tags: marilo,blazor,grid,selection,rows
...
Check the [Grid Keyboard navigation demo](https://demos.marilo.com/blazor-ui/grid/keyboard-navigation) for detailed information about selecting rows with the keyboard.
...
* [Live Demo: Grid Row Selection](https://demos.marilo.com/blazor-ui/grid/row-selection)
