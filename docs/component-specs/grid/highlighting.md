...
description: Highlight rows and cells in the Marilo Blazor Grid to draw attention to important data.
tags: marilo,blazor,grid,highlight,highlighting
published: true
position: 40
components: ["grid"]
---
...
The Marilo [Blazor Grid](slug:grid-overview) enables you to highlight rows and cells programmatically. Use highlighting to draw attention to important data, indicate status, or visually group related records. Highlighting does not require user interaction and is fully controlled by the application logic.
...
See [Grid Highlighting API Reference](slug:marilo.blazor.components.HighlightedCellDescriptor) for details about these parameters and the `GridHighlightedCellDescriptor` type.
...
* [Highlighting API Reference](slug:marilo.blazor.components.HighlightedCellDescriptor)