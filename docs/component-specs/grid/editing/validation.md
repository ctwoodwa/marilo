...
tags: marilo, blazor, grid, validation, editing
published: True
position: 40
components: ["grid"]
---
...
The Marilo Grid for Blazor supports built-in validation that is enabled by default. This article describes how the Grid validation works and how to customize or disable it.
...
Third party validation tools are not part of Marilo UI for Blazor. Reference the required NuGet packages explicitly.
...
>caption Use Marilo Grid for Blazor with FluentValidation
...
<MariloDataGrid Data="@GridData"
    ...
    <GridToolBarTemplate>
        ...
        <label class="k-checkbox-label">
            <MariloCheckBox @bind-Value="@GridValidationEnabled" />
            Enable Validation
        </label>
    </GridToolBarTemplate>
...
* [Remote Validation](https://github.com/marilo/blazor-ui/tree/master/grid/remote-validation)
