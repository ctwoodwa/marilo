...
tags: marilo,blazor,grid,export,events
published: True
position: 15
components: ["grid"]
---
...
<MariloGrid Data="@GridData" Pageable="true" Sortable="true"
    ...
    <GridToolBarTemplate>
        ...
        <label class="k-checkbox-label"><MariloCheckBox @bind-Value="@ExportSelectedItemsOnly" />Export Selected Items Only</label>
    </GridToolBarTemplate>
...
@code {
    ...
    private void OnExcelBeforeExport(GridBeforeExcelExportEventArgs args)
    {
        ...
        // BuiltInNumberFormats is part of the Marilo.Documents.SpreadsheetStreaming namespace
