...
description: Learn how to implement an AI Chat Assistant for the Marilo UI for Blazor Grid that enables natural language interactions to perform data operations through conversational commands.
slug: grid-ai-chat-assistant
tags: marilo,blazor,grid,ai,chat,assistant,conversational
published: True
position: 18
...
>tip The example in this article uses a Marilo-hosted AI service for demonstration purposes only. For production applications, you should [implement your own AI service](slug:grid-ai-service-setup) that understands your specific domain, data, and business requirements.
...
2. Set Up the Chat Component
    ...
    @code {
        private MariloChat<Message> ChatRef { get; set; }
...
View the [complete live demo](https://demos.marilo.com/blazor-ui/grid/ai-chat-assistant).
