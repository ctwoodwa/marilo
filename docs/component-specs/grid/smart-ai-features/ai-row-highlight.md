...
tags: marilo,blazor,grid,ai,highlight,rows
published: True
position: 35
components: ["grid"]
---
...
<MariloDataGrid @ref="@GridRef">
    <GridToolBar>
        ...
        <GridToolBarCustomTool>
            <MariloButton Icon="@nameof(SvgIcon.ArrowRotateCcw)" 
...
View the [complete live demo](https://demos.marilo.com/blazor-ui/grid/ai-highlight).
