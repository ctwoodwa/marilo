...
tags: marilo,blazor,colorpicker,events
published: true
position: 20
...
This article describes the available events of the Marilo ColorPicker for Blazor.
...
<MariloColorPicker @bind-Value="@Color" OnChange="@ColorPickerOnChange" />
...
<MariloColorPicker Value="@Color" ValueChanged="@ColorPickerValueChanged" />
...
<MariloColorPicker @bind-Value="@Color" View="@View" ViewChanged="@ColorPickerViewChanged" />
...
````RAZOR
<MariloColorPicker @bind-Value="@Color" OnOpen="@OnColorPickerPopupOpen" />
...
<MariloColorPicker @bind-Value="@Color" OnClose="@OnColorPickerPopupClose" />
