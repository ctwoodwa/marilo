...
page_title: Marilo UI for Blazor ColorPicker Documentation | ColorPicker Accessibility
description: "Get started with the Marilo UI for Blazor ColorPicker and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Marilo UI for Blazor ColorPicker provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
* [Blazor ColorPicker Demos](https://demos.marilo.com/blazor-ui/colorpicker/overview)
