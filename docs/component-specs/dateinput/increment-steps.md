...
tags: marilo,blazor,DateInput,step
published: true
position: 15
...
<MariloDateInput Format="yyyy MMM dd, HH:mm:ss tt" @bind-Value="@selectedDateTime" Width="250px">
...
* [Live Demo: Date Input Incremental Steps](https://demos.marilo.com/blazor-ui/dateinput/incremental-steps)
