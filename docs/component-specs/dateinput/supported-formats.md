...
tags: marilo,blazor,DateInput,format,formats
published: true
position: 5
...
This article explains the format strings and specifiers supported by the Marilo DateInput for Blazor and how to set them to its `Format` property.
...
The Marilo Date Input supports the standard format strings and specifiers that come from the .NET Framework:
...
If you set an `DateTimeFormat.AMDesignator` and `DateTimeFormat.PMDesignator` to your current culture, they will be used by the Marilo components - the framework honors them and will render them in the date/time strings, and so the Marilo Time Pickers will also render the period of day (AM/PM) carousel, as if the culture supports it, even if it does not have them by default.
...
>caption Standard format strings support in Marilo Date Input for Blazor

````RAZOR
@TheDate
<br />

<MariloDateInput @bind-Value="TheDate" Format="d" />@TheDate.ToString("d")
<br />
<MariloDateInput @bind-Value="TheDate" Format="D" />@TheDate.ToString("D")
<br />
<MariloDateInput @bind-Value="TheDate" Format="f" />@TheDate.ToString("f")
<br />
<MariloDateInput @bind-Value="TheDate" Format="F" />@TheDate.ToString("F")
<br />
<MariloDateInput @bind-Value="TheDate" Format="g" />@TheDate.ToString("g")
<br />
<MariloDateInput @bind-Value="TheDate" Format="G" />@TheDate.ToString("G")
<br />
<MariloDateInput @bind-Value="TheDate" Format="m" />@TheDate.ToString("m")
<br />
<MariloDateInput @bind-Value="TheDate" Format="M" />@TheDate.ToString("M")
<br />
<MariloDateInput @bind-Value="TheDate" Format="r" />@TheDate.ToString("r")
<br />
<MariloDateInput @bind-Value="TheDate" Format="R" />@TheDate.ToString("R")
<br />
<MariloDateInput @bind-Value="TheDate" Format="s" />@TheDate.ToString("s")
<br />
<MariloDateInput @bind-Value="TheDate" Format="t" />@TheDate.ToString("t")
<br />
<MariloDateInput @bind-Value="TheDate" Format="T" />@TheDate.ToString("T")
<br />
<MariloDateInput @bind-Value="TheDate" Format="u" />@TheDate.ToString("u")
<br />
<MariloDateInput @bind-Value="TheDate" Format="y" />@TheDate.ToString("y")
<br />
<MariloDateInput @bind-Value="TheDate" Format="Y" />@TheDate.ToString("Y")
...
>caption Using supported .NET format specifiers to define relatively common date formats in the Marilo Date Input

````RAZOR
@TheDate
<br />

<MariloDateInput @bind-Value="TheDate" Format="dd MMM yyyy" /> @TheDate.ToString("dd MMM yyyy")
<br />
<MariloDateInput @bind-Value="TheDate" Format="dddd, dd MMM yyyy" /> @TheDate.ToString("dddd, dd MMM yyyy")
<br />
<MariloDateInput @bind-Value="TheDate" Format="HH:mm:ss" /> @TheDate.ToString("HH:mm:ss")
<br />
<MariloDateInput @bind-Value="TheDate" Format="dd MMM yyyy H:mm:ss" /> @TheDate.ToString("dd MMM yyyy H:mm:ss")
<br />
<MariloDateInput @bind-Value="TheDate" Format="dd MMMM yyyy HH:mm:ss" /> @TheDate.ToString("dd MMMM yyyy HH:mm:ss")
<br />
<MariloDateInput @bind-Value="TheDate" Format="dd-MM-yyyy" /> @TheDate.ToString("dd-MM-yyyy")
<br />
<MariloDateInput @bind-Value="TheDate" Format="dd.MMM.yyyy" /> @TheDate.ToString("dd.MMM.yyyy")
