...
tags: marilo,blazor,date,input,dateinput,overview
published: True
position: 0
...
>caption Basic Marilo Blazor DateInput

````RAZOR
<MariloDateInput @bind-Value="@DateValue"
                  Format="dd MMMM yyyy"
                  Min="@MinDate"
                  Max="@MaxDate"
...
````RAZOR
<MariloDateInput @ref="@DateInputRef"
                  @bind-Value="@DateValue"
                  Width="200px">
</MariloDateInput>

<MariloButton OnClick="@OnButtonClick">Focus DateInput</MariloButton>

@code {
    private MariloDateInput<DateTime> DateInputRef { get; set; }
...
* [Live Demo: Date Input](https://demos.marilo.com/blazor-ui/dateinput/overview)
* [Input Validation](slug:common-features/input-validation)
* [Date Input API Reference](slug:Marilo.Blazor.Components.MariloDateInput-1)
