...
tags: marilo,blazor,DateInput,efficient,keyboard,input
published: true
...
````RAZOR.skip-repl
<MariloDateInput AutoSwitchKeys="@( new List<object>() { "/", "tab" } )" />
````
...
````RAZOR
<ul>
    <li><label> <MariloCheckBox @bind-Value="@AllowCaretMode" /> AllowCaretMode </label></li>
    <li><label> <MariloCheckBox @bind-Value="@AutoCorrectParts" /> AutoCorrectParts </label></li>
    <li><label> <MariloCheckBox @bind-Value="@AutoSwitchParts" /> AutoSwitchParts </label></li>

    <li>
        <label>
            <MariloNumericTextBox @bind-Value="@TwoDigitYearMax" Min="0" Max="100" Width="80px" />
