...
This article describes the events of the Marilo ButtonGroup component for Blazor.
...
<p><label><MariloCheckBox @bind-Value="@HandleEvents" /> Handle SelectedChanged</label></p>
