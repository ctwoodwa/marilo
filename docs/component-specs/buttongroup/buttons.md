...
tags: marilo,blazor,toggle,button,group,type
published: True
position: 5
...
The `ButtonGroupButton` inherits the parameters and behavior of the [Marilo UI for Blazor Button](slug:components/button/overview) component.
...
The `ButtonGroupToggleButton` inherits the parameters and behavior of the [`MariloToggleButton`](slug:togglebutton-overview) component.
...
<MariloToggleButton @bind-Selected="@ShowHiddenButtons">Show Hidden Buttons</MariloToggleButton>
...
## See Also
  ...
  * [Live Demo: Button Types](https://demos.marilo.com/blazor-ui/buttongroup/button-types)
