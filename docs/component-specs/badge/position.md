...
tags: marilo,blazor,badge,position,align,alignment
published: True
position: 35
components: ["badge"]
---
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <label>
                Position
                <MariloDropDownList Data="@Positions" @bind-Value="@Position"></MariloDropDownList>
            </label>
        </div>
        <div class="col-md-4">
            <label>
                Horizontal Alignment
                <MariloDropDownList Data="@BadgeHorizontalAlignSettings" @bind-Value="@BadgeHorizontalAlignSetting"></MariloDropDownList>
            </label>
        </div>
        <div class="col-md-4">
            <label>
                Vertical Alignment
                <MariloDropDownList Data="@BadgeVerticalAlignSettings" @bind-Value="@BadgeVerticalAlignSetting"></MariloDropDownList>
            </label>
        </div>
    </div>
...
* [Live Demo: Badge Position](https://demos.marilo.com/blazor-ui/badge/position)
