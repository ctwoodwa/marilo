...
tags: marilo, blazor, dockmanager, docking
published: true
position: 10
        ...
        <DockManagerSplitPane>
            <Panes>
                ...
                <DockManagerContentPane HeaderText="Pane 1" Dockable="@Pane1Dockable">
                    <Content>
                        <MariloToggleButton @bind-Selected="@Pane1Dockable">Enable Docking Over Pane 1</MariloToggleButton>
                    </Content>
                </DockManagerContentPane>

                <DockManagerContentPane HeaderText="Pane 2" Dockable="Pane2Dockable">
                    <Content>
                        <MariloToggleButton @bind-Selected="@Pane2Dockable">Enable Docking Over Pane 2</MariloToggleButton>
                    </Content>
                </DockManagerContentPane>
