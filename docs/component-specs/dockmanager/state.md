...
tags: marilo,blazor,dockmanager,state,save,load,layout,set,change,management
published: True
position: 15
...
<MariloButton OnClick="@GetDockManagerState">Get State</MariloButton>
<MariloButton OnClick="@SetDockManagerState">Set State</MariloButton>

<MariloDockManager @ref="DockManager"
                    Height="600px"
                    OnStateInit="@OnStateInit"
                    OnStateChanged="@OnStateChanged">
    <DockManagerPanes>
...
@code {
    ...
    private MariloDockManager DockManager { get; set; }
...
* [DockManagerState API reference](slug:Marilo.Blazor.Components.MariloDockManager)
