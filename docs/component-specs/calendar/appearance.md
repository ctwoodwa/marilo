...
tags: marilo,blazor,calendar,appearance
published: True
position: 30
components: ["calendar"]
---
...
You can increase or decrease the size of the Calendar by setting the `Size` attribute to a member of the `Marilo.Blazor.ThemeConstants.Calendar.Size` class:
...
````RAZOR
@{
    var fields = typeof(Marilo.Blazor.ThemeConstants.Calendar.Size)
    ...
    foreach (var field in fields)
    {
        ...
        <div style="float:left; margin: 20px;">
            <MariloCalendar @bind-Value="@DateValue" Size="@size"></MariloCalendar>
        </div>
    }
}
...
* [Live Demo: Calendar - Appearance](https://demos.marilo.com/blazor-ui/calendar/appearance)
