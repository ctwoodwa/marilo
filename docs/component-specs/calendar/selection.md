...
tags: marilo,blazor,calendar,selection,select date,multiple selection
published: True
position: 2
components: ["calendar"]
---
...
To control how many dates the user can select, use the `SelectionMode` property. It takes a member of the `Marilo.Blazor.CalendarSelectionMode` enum and can be:
* `Single`
* `Multiple`
* `Range`
...
````RAZOR
<MariloCalendar @bind-Date="@startDate"
...
````RAZOR
<MariloCalendar @ref="@CalendarRef"
...
@code {
    ...
    private MariloCalendar CalendarRef { get; set; }
...
<MariloCalendar SelectionMode="@CalendarSelectionMode.Multiple"
...
@code {
    ...
    private Marilo.Blazor.Components.MariloCalendar multipleSelCalendar;
...
## See Also
  ...
  * [Live Demo: Calendar Selection](https://demos.marilo.com/blazor-ui/calendar/selection)
