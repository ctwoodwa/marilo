...
tags: marilo,blazor,calendar,navigation,min,max
published: True
position: 2
components: ["calendar"]
---
...
<MariloCalendar @bind-Date="@startDate" @bind-View="@selectedView" Min="@minDate" Max="@maxDate"></MariloCalendar>
@code {
...
To control the initial view, set the `View` property to a member of the `Marilo.Blazor.CalendarView` enum, as listed above.
...
<MariloCalendar TopView="@CalendarView.Year" BottomView="@CalendarView.Year" @bind-View="@SelectedView"
...
<MariloCalendar @bind-Date="@startDate" @bind-View="@calendarView"
                 Min="@min" Max="@max">
</MariloCalendar>
<MariloButton OnClick="@UpdateView">Update View</MariloButton>
