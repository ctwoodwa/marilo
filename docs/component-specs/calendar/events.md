...
tags: marilo,blazor,calendar,events
published: true
position: 21
components: ["calendar"]
---
...
This article explains the events available in the Marilo Calendar for Blazor:
...
<MariloCalendar Min="@CalendarMin"
                 Max="@CalendarMax"
                 Date="@CalendarDate"
...
@result
<br />
<MariloCalendar Min="@min" Max="@max" View="@initialView" ViewChanged="@ViewChangedHandler">
</MariloCalendar>
...
<MariloCalendar OnCellRender="@OnCellRender">
</MariloCalendar>
