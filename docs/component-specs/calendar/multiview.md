...
tags: marilo,blazor,calendar,multi,view,multiple
published: True
position: 3
components: ["calendar"]
---
...
````RAZOR
<MariloCalendar Views="3" View="CalendarView.Month">
</MariloCalendar>
````
...
````RAZOR
<MariloCalendar Orientation="@CalendarOrientation.Vertical"
                 Views="2"
...
## See Also
  ...
  * [Live Demo: Calendar - MultiView](https://demos.marilo.com/blazor-ui/calendar/multiview)
  * [Live Demo: Calendar - Orientation](https://demos.marilo.com/blazor-ui/calendar/orientation)
