...
tags: marilo,blazor,calendar,overview
published: True
position: 0
components: ["calendar"]
---
...
<MariloCalendar Min="@min" Max="@max" ValueChanged="@MyValueChangeHandler" @bind-Date="@theDate">
</MariloCalendar>
...
| `DisabledDates` | `List<DateTime>` | A list of dates that cannot be selected as the start or end of the range. See the <a href="https://demos.marilo.com/blazor-ui/calendar/disabled-dates" target="_blank">Live Demo: Calendar - Disabled Dates</a>. |
...
````RAZOR
<p>
    <MariloButton OnClick="@GoToPreviousMonth">Go To Previous Month</MariloButton>
    <MariloButton OnClick="@GoToNextMonth">Go To Next Month</MariloButton>
</p>

<MariloCalendar @ref="@Calendar"
                 @bind-Value="@CalendarValue"
                 @bind-Date="@CalendarDate" />

@code {
    MariloCalendar Calendar { get; set; }
...
* [Live Demo: Calendar](https://demos.marilo.com/blazor-ui/calendar/overview)
* [Calendar API Reference](slug:Marilo.Blazor.Components.MariloCalendar)
