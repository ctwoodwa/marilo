...
description: Separate items in the Marilo ToolBar for Blazor
slug: toolbar-separators
tags: marilo,blazor,toolbar,separator,spacer,tools
published: True
position: 5
components: ["toolbar"]
---
...
You can visually separate the items in the Marilo ToolBar for Blazor. Depending on the needs of your application you can use of the following, or a combination of them:
