...
tags: marilo,blazor,toolbar,appearance
published: True
position: 35
components: ["toolbar"]
---
...
````RAZOR
@{
    var fields = typeof(Marilo.Blazor.ThemeConstants.ToolBar.FillMode)
    ...
    foreach (var field in fields)
    {
        ...
        <div style="float:left; margin: 20px;">
            <MariloToolBar FillMode="@fillMode">
...
You can increase or decrease the size of the ToolBar by setting the `Size` parameter to a member of the `Marilo.Blazor.ThemeConstants.ToolBar.Size` class:
...
````RAZOR
@{
    var fields = typeof(Marilo.Blazor.ThemeConstants.ToolBar.Size)
        .GetFields(System.Reflection.BindingFlags.Public 
        | System.Reflection.BindingFlags.Static
        | System.Reflection.BindingFlags.FlattenHierarchy)
        .Where(field => field.IsLiteral && !field.IsInitOnly).ToList();
...
* [Live Demo: ToolBar Appearance](https://demos.marilo.com/blazor-ui/toolbar/appearance)
