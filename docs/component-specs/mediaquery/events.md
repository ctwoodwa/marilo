...
tags: marilo,blazor,mediaquery,events
published: True
position: 30
...
The MariloMediaQuery component for Blazor exposes events that allow you to respond to user actions and provide custom logic.
...
<MariloMediaQuery Media="@MediaQuery" OnChange="@OnChange"></MariloMediaQuery>
