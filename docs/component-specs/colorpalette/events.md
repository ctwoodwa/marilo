...
tags: marilo,blazor,Color,Palette,events
published: true
position: 50
...
This article explains the events available in the Marilo Color Palette for Blazor:
...
<MariloColorPalette @bind-Value="@MyColor" OnChange="@OnChangeHandler">
</MariloColorPalette>
...
<MariloColorPalette Value="@MyColor" ValueChanged="@ValueChangedHandler">
</MariloColorPalette>
...
<MariloColorPalette @bind-Value="@MyColor" OnBlur="@OnBlurHandler">
</MariloColorPalette>
