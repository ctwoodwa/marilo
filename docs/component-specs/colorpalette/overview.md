...
tags: marilo,blazor,masked,Color,Palette,overview
published: True
position: 0
...
1. Add the `<MariloColorPalette>` tag to a Razor file.
...
````RAZOR
<MariloColorPalette @bind-Value="@MyColor" />
...
* [Live ColorPalette Demos](https://demos.marilo.com/blazor-ui/colorpalette/overview)
* [ColorPalette API Reference](slug:Marilo.Blazor.Components.MariloColorPalette)
