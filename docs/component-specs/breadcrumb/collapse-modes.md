...
tags: marilo,blazor,breadcrumb,collapse,modes
published: True
position: 20
...
<div style="width:400px">
    <MariloBreadcrumb CollapseMode="@BreadcrumbCollapseMode.Wrap"
                       Data="@Items">
    </MariloBreadcrumb>
</div>
...
* [Live Demo: Breadcrumb Collapse Modes](https://demos.marilo.com/blazor-ui/breadcrumb/collapse-modes)