...
tags: marilo,blazor,breadcrumb,icons
published: True
position: 10
...
You can add [Marilo Font or SVG icons](slug:common-features-icons) to the Breadcrumb items. The component also supports custom icons.
...
````RAZOR
<MariloBreadcrumb Data="@Data"></MariloBreadcrumb>
...
* [Live Demo: Breadcrumb Items](https://demos.marilo.com/blazor-ui/breadcrumb/items)
