...
tags: marilo,blazor,breadcrumb,events
published: True
position: 30
...
This article explains the events available in the Marilo Breadcrumb for Blazor:
...
<MariloBreadcrumb OnItemClick="@ClickHandler"
                   Data="@Items" >
</MariloBreadcrumb>
...
* [Live Demo: Breadcrumb Events](https://demos.marilo.com/blazor-ui/breadcrumb/events)
