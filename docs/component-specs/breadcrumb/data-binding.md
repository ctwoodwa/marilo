...
tags: marilo,blazor,breadcrumb,data,binding
published: True
position: 5
...
The properties of a Breadcrumb item map directly to fields from the Breadcrumb model. You define that relationship by providing the names of the fields where the corresponding information is present. To do this, use the properties in the main `MariloBreadcrumb` tag:
...
@code {
    ...
    protected override void OnInitialized()
    {
        Items = new List<BreadcrumbItem>
        {
            ...
            {
                ItemText = "Overview",
                ItemUrl = "https://demos.marilo.com/blazor-ui/breadcrumb/overview"
            },
            new BreadcrumbItem
            { ItemText = "Navigation",
                ItemUrl = "https://demos.marilo.com/blazor-ui/breadcrumb/navigation",
            },
            new BreadcrumbItem
            { ItemText = "Items",
                ItemUrl = "https://demos.marilo.com/blazor-ui/breadcrumb/items",
                ItemDisabled = true
            },
            new BreadcrumbItem
            {
                ItemText = "Collapse Modes",
                ItemUrl = "https://demos.marilo.com/blazor-ui/breadcrumb/collapse-modes"
            }
        };
    }
