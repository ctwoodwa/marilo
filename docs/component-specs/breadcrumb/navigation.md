...
tags: marilo,blazor,breadcrumb,navigation
published: True
position: 7
...
Here is an example for such a configuration in our public repository - [SubScribeToLocationChanged](https://github.com/marilo/blazor-ui/tree/master/breadcrumb/subscribe-to-location-changed).
...
* [Live Demo: Breadcrumb Navigation](https://demos.marilo.com/blazor-ui/breadcrumb/navigation)
