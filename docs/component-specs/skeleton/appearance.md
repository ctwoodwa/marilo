...
tags: marilo,blazor,skeleton,appearance
published: True
position: 5
components: ["skeleton"]
---
...
<div class="row">
    <div class="col-4" style="position: relative;">
        <MariloSkeleton ShapeType="@SkeletonShapeType.Circle"
    ...
    <div class="col-4" style="position: relative;">
        <MariloSkeleton ShapeType="@SkeletonShapeType.Text"
                         Width="50px" Height="50px" Visible="true">
        </MariloSkeleton>
    </div>
</div>
...
<div class="row">
    <div class="col-4" style="position:relative;">
        <MariloSkeleton AnimationType="@SkeletonAnimationType.None"
                         Width="50px" Height="50px" Visible="true">
        </MariloSkeleton>
    </div>
    <div class="col-4" style="position:relative;">
        <MariloSkeleton AnimationType="@SkeletonAnimationType.Pulse"
                         Width="50px" Height="50px" Visible="true">
        </MariloSkeleton>
    </div>
    <div class="col-4" style="position:relative;">
        <MariloSkeleton AnimationType="@SkeletonAnimationType.Wave"
                         Width="50px" Height="50px" Visible="true">
        </MariloSkeleton>
    </div>
</div>
...
* [Live Demo: Skeleton Appearance](https://demos.marilo.com/blazor-ui/skeleton/appearance)
