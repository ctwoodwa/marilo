...
The Marilo Blazor ListBox fires events that are related to toolbar button clicks and drag and drop user actions. This article describes all events and event arguments.
...
<MariloListBox Data="@ListBoxData"
...
The event handler receives an argument of type [`ListBoxRemoveEventArgs<T>`](slug:Marilo.Blazor.Components.ListBoxRemoveEventArgs-1). See the [example below](#example) and the [example in article ListBox Templates](slug:listbox-templates#example).
...
The event handler receives an argument of type [`ListBoxReorderEventArgs<T>`](slug:Marilo.Blazor.Components.ListBoxReorderEventArgs-1). See the [example below](#example) and the example at [Creating Blazor ListBox](slug:listbox-overview#creating-blazor-listbox).
...
The event handler receives an argument of type [`ListBoxTransferEventArgs<T>`](slug:Marilo.Blazor.Components.ListBoxTransferEventArgs-1). See the [example below](#example) and the [example in article Connect ListBoxes](slug:listbox-connect#example).
...
@code {
    private MariloListBox<ListBoxModel> ListBoxRef1 { get; set; } = null!;
    private MariloListBox<ListBoxModel> ListBoxRef2 { get; set; } = null!;
...
* [Live Demo: ListBox Events](https://demos.marilo.com/blazor-ui/listbox/events)
