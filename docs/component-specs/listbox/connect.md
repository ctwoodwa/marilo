...
One of the main benefits of the Marilo Blazor ListBox is the ability to move items from one component instance to another. This article explains how to link multiple ListBoxes to transfer items.
...
<label><MariloCheckBox @bind-Value="@SelectItemsInDestination" /> Select Moved Items in Destination ListBox</label>

@code {
    private MariloListBox<ListBoxModel> ListBoxRef1 { get; set; } = null!;
    private MariloListBox<ListBoxModel> ListBoxRef2 { get; set; } = null!;
    private MariloListBox<ListBoxModel> ListBoxRef3 { get; set; } = null!;
...
* [Live Demo: ListBox](https://demos.marilo.com/blazor-ui/listbox/overview)
