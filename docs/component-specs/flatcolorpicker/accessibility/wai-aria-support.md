...
page_title: Marilo UI for Blazor FlatColorPicker Documentation | FlatColorPicker Accessibility
description: "Get started with the Marilo UI for Blazor FlatColorPicker and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Marilo UI for Blazor FlatColorPicker provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
* [Blazor ColorGradient Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/colorgradient/keyboard-navigation)
* [Blazor ColorPalette Accessibility and Keyboard Navigation Demo](https://demos.marilo.com/blazor-ui/colorpalette/keyboard-navigation)

## See Also

* [Blazor FlatColorPicker Demos](https://demos.marilo.com/blazor-ui/flatcolorpicker/overview)
