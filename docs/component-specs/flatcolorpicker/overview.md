...
tags: marilo,blazor,flatcolorpicker,overview
published: True
position: 0
...
To use a Marilo FlatColorPicker for Blazor:

1. Add the `MariloFlatColorPicker` tag.
...
* [FlatColorPicker Live Demo](https://demos.marilo.com/blazor-ui/flatcolorpicker/overview)
