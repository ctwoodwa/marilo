...
tags: marilo,blazor,flatcolorpicker,events
published: true
position: 20
...
This article describes the available events of the Marilo FlatColorPicker for Blazor.
...
<MariloFlatColorPicker @bind-Value="@Color" OnChange="@FlatColorPickerOnChange" />
...
<MariloFlatColorPicker Value="@Color" ValueChanged="@FlatColorPickerValueChanged" />
...
<MariloFlatColorPicker @bind-Value="@Color" View="@View" ViewChanged="@FlatColorPickerViewChanged" />
