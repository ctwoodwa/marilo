...
tags: marilo,blazor,flatcolorpicker,views,overview
published: True
position: 0
...
The GradientView uses a [`MariloColorGradient` component](slug:colorgradient-overview). The following [ColorGradient attributes](slug:colorgradient-overview#colorgradient-parameters) are exposed in the `FlatColorPickerGradientView` tag:
...
The PaletteView uses a [`MariloColorPalette` component](slug:colorpalette-overview). The following [ColorPalette attributes](slug:colorpalette-overview#colorpalette-parameters) are exposed in the `FlatColorPickerPaletteView` tag:
...
<MariloFlatColorPicker @bind-Value="@Color">
...
* [FlatColorPicker Views Demo](https://demos.marilo.com/blazor-ui/flatcolorpicker/views)
