...
tags: marilo,blazor,editor,prosemirror,schema
published: True
position: 5
components: ["editor"]
---
...
@code {
    ...
    {
        EditorValue = @"
        <p>This Marilo Blazor Editor uses a ProseMirror Schema that supports only several nodes and marks - Paragraph, Hyperlinks, Bold text, Emphasized text, Underlined text.</p>
...
* [Live Demo: Editor - ProseMirror Schema](https://demos.marilo.com/blazor-ui/editor/prosemirror-schema)
...
Similar to how this is handled in the Grid State article - https://docs.marilo.com/blazor-ui/components/grid/state#examples
-->