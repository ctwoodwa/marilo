...
slug: editor-events
tags: marilo,blazor,editor,event
published: True
position: 150
components: ["editor"]
---
...
This article explains the events available in the Marilo Editor for Blazor:
...
<MariloEditor Value="@TheEditorContent" ValueChanged="@ValueChangedHandler">
</MariloEditor>
