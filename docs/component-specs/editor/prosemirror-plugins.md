...
tags: marilo,blazor,editor,prosemirror,plugins
published: True
position: 130
components: ["editor"]
---
...
The Marilo UI for Blazor Editor component is based on the <a href="https://prosemirror.net/" target="_blank">ProseMirror library</a>. ProseMirror provides a set of tools and concepts for building rich text editors, using user interface inspired by what-you-see-is-what-you-get.
...
@code {
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            //Plug the styles with JavaScript as shown below or set the EditMode to `Div` - https://docs.marilo.com/blazor-ui/components/editor/edit-modes/div
...
* [Live Demo: Editor - ProseMirror Plugins](https://demos.marilo.com/blazor-ui/editor/prosemirror-plugins)
* [ProseMirror Schema](slug:editor-prosemirror-schema-overview)


<!-- # Examples

List here the KB articles created as part of https://github.com/marilo/blazor/issues/9608 

Similar to how this is handle in the Grid State article - https://docs.marilo.com/blazor-ui/components/grid/state#examples
-->