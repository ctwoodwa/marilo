...
tags: marilo,blazor,custom,tool
published: True
position: 60
...
The [Blazor Editor](https://www.marilo.com/blazor-ui/editor) component lets you add custom tools to its [toolbar](slug:editor-toolbar). In those tools, you can use both the [built-in tools and commands](slug:editor-built-in-tools) the editor provides, and also your own custom logic.
...
<MariloEditor Tools="@Tools" @bind-Value="@TheEditorContent">
    <EditorCustomTools>
        <EditorCustomTool Name="AddSignature">
            <MariloButton OnClick="@AddSignature">Add Signature</MariloButton>
        </EditorCustomTool>
    </EditorCustomTools>
</MariloEditor>
...
<MariloEditor @ref="@EditorRef" Tools="@Tools" @bind-Value="@TheEditorContent">
    <EditorCustomTools>
        <EditorCustomTool Name="ImportantFragment">
            <MariloButton OnClick="@MarkImportant" Icon="@SvgIcon.Star"></MariloButton>
        </EditorCustomTool>
    </EditorCustomTools>
</MariloEditor>
...
<MariloEditor Tools="@Tools" @bind-Value="@TheEditorContent">
    <EditorCustomTools>
        <EditorCustomTool Name="Save">
            <MariloButton OnClick="@Save" Icon="@SvgIcon.Save" />
        </EditorCustomTool>
    </EditorCustomTools>
</MariloEditor>
