...
tags: marilo,blazor,edit,mode,overview
published: True
position: 0
components: ["editor"]
---
...
You control which mode is used through the `EditMode` parameter of the editor which takes a member of the `Marilo.Blazor.EditorEditMode` enum:
...
<MariloEditor @bind-Value="@Val1" EditMode="@EditorEditMode.Iframe"></MariloEditor>

<MariloEditor @bind-Value="@Val2" EditMode="@EditorEditMode.Div"></MariloEditor>
