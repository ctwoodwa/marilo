...
#advanced-example-toolbar
    <GridToolBarTemplate>
        ...
        <label class="k-checkbox-label"><MariloCheckBox @bind-Value="@ShouldCancelOnAddEdit" /> Cancel OnAdd and OnEdit Events</label>
        <span class="k-separator"></span>
        <label class="k-checkbox-label"><MariloCheckBox @bind-Value="@GridConfirmDelete" /> Confirm Delete Commands</label>
        <span class="k-separator"></span>
        <label class="k-checkbox-label"><MariloCheckBox @bind-Value="@ShouldConfirmOnCancel" /> Confirm Cancel Commands</label>
    </GridToolBarTemplate>
#end
...
#advanced-example-code
    ...
    [CascadingParameter]
    public DialogFactory? MariloDialogs { get; set; }
    ...
    {
        if (ShouldConfirmOnCancel && MariloDialogs != null)
        {
            bool shouldContinue = await MariloDialogs.ConfirmAsync("Do you want to discard your changes?");
