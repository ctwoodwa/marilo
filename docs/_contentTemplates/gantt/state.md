...
<MariloButton OnClick="@SetGanttSort">Sort Gantt by Status</MariloButton>
...
<MariloButton OnClick="@SetGanttFilter">Filter Gantt by Task 2</MariloButton>
...
<MariloButton OnClick="@SetGanttFilter">Filter Gantt by Task 2 and 5</MariloButton>
...
<MariloButton OnClick="@SetExpandedItems">Expand First Task Only</MariloButton>
