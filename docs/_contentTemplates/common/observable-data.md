...
#observable-data
Databound components can benefit from live updates - when the data source collection changes, the components should update to reflect that change. Most data-bound components in the Marilo UI for Blazor suite implement such functionality.
