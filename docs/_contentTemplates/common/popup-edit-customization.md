...
| `ThemeColor` | `string` | The color scheme of the window. Use the available members of the static class [`ThemeConstants.Window.ThemeColor`](slug:Marilo.Blazor.ThemeConstants.Window.ThemeColor). |
