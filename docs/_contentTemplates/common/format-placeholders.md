...
The `FormatPlaceholder` parameter allows you to set custom strings as placeholders for each DateTime segment and is available for the following Marilo UI for Blazor components:
...
<MariloDatePicker @bind-Value="@DateValue">
