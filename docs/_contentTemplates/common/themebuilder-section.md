...
To take full control over the appearance of the Marilo UI for Blazor components, you can create your own styles by using [ThemeBuilder](https://docs.marilo.com/themebuilder).
