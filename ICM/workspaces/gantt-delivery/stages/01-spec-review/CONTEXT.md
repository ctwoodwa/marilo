...
| API spec | /workspaces/Marilo/docs/component-specs/gantt/ | Full directory | What is documented |
...
| Gap workspace closure reports | /workspaces/Marilo/workspaces/gantt-gap-analysis/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/gantt-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/gantt-spec-gap-list.md | spec-coverage-format.md |
