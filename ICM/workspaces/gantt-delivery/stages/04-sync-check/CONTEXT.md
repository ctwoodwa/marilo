...
| Stage 03 output | stages/03-visual-parity/output/ | Full file | Visual parity gaps |
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/gantt-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/gantt-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/gantt-delivery-report.md | delivery-checklist.md |
