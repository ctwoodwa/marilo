...
| [SCSS component file — gantt] | [specific selector or rule, e.g., .marilo-gantt-bar, .marilo-gantt-milestone, .marilo-gantt-dependency] |
...
- [ ] Other states of this component (e.g., fixing task bar height should not break milestone sizing)
- [ ] Other components (if changing a foundation token, scan for consumers)
- [ ] Dependency line rendering — line weight changes affect all connector types
