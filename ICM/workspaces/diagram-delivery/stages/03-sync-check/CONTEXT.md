...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/diagram-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/diagram-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/diagram-delivery-report.md | delivery-checklist.md |
