...
|--------|--------------|---------------|-----|
| Previous stage | ../03-resolution-design/output/gap-scheduler-resolutions.md | Full file | Approved resolution decisions |
| Backlog | ../02-prioritize/output/gap-scheduler-backlog.md | Phase assignments | Phase structure and dependencies |
| Config | ../../_config/gap-context.md | Full file | Project context and constraints |
| Target project | src/Marilo.Components/ | Project structure | Identify affected files per task |
...
3. Group tasks into rollout phases:
   ...
   - **Enforcement:** Add guardrails to prevent regression.
...
|----------|----------|--------|
| Remediation plan | output/gap-scheduler-remediation-plan.md | Phased task list with dependencies and criteria |
