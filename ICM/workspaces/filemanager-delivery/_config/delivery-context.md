# Delivery Context -- MariloFileManager

## Component Identity

| Field | Value |
|-------|-------|
| Component name | MariloFileManager |
| Component slug | filemanager |
...
| Field | Value |
|-------|-------|
| API spec | /workspaces/Marilo/docs/component-specs/filemanager/ |
| Example UX | /workspaces/Marilo/samples/Marilo.Demo/Pages/Components/FileManager/ |
| Component source | /workspaces/Marilo/src/Marilo.Components/Forms/Inputs/ |
| Test files | UNKNOWN |
| Gap workspace | /workspaces/Marilo/workspaces/filemanager-gap-analysis |
...
| Field | Value |
|-------|-------|
| Latest closure reports | /workspaces/Marilo/workspaces/filemanager-gap-analysis/stages/06-validate/output/ |
| Coverage summary | /workspaces/Marilo/workspaces/filemanager-gap-analysis/_config/coverage-summary.md |
