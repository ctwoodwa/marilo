...
**Gap ID:** VP-filemanager-[sequence]
...
| [SCSS component file — filemanager] | [specific selector or rule, e.g., .marilo-filemanager-tree, .marilo-filemanager-grid, .marilo-filemanager-breadcrumb, .marilo-filemanager-context-menu] |
...
- [ ] Other states of this component (e.g., fixing item hover should not break selected item or context menu)
- [ ] Other components (if changing a foundation token, scan for consumers)
- [ ] Pane splitter layout — splitter and panel width changes affect both tree and file grid simultaneously
