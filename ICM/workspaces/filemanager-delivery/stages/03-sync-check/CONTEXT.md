...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/filemanager-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/filemanager-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/filemanager-delivery-report.md | delivery-checklist.md |
