...
## Visual Parity
- [ ] Visual parity review completed or explicitly waived
- [ ] All critical parity gaps resolved or tracked
- [ ] Parity scores documented for primary states across all active themes
- [ ] Open parity issues listed with remediation handoff targets

## Alignment
- [ ] Spec version consistent with implementation
