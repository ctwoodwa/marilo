...
1. Read all four stage outputs and delivery config.
...
4. Write output/allocation-scheduler-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/allocation-scheduler-delivery-report.md | delivery-checklist.md |
