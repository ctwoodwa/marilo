...
This workspace is initialized. Run intake (Stage 01) to begin gap analysis. Feature areas are tracked in ../datagrid-delivery/_config/delivery-context.md.

## Folder Map

```
datagrid-gap-analysis/
...
| Return to delivery workspace | ../datagrid-delivery/CLAUDE.md |
