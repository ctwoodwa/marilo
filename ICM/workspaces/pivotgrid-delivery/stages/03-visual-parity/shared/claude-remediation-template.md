...
| [SCSS component file — pivotgrid] | [specific selector or rule, e.g., .marilo-pivot-row-header, .marilo-pivot-data-cell, .marilo-pivot-field-chooser] |
...
- [ ] Other states of this component (e.g., fixing row header indentation should not break column header alignment)
- [ ] Other components (if changing a foundation token, scan for consumers)
- [ ] Aggregation row distinction — changes to typography tokens may flatten the visual hierarchy
