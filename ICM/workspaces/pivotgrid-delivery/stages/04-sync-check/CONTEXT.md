...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/pivotgrid-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/pivotgrid-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/pivotgrid-delivery-report.md | delivery-checklist.md |
