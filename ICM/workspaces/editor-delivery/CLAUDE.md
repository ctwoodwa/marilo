...
```
Pipeline Status: editor-delivery
...
| Read gap-analysis workspace for this component | /workspaces/Marilo/workspaces/editor-gap-analysis/CLAUDE.md |
...
<!-- CDW owns: spec accuracy, Example UX completeness.
     ...
     /workspaces/Marilo/workspaces/editor-gap-analysis/.
