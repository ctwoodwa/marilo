...
| [SCSS component file — editor] | [specific selector or rule, e.g., .marilo-editor-toolbar, .marilo-editor-toolbar-button, .marilo-editor-content] |
...
- [ ] Other toolbar button states (e.g., fixing hover should not break active or focus ring)
- [ ] Other components (if changing a foundation token, scan for consumers)
- [ ] Dialog chrome — dialog fixes must be tested for both link and image dialogs
