...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/editor-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/editor-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/editor-delivery-report.md | delivery-checklist.md |
