...
```
Pipeline Status: datasheet-delivery
...
| Read gap-analysis workspace for this component | /workspaces/Marilo/workspaces/datasheet-gap-analysis/CLAUDE.md |
...
<!-- CDW owns: spec accuracy, Example UX completeness.
     ...
     /workspaces/Marilo/workspaces/datasheet-gap-analysis.
