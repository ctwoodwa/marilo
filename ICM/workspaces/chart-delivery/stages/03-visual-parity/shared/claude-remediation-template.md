...
| [SCSS component file — chart] | [specific selector or rule, e.g., .marilo-chart-series, .marilo-chart-tooltip, .marilo-chart-legend] |
...
- [ ] Other states of this component (e.g., fixing series hover should not break series selected)
- [ ] Other components (if changing a foundation token, scan for consumers)
- [ ] Other series types (e.g., fixing line chart colors should not break bar or pie palette)
