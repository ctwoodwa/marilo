...
| Stage 03 output | stages/03-visual-parity/output/ | Full file | Parity gap list |
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/scheduler-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/scheduler-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/scheduler-delivery-report.md | delivery-checklist.md |
