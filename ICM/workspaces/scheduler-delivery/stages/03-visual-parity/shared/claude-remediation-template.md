...
**Token-first rule:** If the issue is a color, spacing, or typography mismatch that could recur across components, fix the token in the SCSS foundation layer rather than patching the component file.
...
| [SCSS component file] | [specific selector or rule] |
...
- [ ] Other states of this component (e.g., fixing hover should not break selected)
