...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/wizard-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/wizard-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/wizard-delivery-report.md | delivery-checklist.md |
