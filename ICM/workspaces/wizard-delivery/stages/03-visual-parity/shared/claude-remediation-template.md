# Claude Remediation Template -- MariloWizard
...
| [SCSS component file] | [specific selector or rule, e.g., .marilo-wizard__step--active] |
...
- [ ] Other states of this component (e.g., fixing active step should not break completed or pending)
