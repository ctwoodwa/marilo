...
**ID:** VP-wizard-[sequence]
**Component:** MariloWizard
**Theme:** Fluent | Bootstrap | Material
**Mode:** Light | Dark
**State/Scenario:** [e.g., step indicator active, step indicator completed, step indicator pending, step content area, navigation buttons, disabled step, validation error, non-linear mode]
**Reference Source:** Telerik Wizard | internal Marilo baseline
...
- Reference source is Telerik Wizard for states where Telerik has a clear equivalent. Use internal Marilo baseline for states unique to Marilo.
