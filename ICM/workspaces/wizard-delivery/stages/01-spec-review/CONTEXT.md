...
| API spec | /workspaces/Marilo/docs/component-specs/wizard/ | Full directory | What is documented |
...
| Gap workspace closure reports | /workspaces/Marilo/workspaces/wizard-gap-analysis/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/wizard-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/wizard-spec-gap-list.md | spec-coverage-format.md |
