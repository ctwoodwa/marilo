...
| Read gap-analysis workspace for this component | /workspaces/Marilo/workspaces/map-gap-analysis/CLAUDE.md |
...
<!-- CDW owns: spec accuracy, Example UX completeness.
     ...
     /workspaces/Marilo/workspaces/map-gap-analysis/.
