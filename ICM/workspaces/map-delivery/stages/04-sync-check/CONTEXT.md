...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/map-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/map-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/map-delivery-report.md | delivery-checklist.md |
