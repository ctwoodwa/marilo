# Claude Remediation Template -- MariloMap
...
[What the correct rendering should look like — Telerik Map reference screenshot path or description]
...
- [ ] Other states of this component (e.g., fixing marker hover should not break marker selected)
