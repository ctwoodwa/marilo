# Claude Remediation Template -- MariloDockManager
...
**Gap ID:** VP-dockmanager-[sequence]
...
- [ ] Other states of this component (e.g., fixing panel header should not break tab strip)
