...
| API spec | /workspaces/Marilo/docs/component-specs/dockmanager/ | Full directory | What is documented |
...
| Gap workspace closure reports | /workspaces/Marilo/workspaces/dockmanager-gap-analysis/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/dockmanager-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/dockmanager-spec-gap-list.md | spec-coverage-format.md |
