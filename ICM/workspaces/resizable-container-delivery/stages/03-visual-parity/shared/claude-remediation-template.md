# Claude Remediation Template -- MariloResizableContainer
...
**Gap ID:** VP-resizable-container-[sequence]
...
[What the correct rendering should look like — internal Marilo delivery-quality baseline description]
...
- [ ] Other states of this component (e.g., fixing handle hover should not break handle active)
