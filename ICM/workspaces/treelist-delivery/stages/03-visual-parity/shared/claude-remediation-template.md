...
| [SCSS component file — treelist] | [specific selector or rule, e.g., .marilo-treelist-row, .marilo-treelist-expand-icon, .marilo-treelist-indent] |
...
- [ ] Other states of this component (e.g., fixing row hover should not break selected row or checkbox selection)
- [ ] Other components (if changing a foundation token, scan for consumers)
- [ ] Tree indentation — indentation changes must be tested at all hierarchy depths (level 1, 2, 3+)
