...
| API spec | /workspaces/Marilo/docs/component-specs/treelist/ | Full directory | What is documented |
...
| Gap workspace closure reports | /workspaces/Marilo/workspaces/treelist-gap-analysis/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/treelist-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/treelist-spec-gap-list.md | spec-coverage-format.md |
