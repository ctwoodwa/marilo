...
```
Pipeline Status: datagrid-delivery
...
| Read gap-analysis workspace for this component | /workspaces/Marilo/workspaces/datagrid-gap-analysis/CLAUDE.md |
...
<!-- CDW owns: spec accuracy, Example UX completeness.
     ...
     /workspaces/Marilo/workspaces/datagrid-gap-analysis.
