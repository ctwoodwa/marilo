...
| Gap workspace coverage summary | /workspaces/Marilo/workspaces/datagrid-gap-analysis/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/datagrid-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/datagrid-delivery-report.md | delivery-checklist.md |
