...
**ID:** VP-datagrid-[sequence]
**Component:** MariloDataGrid
**Theme:** Fluent | Bootstrap | Material
**Mode:** Light | Dark
**State/Scenario:** [e.g., default grid, header row, row hover, sorted ascending, filter menu, grouped, pager idle]
**Reference Source:** Telerik Grid | internal Marilo baseline
...
- Reference source is Telerik Grid for states where Telerik has a clear equivalent. Use internal Marilo baseline for states unique to Marilo.
