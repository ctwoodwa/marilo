...
**ID:** VP-splitter-[sequence]
**Component:** MariloSplitter
**Theme:** Fluent | Bootstrap | Material
**Mode:** Light | Dark
**State/Scenario:** [e.g., horizontal split default, resize handle hover, resize handle active, collapsed pane, nested splitters, min/max constraint hit]
**Reference Source:** Telerik Splitter | internal Marilo baseline
...
- Reference source is Telerik Splitter for states where Telerik has a clear equivalent. Use internal Marilo baseline for states unique to Marilo.
