...
**ID:** VP-treeview-[sequence]
**Component:** TreeView
**Theme:** Fluent | Bootstrap | Material
**Mode:** Light | Dark
**State/Scenario:** [e.g., default hierarchy, expanded node, selected node, checkbox indeterminate]
**Reference Source:** Telerik TreeView | internal Marilo baseline
...
- Reference source is Telerik TreeView for states where Telerik has a clear equivalent. Use internal Marilo baseline for states unique to Marilo.
- Category helps route remediation: token/color issues go to SCSS foundation; spacing/layout issues go to component SCSS.
