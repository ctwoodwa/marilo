...
| API spec | /home/user/marilo/docs/component-specs/treeview/ | Full directory | What is documented |
| Component source | /home/user/marilo/src/Marilo.Components/Navigation/ | Parameter and event declarations only | What is implemented |
| Spec coverage format | shared/spec-coverage-format.md | Full file | Gap record format |
| Gap workspace closure reports | /home/user/marilo/workspaces/gap-analysis-resolution/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/treeview-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/treeview-spec-gap-list.md | spec-coverage-format.md |
