...
| API spec | {{SPEC_PATH}} | Full directory | What is documented |
| Component source | {{SOURCE_PATH}} | Parameter and event declarations only | What is implemented |
| Spec coverage format | shared/spec-coverage-format.md | Full file | Gap record format |
| Gap workspace closure reports | {{GAP_WORKSPACE_PATH}}/stages/06-validate/output/ | List + read relevant reports | Current resolution state |
...
8. Write output/{{COMPONENT_SLUG}}-spec-gap-list.md.
...
|----------|----------|--------|
| Spec gap list | output/{{COMPONENT_SLUG}}-spec-gap-list.md | spec-coverage-format.md |
