...
1. Read `workspaces/treeview-delivery/CLAUDE.md` — this is the workspace routing layer
2. If `$ARGUMENTS` is provided, treat it as a **trigger keyword** and follow the Triggers table in CLAUDE.md
3. If no argument, read `workspaces/treeview-delivery/CONTEXT.md` for task routing
...
`workspaces/gap-analysis-resolution/` — TreeView graduated from the shared gap-analysis-resolution workspace.
