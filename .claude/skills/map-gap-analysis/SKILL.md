...
1. Read `workspaces/map-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/map-delivery/` — spec accuracy and Example UX coordination happen there.
