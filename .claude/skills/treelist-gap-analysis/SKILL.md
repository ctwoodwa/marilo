...
1. Read `workspaces/treelist-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/treelist-delivery/` — spec accuracy and Example UX coordination happen there.
