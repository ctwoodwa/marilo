...
1. Read `ICM/workspaces/diagram-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`ICM/workspaces/diagram-delivery/` — spec accuracy and Example UX coordination happen there.
