...
1. Read `workspaces/gantt-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/gantt-delivery/` — spec accuracy and Example UX coordination happen there.
