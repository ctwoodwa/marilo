...
1. Read `workspaces/pivotgrid-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/pivotgrid-delivery/` — spec accuracy and Example UX coordination happen there.
