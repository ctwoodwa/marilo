...
1. Read `workspaces/dockmanager-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/dockmanager-delivery/` — spec accuracy and Example UX coordination happen there.
