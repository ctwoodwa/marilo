...
1. Read `workspaces/chart-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/chart-delivery/` — spec accuracy and Example UX coordination happen there.
