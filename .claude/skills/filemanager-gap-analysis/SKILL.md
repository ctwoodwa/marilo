...
1. Read `workspaces/filemanager-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/filemanager-delivery/` — spec accuracy and Example UX coordination happen there.
