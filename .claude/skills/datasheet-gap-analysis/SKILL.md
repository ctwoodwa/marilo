---
name: datasheet-gap-analysis
description: "ICM workspace: Gap analysis for MariloDataSheet. Intake, prioritize, design, plan, implement, validate. Stages: 01-intake through 06-validate."
argument-hint: "[setup|status|ingest|resolve|close]"
allowed-tools: Read Glob Grep Edit Write
---

# MariloDataSheet Gap Analysis — ICM Workspace Skill
