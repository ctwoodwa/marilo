...
1. Read `workspaces/editor-delivery/CLAUDE.md` — this is the workspace routing layer
2. If `$ARGUMENTS` is provided, treat it as a **trigger keyword** and follow the Triggers table in CLAUDE.md
3. If no argument, read `workspaces/editor-delivery/CONTEXT.md` for task routing
...
`workspaces/editor-gap-analysis/` — source changes and test writing are delegated there.
