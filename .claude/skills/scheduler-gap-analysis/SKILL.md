...
1. Read `workspaces/scheduler-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/scheduler-delivery/` — spec accuracy and Example UX coordination happen there.
