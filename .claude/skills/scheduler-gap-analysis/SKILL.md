---
name: scheduler-gap-analysis
description: "ICM workspace: Gap analysis for MariloScheduler. Intake, prioritize, design, plan, implement, validate. Stages: 01-intake through 06-validate."
argument-hint: "[setup|status|ingest|resolve|close]"
allowed-tools: Read Glob Grep Edit Write
---

# MariloScheduler Gap Analysis — ICM Workspace Skill
...
1. Read `ICM/workspaces/scheduler-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`ICM/workspaces/scheduler-delivery/` — spec accuracy and Example UX coordination happen there.
