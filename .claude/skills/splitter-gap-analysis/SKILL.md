...
1. Read `workspaces/splitter-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/splitter-delivery/` — spec accuracy and Example UX coordination happen there.
