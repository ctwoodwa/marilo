---
name: datagrid-gap-analysis
description: "ICM workspace: Gap analysis for MariloDataGrid. Intake, prioritize, design, plan, implement, validate. Stages: 01-intake through 06-validate."
argument-hint: "[setup|status|ingest|resolve|close]"
allowed-tools: Read Glob Grep Edit Write
---

# MariloDataGrid Gap Analysis — ICM Workspace Skill
...
1. Read `ICM/workspaces/datagrid-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`ICM/workspaces/datagrid-delivery/` — spec accuracy and Example UX coordination happen there.
