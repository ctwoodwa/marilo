...
1. Read `workspaces/datagrid-gap-analysis/CLAUDE.md` — this is the workspace routing layer
...
`workspaces/datagrid-delivery/` — spec accuracy and Example UX coordination happen there.
