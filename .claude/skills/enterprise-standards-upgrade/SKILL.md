...
1. Read `ICM/workspaces/enterprise-standards-upgrade/CLAUDE.md` — this is the workspace routing layer
2. If `$ARGUMENTS` is provided, treat it as a **trigger keyword** and follow the Triggers table in CLAUDE.md
3. If no argument, read `ICM/workspaces/enterprise-standards-upgrade/CONTEXT.md` for task routing
