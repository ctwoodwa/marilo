...
| Gap workspace coverage summary | {{GAP_WORKSPACE_PATH}}/_config/coverage-summary.md | Full file | Test and closure state |
...
4. Write output/{{COMPONENT_SLUG}}-delivery-report.md.
...
|----------|----------|--------|
| Delivery report | output/{{COMPONENT_SLUG}}-delivery-report.md | delivery-checklist.md |
