...
| Stage 01 output | stages/01-spec-review/output/{{COMPONENT_SLUG}}-spec-gap-list.md | Full file | Which parameters need demo coverage |
| API spec | {{SPEC_PATH}} | Full directory | Parameter definitions and use cases |
| Demo scenario format | shared/demo-scenario-format.md | Full file | What a complete scenario looks like |
| Existing demo page(s) | {{DEMO_PATH}} | Full file | Current state |
| Component source | {{SOURCE_PATH}} | Parameter and event declarations | Accurate API surface |
...
8. Write output/{{COMPONENT_SLUG}}-demo-gap-list.md (the gap audit).
9. Write the updated demo page file(s) to {{DEMO_PATH}}.
...
|----------|----------|--------|
| Demo gap list | output/{{COMPONENT_SLUG}}-demo-gap-list.md | demo-scenario-format.md |
| Updated demo page | {{DEMO_PATH}} | Blazor .razor file(s) |
