# Component Delivery Workspace -- {{COMPONENT_NAME}}

Coordinates spec, Example UX, and source+tests for {{COMPONENT_NAME}}.
...
| Gap workspace | {{GAP_WORKSPACE_PATH}}/CLAUDE.md | Routing table only |
